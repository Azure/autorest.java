...
/**
 * The SasDefinitionCreateParameters model.
 */
@Fluent
public final class SasDefinitionCreateParameters {
     ...
     */
    public SasDefinitionCreateParameters setTemplateUri(String templateUri) {
     ...
     * @return the SasDefinitionCreateParameters object itself.
     */
    public SasDefinitionCreateParameters setSasType(SasTokenType sasType) {
     ...
     * @return the SasDefinitionCreateParameters object itself.
     */
    public SasDefinitionCreateParameters setValidityPeriod(String validityPeriod) {
     ...
     * @return the SasDefinitionCreateParameters object itself.
     */
    public SasDefinitionCreateParameters setSasDefinitionAttributes(SasDefinitionAttributes sasDefinitionAttributes) {
     ...
     * @return the SasDefinitionCreateParameters object itself.
     */
    public SasDefinitionCreateParameters setTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public void validate() {
        if (getTemplateUri() == null) {
            throw new IllegalArgumentException("Missing required property templateUri in model SasDefinitionCreateParameters");
        }
        if (getSasType() == null) {
            throw new IllegalArgumentException("Missing required property sasType in model SasDefinitionCreateParameters");
        }
        if (getValidityPeriod() == null) {
            throw new IllegalArgumentException("Missing required property validityPeriod in model SasDefinitionCreateParameters");
        }
