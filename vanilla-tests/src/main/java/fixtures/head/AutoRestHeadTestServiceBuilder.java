...
public final class AutoRestHeadTestServiceBuilder
        implements HttpTrait<AutoRestHeadTestServiceBuilder>, ConfigurationTrait<AutoRestHeadTestServiceBuilder> {
    ...
    @Generated
    @Override
    public AutoRestHeadTestServiceBuilder retryOptions(RetryOptions retryOptions) {
    ...
    public AutoRestHeadTestService buildClient() {
        ...
        AutoRestHeadTestService client = new AutoRestHeadTestService(localPipeline, localSerializerAdapter, localHost);
        return client;
    }
