...
import fixtures.mediatypes.models.ContentType1AutoGenerated;
import fixtures.mediatypes.models.ContentType1AutoGenerated2;
...
public final class MediaTypesClient {
    ...
    private interface MediaTypesClientService {
        ...
        Mono<Response<String>> binaryBodyWithThreeContentTypes(
                @HostParam("$host") String host,
                @HeaderParam("Content-Type") ContentType1AutoGenerated contentType,
                @HeaderParam("Content-Length") long contentLength,
                @BodyParam("application/octet-stream") Flux<ByteBuffer> message,
                @HeaderParam("Accept") String accept,
                Context context);
        ...
        Mono<Response<String>> putTextAndJsonBody(
                @HostParam("$host") String host,
                @HeaderParam("Content-Type") ContentType1AutoGenerated2 contentType,
    ...
    public Mono<Response<String>> binaryBodyWithThreeContentTypesWithResponseAsync(
            ContentType1AutoGenerated contentType, long contentLength, Flux<ByteBuffer> message) {
        if (this.getHost() == null) {
            return Mono.error(new IllegalArgumentException("Parameter this.getHost() is required and cannot be null."));
        }
        if (contentType == null) {
    ...
    public Mono<Response<String>> putTextAndJsonBodyWithResponseAsync(
            ContentType1AutoGenerated2 contentType, String message) {
        if (this.getHost() == null) {
            return Mono.error(new IllegalArgumentException("Parameter this.getHost() is required and cannot be null."));
        }
        if (contentType == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public String putTextAndJsonBody(ContentType1AutoGenerated2 contentType, String message) {
