...
/** An instance of this class provides access to all the operations defined in Strings. */
public final class Strings {
    ...
    /**
     * The interface defining all the services for AutoRestSwaggerBATServiceStrings to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
