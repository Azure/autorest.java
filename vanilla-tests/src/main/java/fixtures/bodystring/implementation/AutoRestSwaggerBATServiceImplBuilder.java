...
public final class AutoRestSwaggerBATServiceImplBuilder
        implements HttpTrait<AutoRestSwaggerBATServiceImplBuilder>,
                ConfigurationTrait<AutoRestSwaggerBATServiceImplBuilder> {
    ...
    @Generated
    @Override
    public AutoRestSwaggerBATServiceImplBuilder retryOptions(RetryOptions retryOptions) {
