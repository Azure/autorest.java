...
public final class MultipleInheritanceServiceClientBuilder
        implements HttpTrait<MultipleInheritanceServiceClientBuilder>,
                ConfigurationTrait<MultipleInheritanceServiceClientBuilder> {
    ...
    @Generated
    @Override
    public MultipleInheritanceServiceClientBuilder retryOptions(RetryOptions retryOptions) {
