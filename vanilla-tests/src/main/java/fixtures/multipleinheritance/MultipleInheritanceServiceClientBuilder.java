...
public final class MultipleInheritanceServiceClientBuilder {
    ...
    /** Create an instance of the MultipleInheritanceServiceClientBuilder. */
     ...
     * @return the MultipleInheritanceServiceClientBuilder.
     */
    public MultipleInheritanceServiceClientBuilder clientOptions(ClientOptions clientOptions) {
