...
public final class AutorestSecurityInfoBuilder {
     ...
     */
    @Generated
    public AutorestSecurityInfoBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
    ...
    private HttpPipeline createHttpPipeline() {
        ...
        if (azureKeyCredential != null) {
            policies.add(new AzureKeyCredentialPolicy("subscription-key", azureKeyCredential));
        }
