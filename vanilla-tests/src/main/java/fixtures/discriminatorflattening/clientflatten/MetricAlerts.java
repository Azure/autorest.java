...
public final class MetricAlerts {
     ...
     * @return successful request for a list of metric alerts along with {@link Response} on successful completion of
     * {@link Mono}.
     */
     ...
     * @throws HttpResponseException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successful request for a list of metric alerts on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws HttpResponseException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successful request for a list of metric alerts along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws HttpResponseException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successful request for a list of metric alerts.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
