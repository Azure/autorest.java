    ...
    public void validate() {
        if (getValue() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model ClassWrapper"));
        } else {
            getValue().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ClassWrapper.class);
