    ...
    public void validate() {
        if (getValue() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model StringWrapper"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(StringWrapper.class);
