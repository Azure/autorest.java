...
public final class AutoRestRequiredOptionalTestService {
     ...
     */
    AutoRestRequiredOptionalTestService(String requiredGlobalPath, String requiredGlobalQuery, int optionalGlobalQuery,
        String host) {
        this(new HttpPipelineBuilder().policies(new UserAgentPolicy(), new RetryPolicy()).build(),
            JacksonAdapter.createDefaultSerializerAdapter(), requiredGlobalPath, requiredGlobalQuery,
            optionalGlobalQuery, host);
    }
     ...
     * @param host server parameter.
     */
    AutoRestRequiredOptionalTestService(HttpPipeline httpPipeline, String requiredGlobalPath,
        String requiredGlobalQuery, int optionalGlobalQuery, String host) {
        this(httpPipeline, JacksonAdapter.createDefaultSerializerAdapter(), requiredGlobalPath, requiredGlobalQuery,
            optionalGlobalQuery, host);
    }
     ...
     * @param host server parameter.
     */
    AutoRestRequiredOptionalTestService(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
