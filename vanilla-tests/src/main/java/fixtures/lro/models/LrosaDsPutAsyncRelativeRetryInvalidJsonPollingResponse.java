...
public final class LrosaDsPutAsyncRelativeRetryInvalidJsonPollingResponse
     ...
     */
    public LrosaDsPutAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode,
        HttpHeaders rawHeaders, Product value, LrosaDsPutAsyncRelativeRetryInvalidJsonPollingHeaders headers) {
