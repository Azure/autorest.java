...
public final class LRORetrysDeleteAsyncRelativeRetrySucceededResponse
     ...
     */
    public LRORetrysDeleteAsyncRelativeRetrySucceededResponse(HttpRequest request, int statusCode,
        HttpHeaders rawHeaders, Void value, LRORetrysDeleteAsyncRelativeRetrySucceededHeaders headers) {
