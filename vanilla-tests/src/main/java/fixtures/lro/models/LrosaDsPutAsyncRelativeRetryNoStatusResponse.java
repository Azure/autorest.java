...
public final class LrosaDsPutAsyncRelativeRetryNoStatusResponse
     ...
     */
    public LrosaDsPutAsyncRelativeRetryNoStatusResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Product value, LrosaDsPutAsyncRelativeRetryNoStatusHeaders headers) {
