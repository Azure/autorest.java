...
public final class LROsPostAsyncRetrySucceededResponse
     ...
     */
    public LROsPostAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Product value, LROsPostAsyncRetrySucceededHeaders headers) {
