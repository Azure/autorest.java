...
public final class LrosaDsPutAsyncRelativeRetryNoStatusPayloadResponse
     ...
     */
    public LrosaDsPutAsyncRelativeRetryNoStatusPayloadResponse(HttpRequest request, int statusCode,
        HttpHeaders rawHeaders, Product value, LrosaDsPutAsyncRelativeRetryNoStatusPayloadHeaders headers) {
