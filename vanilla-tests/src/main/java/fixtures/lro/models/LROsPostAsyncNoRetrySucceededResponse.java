...
public final class LROsPostAsyncNoRetrySucceededResponse
     ...
     */
    public LROsPostAsyncNoRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Product value, LROsPostAsyncNoRetrySucceededHeaders headers) {
