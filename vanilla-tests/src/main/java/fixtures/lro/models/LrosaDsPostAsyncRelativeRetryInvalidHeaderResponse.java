...
public final class LrosaDsPostAsyncRelativeRetryInvalidHeaderResponse
     ...
     */
    public LrosaDsPostAsyncRelativeRetryInvalidHeaderResponse(HttpRequest request, int statusCode,
        HttpHeaders rawHeaders, Void value, LrosaDsPostAsyncRelativeRetryInvalidHeaderHeaders headers) {
