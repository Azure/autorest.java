...
public final class LrosaDsDeleteAsyncRelativeRetryInvalidHeaderResponse
     ...
     */
    public LrosaDsDeleteAsyncRelativeRetryInvalidHeaderResponse(HttpRequest request, int statusCode,
        HttpHeaders rawHeaders, Void value, LrosaDsDeleteAsyncRelativeRetryInvalidHeaderHeaders headers) {
