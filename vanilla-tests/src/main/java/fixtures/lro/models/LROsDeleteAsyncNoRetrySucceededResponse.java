...
public final class LROsDeleteAsyncNoRetrySucceededResponse
        extends ResponseBase<LROsDeleteAsyncNoRetrySucceededHeaders, Void> {
    /**
     ...
     */
    public LROsDeleteAsyncNoRetrySucceededResponse(
            HttpRequest request,
            int statusCode,
            HttpHeaders rawHeaders,
            Void value,
            LROsDeleteAsyncNoRetrySucceededHeaders headers) {
