...
public final class LrosaDsDeleteAsyncRelativeRetryNoStatusResponse
     ...
     */
    public LrosaDsDeleteAsyncRelativeRetryNoStatusResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Void value, LrosaDsDeleteAsyncRelativeRetryNoStatusHeaders headers) {
