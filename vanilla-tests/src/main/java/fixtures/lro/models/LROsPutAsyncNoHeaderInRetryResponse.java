...
public final class LROsPutAsyncNoHeaderInRetryResponse
     ...
     */
    public LROsPutAsyncNoHeaderInRetryResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Product value, LROsPutAsyncNoHeaderInRetryHeaders headers) {
