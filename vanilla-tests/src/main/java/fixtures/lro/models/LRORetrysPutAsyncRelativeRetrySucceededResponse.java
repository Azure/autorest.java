...
public final class LRORetrysPutAsyncRelativeRetrySucceededResponse
     ...
     */
    public LRORetrysPutAsyncRelativeRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Product value, LRORetrysPutAsyncRelativeRetrySucceededHeaders headers) {
