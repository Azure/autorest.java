...
public final class LrosaDsPostAsyncRelativeRetryNoPayloadResponse
     ...
     */
    public LrosaDsPostAsyncRelativeRetryNoPayloadResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Void value, LrosaDsPostAsyncRelativeRetryNoPayloadHeaders headers) {
