...
public final class LROsPutAsyncNoRetrySucceededResponse
     ...
     */
    public LROsPutAsyncNoRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Product value, LROsPutAsyncNoRetrySucceededHeaders headers) {
