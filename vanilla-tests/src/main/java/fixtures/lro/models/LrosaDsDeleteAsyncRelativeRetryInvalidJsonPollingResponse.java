...
public final class LrosaDsDeleteAsyncRelativeRetryInvalidJsonPollingResponse
     ...
     */
    public LrosaDsDeleteAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode,
        HttpHeaders rawHeaders, Void value, LrosaDsDeleteAsyncRelativeRetryInvalidJsonPollingHeaders headers) {
