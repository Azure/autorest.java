...
public final class LROsCustomHeadersPutAsyncRetrySucceededResponse
     ...
     */
    public LROsCustomHeadersPutAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Product value, LROsCustomHeadersPutAsyncRetrySucceededHeaders headers) {
