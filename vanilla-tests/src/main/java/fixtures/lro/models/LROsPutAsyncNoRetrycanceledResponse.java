...
public final class LROsPutAsyncNoRetrycanceledResponse
     ...
     */
    public LROsPutAsyncNoRetrycanceledResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Product value, LROsPutAsyncNoRetrycanceledHeaders headers) {
