...
public final class LROsCustomHeadersPostAsyncRetrySucceededResponse
     ...
     */
    public LROsCustomHeadersPostAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Void value, LROsCustomHeadersPostAsyncRetrySucceededHeaders headers) {
