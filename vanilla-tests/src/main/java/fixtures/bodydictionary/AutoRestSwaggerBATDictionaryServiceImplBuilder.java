...
public final class AutoRestSwaggerBATDictionaryServiceImplBuilder {
    /*
     * server parameter
     */
    private String host;
     ...
     * @return the AutoRestSwaggerBATDictionaryServiceImplBuilder.
     */
    public AutoRestSwaggerBATDictionaryServiceImplBuilder host(String host) {
        this.host = host;
        return this;
    }
     ...
     * @return the AutoRestSwaggerBATDictionaryServiceImplBuilder.
     */
    public AutoRestSwaggerBATDictionaryServiceImplBuilder pipeline(HttpPipeline pipeline) {
