...
public final class Product implements JsonSerializable<Product> {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("child", this.child);
        jsonWriter.writeJsonField("constChild", this.constChild);
        jsonWriter.writeIntField("constInt", this.constInt);
        jsonWriter.writeStringField("constString", this.constString);
        jsonWriter.writeArrayField("display_names", this.displayNames,
            (writer, element) -> writer.writeString(element));
        jsonWriter.writeNumberField("capacity", this.capacity);
        jsonWriter.writeStringField("image", this.image);
        jsonWriter.writeStringField("constStringAsEnum", this.constStringAsEnum);
     ...
     * @return An instance of Product if the JsonReader was pointing to an instance of it, or null if it was pointing
     * to JSON null.
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("child".equals(fieldName)) {
                    deserializedProduct.child = ChildProduct.fromJson(reader);
                } else if ("constChild".equals(fieldName)) {
                    deserializedProduct.constChild = ConstantProduct.fromJson(reader);
                } else if ("display_names".equals(fieldName)) {
                    List<String> displayNames = reader.readArray(reader1 -> reader1.getString());
                    deserializedProduct.displayNames = displayNames;
                } else if ("capacity".equals(fieldName)) {
                    deserializedProduct.capacity = reader.getNullable(JsonReader::getInt);
                } else if ("image".equals(fieldName)) {
                    deserializedProduct.image = reader.getString();
                } else if ("constStringAsEnum".equals(fieldName)) {
                    deserializedProduct.constStringAsEnum = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
