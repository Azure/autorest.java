...
public final class AutoRestDurationTestServiceBuilder
        implements HttpTrait<AutoRestDurationTestServiceBuilder>,
                ConfigurationTrait<AutoRestDurationTestServiceBuilder> {
    ...
    @Generated
    @Override
    public AutoRestDurationTestServiceBuilder retryOptions(RetryOptions retryOptions) {
    ...
    public AutoRestDurationTestService buildClient() {
        ...
        AutoRestDurationTestService client =
                new AutoRestDurationTestService(localPipeline, localSerializerAdapter, localHost);
        return client;
    }
