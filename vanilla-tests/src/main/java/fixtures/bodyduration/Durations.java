...
/** An instance of this class provides access to all the operations defined in Durations. */
public final class Durations {
    ...
    /**
     * The interface defining all the services for AutoRestDurationTestServiceDurations to be used by the proxy service
