...
public final class NoModelAsStringRequiredTwoValueDefault
    implements JsonSerializable<NoModelAsStringRequiredTwoValueDefault> {
    /*
    ...
    private static final ClientLogger LOGGER = new ClientLogger(NoModelAsStringRequiredTwoValueDefault.class);
    ...
    public static NoModelAsStringRequiredTwoValueDefault fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            NoModelAsStringRequiredTwoValueDefault deserializedNoModelAsStringRequiredTwoValueDefault
                = new NoModelAsStringRequiredTwoValueDefault();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("parameter".equals(fieldName)) {
                    deserializedNoModelAsStringRequiredTwoValueDefault.parameter
                        = NoModelAsStringRequiredTwoValueDefaultEnum.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedNoModelAsStringRequiredTwoValueDefault;
        });
    }
}
