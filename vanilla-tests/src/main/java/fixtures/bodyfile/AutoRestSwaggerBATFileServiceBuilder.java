...
public final class AutoRestSwaggerBATFileServiceBuilder implements HttpTrait<AutoRestSwaggerBATFileServiceBuilder>,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AutoRestSwaggerBATFileServiceBuilder.class);
}
