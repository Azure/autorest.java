...
public final class AutoRestSwaggerBATFileServiceBuilder
        implements HttpTrait<AutoRestSwaggerBATFileServiceBuilder>,
                ConfigurationTrait<AutoRestSwaggerBATFileServiceBuilder> {
    ...
    @Generated
    @Override
    public AutoRestSwaggerBATFileServiceBuilder retryOptions(RetryOptions retryOptions) {
    ...
    public AutoRestSwaggerBATFileService buildClient() {
        ...
        AutoRestSwaggerBATFileService client =
                new AutoRestSwaggerBATFileService(localPipeline, localSerializerAdapter, localHost);
        return client;
    }
