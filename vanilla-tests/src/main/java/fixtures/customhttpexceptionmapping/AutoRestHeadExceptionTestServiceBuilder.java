...
public final class AutoRestHeadExceptionTestServiceBuilder
        implements HttpTrait<AutoRestHeadExceptionTestServiceBuilder>,
                ConfigurationTrait<AutoRestHeadExceptionTestServiceBuilder> {
    ...
    @Generated
    @Override
    public AutoRestHeadExceptionTestServiceBuilder retryOptions(RetryOptions retryOptions) {
