...
public final class PathItems {
    ...
    public interface PathItemsService {
        ...
        Mono<Response<Void>> getAllWithValues(@HostParam("$host") String host,
            ...
            @QueryParam("localStringQuery") String localStringQuery, @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return successfully received all query parameters in uri along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> getAllWithValuesWithResponseAsync(String pathItemStringPath, String localStringPath,
        String pathItemStringQuery, String localStringQuery, Context context) {
        ...
        return service.getAllWithValues(this.client.getHost(), pathItemStringPath, pathItemStringQuery,
            this.client.getGlobalStringPath(), this.client.getGlobalStringQuery(), localStringPath, localStringQuery,
            accept, context);
    }
     ...
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successfully received all query parameters in uri on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getAllWithValuesAsync(String pathItemStringPath, String localStringPath,
        String pathItemStringQuery, String localStringQuery) {
        return getAllWithValuesWithResponseAsync(pathItemStringPath, localStringPath, pathItemStringQuery,
            localStringQuery).flatMap(ignored -> Mono.empty());
    }
    ...
    public Mono<Void> getAllWithValuesAsync(String pathItemStringPath, String localStringPath,
        String pathItemStringQuery, String localStringQuery, Context context) {
        return getAllWithValuesWithResponseAsync(pathItemStringPath, localStringPath, pathItemStringQuery,
            localStringQuery, context).flatMap(ignored -> Mono.empty());
    }
    ...
    public Response<Void> getAllWithValuesWithResponse(String pathItemStringPath, String localStringPath,
        String pathItemStringQuery, String localStringQuery, Context context) {
        return getAllWithValuesWithResponseAsync(pathItemStringPath, localStringPath, pathItemStringQuery,
            localStringQuery, context).block();
    }
     ...
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successfully received all query parameters but global along with {@link Response} on successful
    ...
    public Mono<Response<Void>> getGlobalQueryNullWithResponseAsync(String pathItemStringPath, String localStringPath,
        ...
        final String accept = "application/json";
        return service.getGlobalQueryNull(this.client.getHost(), pathItemStringPath, pathItemStringQuery,
            this.client.getGlobalStringPath(), this.client.getGlobalStringQuery(), localStringPath, localStringQuery,
            accept, context);
    }
     ...
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successfully received all query parameters but global on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getGlobalQueryNullAsync(String pathItemStringPath, String localStringPath,
        String pathItemStringQuery, String localStringQuery) {
        return getGlobalQueryNullWithResponseAsync(pathItemStringPath, localStringPath, pathItemStringQuery,
            localStringQuery).flatMap(ignored -> Mono.empty());
    }
     ...
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successfully received only the pathItemQuery query parameter along with {@link Response} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> getGlobalAndLocalQueryNullWithResponseAsync(String pathItemStringPath,
        String localStringPath, String pathItemStringQuery, String localStringQuery, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return service.getGlobalAndLocalQueryNull(this.client.getHost(), pathItemStringPath, pathItemStringQuery,
            this.client.getGlobalStringPath(), this.client.getGlobalStringQuery(), localStringPath, localStringQuery,
            accept, context);
    }
     ...
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successfully received only the pathItemQuery query parameter on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getGlobalAndLocalQueryNullAsync(String pathItemStringPath, String localStringPath,
        String pathItemStringQuery, String localStringQuery) {
        return getGlobalAndLocalQueryNullWithResponseAsync(pathItemStringPath, localStringPath, pathItemStringQuery,
            localStringQuery).flatMap(ignored -> Mono.empty());
    }
    ...
    public void getGlobalAndLocalQueryNull(String pathItemStringPath, String localStringPath,
        String pathItemStringQuery, String localStringQuery) {
        getGlobalAndLocalQueryNullWithResponse(pathItemStringPath, localStringPath, pathItemStringQuery,
            localStringQuery, Context.NONE);
    }
     ...
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successfully received only global query parameter along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public Mono<Response<Void>> getLocalPathItemQueryNullWithResponseAsync(String pathItemStringPath,
        ...
        final String accept = "application/json";
        return service.getLocalPathItemQueryNull(this.client.getHost(), pathItemStringPath, pathItemStringQuery,
            this.client.getGlobalStringPath(), this.client.getGlobalStringQuery(), localStringPath, localStringQuery,
            accept, context);
    }
     ...
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return successfully received only global query parameter on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getLocalPathItemQueryNullAsync(String pathItemStringPath, String localStringPath,
        String pathItemStringQuery, String localStringQuery) {
        return getLocalPathItemQueryNullWithResponseAsync(pathItemStringPath, localStringPath, pathItemStringQuery,
            localStringQuery).flatMap(ignored -> Mono.empty());
    }
    ...
    public void getLocalPathItemQueryNull(String pathItemStringPath, String localStringPath, String pathItemStringQuery,
        String localStringQuery) {
        getLocalPathItemQueryNullWithResponse(pathItemStringPath, localStringPath, pathItemStringQuery,
            localStringQuery, Context.NONE);
    }
