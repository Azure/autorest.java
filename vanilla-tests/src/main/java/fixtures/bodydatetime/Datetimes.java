...
/** An instance of this class provides access to all the operations defined in Datetimes. */
public final class Datetimes {
    ...
    /**
     * The interface defining all the services for AutoRestDateTimeTestServiceDatetimes to be used by the proxy service
    ...
    private interface DatetimesService {
        ...
        @ReturnValueWireType(OffsetDateTime.class)
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SimpleResponse<OffsetDateTime>> getUtcUppercaseMaxDateTime7Digits(
                @HostParam("$host") String host, Context context);
        ...
        @ReturnValueWireType(OffsetDateTime.class)
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SimpleResponse<OffsetDateTime>> getLocalNoOffsetMinDateTime(
                @HostParam("$host") String host, Context context);
    }
