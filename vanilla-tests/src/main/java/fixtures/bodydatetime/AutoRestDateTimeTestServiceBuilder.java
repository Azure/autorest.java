...
public final class AutoRestDateTimeTestServiceBuilder
        implements HttpTrait<AutoRestDateTimeTestServiceBuilder>,
                ConfigurationTrait<AutoRestDateTimeTestServiceBuilder> {
    ...
    @Generated
    @Override
    public AutoRestDateTimeTestServiceBuilder retryOptions(RetryOptions retryOptions) {
