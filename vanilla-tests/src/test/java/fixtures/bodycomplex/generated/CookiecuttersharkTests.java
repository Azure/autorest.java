...
public final class CookiecuttersharkTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals(
                53.090946f, model.getSiblings().get(0).getSiblings().get(0).getSiblings().get(0).getLength());
    ...
    public void testSerialize() throws Exception {
        Cookiecuttershark model =
                new Cookiecuttershark(5.423278f, OffsetDateTime.parse("2021-07-24T18:44:29Z"))
                                                ...
                                                .setSiblings(
                                                        Arrays.asList(
                                                                new Fish(58.94148f)
                                                                        ...
                                                                        .setSiblings(
                                                                                Arrays.asList(new Fish(53.090946f))))),
                                        new Fish(3.4862816f)
                                                .setSpecies("locx")
                                                .setSiblings(
                                                        Arrays.asList(
                                                                new Fish(91.597664f)
                                                                        .setSpecies("erhhbcsglumm")
                                                                        .setSiblings(
                                                                                Arrays.asList(new Fish(29.64415f))),
                                                                new Fish(62.736557f)
                                                                        .setSpecies("dxob")
                                                                        .setSiblings(
                                                                                Arrays.asList(
