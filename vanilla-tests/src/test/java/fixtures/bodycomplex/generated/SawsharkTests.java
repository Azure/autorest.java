...
public final class SawsharkTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-09-01T01:28:54Z", DateTimeFormatter.ISO_OFFSET_DATE_TIME),
            model.getBirthday());
    }
    ...
    public void testSerialize() throws Exception {
        Sawshark model
            = new Sawshark(41.75237f,
                OffsetDateTime.parse("2021-09-01T01:28:54Z", DateTimeFormatter.ISO_OFFSET_DATE_TIME))
                    .setSpecies("gibma")
                    .setSiblings(
                        Arrays
                            .asList(
