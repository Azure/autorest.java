...
public final class SawsharkTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals(
                56.270576f, model.getSiblings().get(0).getSiblings().get(0).getSiblings().get(0).getLength());
        ...
        Sawshark model =
                new Sawshark(41.75237f, OffsetDateTime.parse("2021-09-01T01:28:54Z"))
                        ...
                        .setSiblings(
                                Arrays.asList(
                                        new Fish(18.452686f)
                                                .setSpecies("qsrxybzqqed")
                                                .setSiblings(
                                                        Arrays.asList(
                                                                new Fish(67.5812f)
                                                                        .setSpecies("iqfouflmmnkz")
                                                                        .setSiblings(
                                                                                Arrays.asList(
                                                                                        new Fish(56.270576f),
                                                                                        new Fish(47.130127f))),
                                                                ...
                                                                new Fish(94.51547f)
                                                                        .setSpecies("ta")
                                                                        .setSiblings(
                                                                                Arrays.asList(new Fish(18.805998f))))),
                                        new Fish(2.3766458f)
                                                .setSpecies("uertumk")
                                                .setSiblings(
                                                        Arrays.asList(
                                                                new Fish(84.869194f)
                                                                        ...
                                                                        .setSiblings(
                                                                                Arrays.asList(
                                                                                        new Fish(0.016152859f),
                                                                                        new Fish(25.363232f),
                                                                                        new Fish(21.297592f))),
                                                                new Fish(4.9203157f)
                                                                        .setSpecies("mbmbexppbh")
                                                                        .setSiblings(
                                                                                Arrays.asList(
                                                                                        new Fish(8.5479145f),
                                                                                        new Fish(16.483826f))),
                                                ...
                                                .setSiblings(
                                                        Arrays.asList(
                                                                ...
                                                                new Fish(84.77632f)
                                                                        .setSpecies("rujqg")
                                                                        .setSiblings(
                                                                                Arrays.asList(new Fish(44.637882f))),
                                                                new Fish(48.901512f)
                                                                        .setSpecies("qfprwzwbn")
                                                                        .setSiblings(
                                                                                Arrays.asList(new Fish(23.633587f))))),
                                        new Fish(2.362436f)
                                                .setSpecies("uizga")
                                                .setSiblings(
                                                        Arrays.asList(
                                                                new Fish(56.51085f)
                                                                        .setSpecies("zuckyfi")
                                                                        .setSiblings(
                                                                                Arrays.asList(new Fish(68.11774f))),
                                                                new Fish(66.07407f)
                                                                        .setSpecies("vzwdzuhtymwis")
                                                                        .setSiblings(
                                                                                Arrays.asList(
                                                                                        new Fish(61.41952f),
                                                                                        new Fish(60.204166f),
