...
public final class SharkTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals(
                45.296448f, model.getSiblings().get(0).getSiblings().get(0).getSiblings().get(0).getLength());
    ...
    public void testSerialize() throws Exception {
        Shark model =
                new Shark(63.108402f, OffsetDateTime.parse("2021-05-16T15:44:09Z"))
                        .setSpecies("kao")
                        .setSiblings(
                                Arrays.asList(
                                        new Fish(81.88607f)
                                                .setSpecies("tyhxhurokft")
                                                .setSiblings(
                                                        Arrays.asList(
                                                                new Fish(48.25244f)
                                                                        .setSpecies("iwpwcuk")
