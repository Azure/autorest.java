...
import com.fluent.gencode.parent_child_insame_opgroup.implementation.AccessUriInner;

/**
 * Type representing AccessUri.
 */
public interface AccessUri extends HasInner<AccessUriInner>, HasManager<Parent_Child_Insame_OpGroupManager> {
    /**
