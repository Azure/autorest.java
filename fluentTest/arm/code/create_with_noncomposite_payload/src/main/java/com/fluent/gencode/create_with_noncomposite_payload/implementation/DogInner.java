 ...
 */
@JsonFlatten
public class DogInner extends Resource {
    /**
     * A relative URI containing the ID of the owner that has the dog attached.
     */
     ...
     */
    public DogInner withSku(DogSku sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the DogInner object itself.
     */
    public DogInner withZones(List<String> zones) {
        this.zones = zones;
        return this;
    }
     ...
     * @return the DogInner object itself.
     */
    public DogInner withOsType(ColorTypes osType) {
        this.osType = osType;
        return this;
    }
     ...
     * @return the DogInner object itself.
     */
    public DogInner withCreationData(CreationData creationData) {
     ...
     * @return the DogInner object itself.
     */
    public DogInner withAnimalSizeGB(Integer animalSizeGB) {
