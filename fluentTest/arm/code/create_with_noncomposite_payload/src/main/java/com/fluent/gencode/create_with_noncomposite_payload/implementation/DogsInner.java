...
import com.fluent.gencode.create_with_noncomposite_payload.DogUpdate;
...
public class DogsInner implements InnerSupportsGet<DogInner>, InnerSupportsDelete<Void> {
    ...
    interface DogsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.fluent.gencode.create_with_noncomposite_payload.Dogs createOrUpdate" })
        @PUT("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Pets/dogs/{dogName}")
        Observable<Response<ResponseBody>> createOrUpdate(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("dogName") String dogName, @Query("api-version") String apiVersion, @Body Map<String, String> dog, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.fluent.gencode.create_with_noncomposite_payload.Dogs beginCreateOrUpdate" })
        @PUT("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Pets/dogs/{dogName}")
        Observable<Response<ResponseBody>> beginCreateOrUpdate(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("dogName") String dogName, @Query("api-version") String apiVersion, @Body Map<String, String> dog, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.fluent.gencode.create_with_noncomposite_payload.Dogs updateDog" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.fluent.gencode.create_with_noncomposite_payload.Dogs beginUpdateDog" })
        @PATCH("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Pets/dogs/{dogName}")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.fluent.gencode.create_with_noncomposite_payload.Dogs getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.fluent.gencode.create_with_noncomposite_payload.Dogs delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.fluent.gencode.create_with_noncomposite_payload.Dogs beginDelete" })
        @HTTP(path = "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Pets/dogs/{dogName}", method = "DELETE", hasBody = true)
     ...
     */
    public DogInner createOrUpdate(String resourceGroupName, String dogName, Map<String, String> dog) {
     ...
     */
    public ServiceFuture<DogInner> createOrUpdateAsync(String resourceGroupName, String dogName, Map<String, String> dog, final ServiceCallback<DogInner> serviceCallback) {
     ...
     */
    public Observable<DogInner> createOrUpdateAsync(String resourceGroupName, String dogName, Map<String, String> dog) {
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponse<DogInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String dogName, Map<String, String> dog) {
     ...
     * @return the DogInner object if successful.
     */
    public DogInner beginCreateOrUpdate(String resourceGroupName, String dogName, Map<String, String> dog) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<DogInner> beginCreateOrUpdateAsync(String resourceGroupName, String dogName, Map<String, String> dog, final ServiceCallback<DogInner> serviceCallback) {
     ...
     */
    public Observable<DogInner> beginCreateOrUpdateAsync(String resourceGroupName, String dogName, Map<String, String> dog) {
     ...
     * @return the observable to the DogInner object
     */
    public Observable<ServiceResponse<DogInner>> beginCreateOrUpdateWithServiceResponseAsync(String resourceGroupName, String dogName, Map<String, String> dog) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
