...
class DogsImpl extends GroupableResourcesCoreImpl<Dog, DogImpl, DogInner, DogsInner, Create_With_NonComposite_PayloadManager>  implements Dogs {
    protected DogsImpl(Create_With_NonComposite_PayloadManager manager) {
