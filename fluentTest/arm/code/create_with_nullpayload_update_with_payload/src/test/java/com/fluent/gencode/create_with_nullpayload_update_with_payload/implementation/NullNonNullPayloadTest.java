...
import com.fluent.gencode.create_with_nullpayload_update_with_payload.SkuNames;
...
public class NullNonNullPayloadTest {

    Create_Update_With_NullpayloadManager manager;

    @Before
    public void initialize() {
        AzureTokenCredentials credentials = tokenCredentials();
        this.manager = Create_Update_With_NullpayloadManager.authenticate(credentials, "subscriptionid1");
    }

    @Test
    public void ensureExpectedInheritanceAndFluentChain() {
        //
