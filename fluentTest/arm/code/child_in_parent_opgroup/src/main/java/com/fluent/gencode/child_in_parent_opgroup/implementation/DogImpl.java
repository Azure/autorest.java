...
class DogImpl extends GroupableResourceCoreImpl<Dog, DogInner, DogImpl, Child_In_Parent_OpGroupManager> implements Dog, Dog.Definition, Dog.Update {
    private DogUpdate updateParameter;
    DogImpl(String name, DogInner inner, Child_In_Parent_OpGroupManager manager) {
