...
{
    public class ClientFluentReadOnlyModelImpl : IFluentModel
    {
        public ClientFluentReadOnlyModelImpl(ClientFluentReadOnlyModelInterface mInterface)
        {
            this.Interface = mInterface;
        }

        public ClientFluentReadOnlyModelInterface Interface
        {
            get; private set;
        }
