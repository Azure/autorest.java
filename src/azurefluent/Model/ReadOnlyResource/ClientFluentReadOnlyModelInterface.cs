...
{
    public class ClientFluentReadOnlyModelInterface
    {
        ...
        private ClientFluentReadOnlyModelImpl impl;
        ...
        public ClientFluentReadOnlyModelImpl Impl
        {
            get
            {
                if (impl == null)
                {
                    this.impl = new ClientFluentReadOnlyModelImpl(this);
                }
                return this.impl;
            }
        }
