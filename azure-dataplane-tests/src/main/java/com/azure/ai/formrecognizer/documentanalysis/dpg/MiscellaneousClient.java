 ...
 */
@ServiceClient(builder = MiscellaneousClientBuilder.class)
public final class MiscellaneousClient {
    @Generated
    private final MiscellaneousImpl serviceClient;

    /**
     * Initializes an instance of MiscellaneousClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    MiscellaneousClient(MiscellaneousImpl serviceClient) {
