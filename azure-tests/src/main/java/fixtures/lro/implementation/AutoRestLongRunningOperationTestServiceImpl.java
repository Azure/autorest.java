...
public final class AutoRestLongRunningOperationTestServiceImpl implements AutoRestLongRunningOperationTestService {
    ...
    AutoRestLongRunningOperationTestServiceImpl(
        ...
        this.lROs = new LROsClientImpl(this);
        this.lroRetrys = new LroRetrysClientImpl(this);
        this.lrosaDs = new LrosaDsClientImpl(this);
        this.lrosCustomHeaders = new LrosCustomHeadersClientImpl(this);
    }
