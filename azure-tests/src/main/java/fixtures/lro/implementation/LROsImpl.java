...
public final class LROsImpl implements LROs {
    ...
    public Product patch201RetryWithAsyncHeader(ProductInner product, Context context) {
        ProductInner inner = this.serviceClient().patch201RetryWithAsyncHeader(product, context);
        if (inner != null) {
            return new ProductImpl(inner, this.manager());
        } else {
            return null;
