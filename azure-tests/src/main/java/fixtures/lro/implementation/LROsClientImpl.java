...
public final class LROsClientImpl implements LROsClient {
    ...
    private interface LROsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> patch201RetryWithAsyncHeader(
            @HostParam("$host") String endpoint,
            @BodyParam("application/json") ProductInner product,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> patch202RetryWithAsyncAndLocationHeader(
            @HostParam("$host") String endpoint,
            @BodyParam("application/json") ProductInner product,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> patch201RetryWithAsyncHeaderWithResponseAsync(ProductInner product) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return FluxUtil
            .withContext(
                context -> service.patch201RetryWithAsyncHeader(this.client.getEndpoint(), product, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> patch201RetryWithAsyncHeaderWithResponseAsync(
        ProductInner product, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.patch201RetryWithAsyncHeader(this.client.getEndpoint(), product, accept, context);
    }
    ...
    private PollerFlux<PollResult<ProductInner>, ProductInner> beginPatch201RetryWithAsyncHeaderAsync(
        ProductInner product, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = patch201RetryWithAsyncHeaderWithResponseAsync(product, context);
        return this
            .client
            .<ProductInner, ProductInner>getLroResult(
                mono, this.client.getHttpPipeline(), ProductInner.class, ProductInner.class, context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProductInner> patch201RetryWithAsyncHeaderAsync(ProductInner product) {
        return beginPatch201RetryWithAsyncHeaderAsync(product).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProductInner> patch201RetryWithAsyncHeaderAsync() {
        final ProductInner product = null;
        return beginPatch201RetryWithAsyncHeaderAsync(product).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProductInner> patch201RetryWithAsyncHeaderAsync(ProductInner product, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProductInner patch201RetryWithAsyncHeader() {
        final ProductInner product = null;
        return patch201RetryWithAsyncHeaderAsync(product).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProductInner patch201RetryWithAsyncHeader(ProductInner product, Context context) {
        return patch201RetryWithAsyncHeaderAsync(product, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> patch202RetryWithAsyncAndLocationHeaderWithResponseAsync(
        ProductInner product) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .patch202RetryWithAsyncAndLocationHeader(this.client.getEndpoint(), product, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> patch202RetryWithAsyncAndLocationHeaderWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.patch202RetryWithAsyncAndLocationHeader(this.client.getEndpoint(), product, accept, context);
    }
    ...
    private PollerFlux<PollResult<ProductInner>, ProductInner> beginPatch202RetryWithAsyncAndLocationHeaderAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            patch202RetryWithAsyncAndLocationHeaderWithResponseAsync(product, context);
        return this
            .client
            .<ProductInner, ProductInner>getLroResult(
                mono, this.client.getHttpPipeline(), ProductInner.class, ProductInner.class, context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProductInner> patch202RetryWithAsyncAndLocationHeaderAsync(ProductInner product) {
        return beginPatch202RetryWithAsyncAndLocationHeaderAsync(product)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProductInner> patch202RetryWithAsyncAndLocationHeaderAsync() {
        final ProductInner product = null;
        return beginPatch202RetryWithAsyncAndLocationHeaderAsync(product)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProductInner> patch202RetryWithAsyncAndLocationHeaderAsync(ProductInner product, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProductInner patch202RetryWithAsyncAndLocationHeader() {
        final ProductInner product = null;
        return patch202RetryWithAsyncAndLocationHeaderAsync(product).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProductInner patch202RetryWithAsyncAndLocationHeader(ProductInner product, Context context) {
        return patch202RetryWithAsyncAndLocationHeaderAsync(product, context).block();
    }
