...
public final class LroRetrysClientImpl implements LroRetrysClient {
    ...
    private interface LroRetrysService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> putAsyncRelativeRetrySucceeded(@HostParam("$host") String endpoint, @BodyParam("application/json") ProductInner product, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> deleteAsyncRelativeRetrySucceeded(@HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> postAsyncRelativeRetrySucceeded(@HostParam("$host") String endpoint, @BodyParam("application/json") ProductInner product, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> putAsyncRelativeRetrySucceededWithResponseAsync(ProductInner product) {
        ...
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.putAsyncRelativeRetrySucceeded(this.client.getEndpoint(), product, accept, context))
            .subscriberContext(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext())));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> putAsyncRelativeRetrySucceededWithResponseAsync(ProductInner product, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        if (product != null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<ProductInner>, ProductInner> beginPutAsyncRelativeRetrySucceededAsync(ProductInner product) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<ProductInner>, ProductInner> beginPutAsyncRelativeRetrySucceededAsync(ProductInner product, Context context) {
        context = this.client.mergeContext(context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<ProductInner>, ProductInner> beginPutAsyncRelativeRetrySucceeded(ProductInner product) {
        return beginPutAsyncRelativeRetrySucceededAsync(product)
            .getSyncPoller();}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<ProductInner>, ProductInner> beginPutAsyncRelativeRetrySucceeded(ProductInner product, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteAsyncRelativeRetrySucceededWithResponseAsync() {
        ...
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.deleteAsyncRelativeRetrySucceeded(this.client.getEndpoint(), accept, context))
            .subscriberContext(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext())));
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteAsyncRelativeRetrySucceeded() {
        return beginDeleteAsyncRelativeRetrySucceededAsync()
            .getSyncPoller();}
    ...
    private Mono<Response<Flux<ByteBuffer>>> postAsyncRelativeRetrySucceededWithResponseAsync(ProductInner product) {
        ...
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.postAsyncRelativeRetrySucceeded(this.client.getEndpoint(), product, accept, context))
            .subscriberContext(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext())));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> postAsyncRelativeRetrySucceededWithResponseAsync(ProductInner product, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        if (product != null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<Void>, Void> beginPostAsyncRelativeRetrySucceededAsync(ProductInner product, Context context) {
        context = this.client.mergeContext(context);
    ...
    public SyncPoller<PollResult<Void>, Void> beginPostAsyncRelativeRetrySucceeded(ProductInner product) {
        return beginPostAsyncRelativeRetrySucceededAsync(product)
            .getSyncPoller();}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<Void>, Void> beginPostAsyncRelativeRetrySucceeded(ProductInner product, Context context) {
