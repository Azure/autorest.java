...
public interface LROs {
     ...
     * @return the response.
     */
    Product patch201RetryWithAsyncHeader();
     ...
     * @return the response.
     */
    Product patch201RetryWithAsyncHeader(ProductInner product, Context context);
     ...
     * @return the response.
     */
    Product patch202RetryWithAsyncAndLocationHeader();
