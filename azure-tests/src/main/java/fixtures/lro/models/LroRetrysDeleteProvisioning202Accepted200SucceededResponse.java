...
public final class LroRetrysDeleteProvisioning202Accepted200SucceededResponse
    extends ResponseBase<LroRetrysDeleteProvisioning202Accepted200SucceededHeaders, ProductInner> {
    /**
     ...
     */
    public LroRetrysDeleteProvisioning202Accepted200SucceededResponse(
        HttpRequest request,
        int statusCode,
        HttpHeaders rawHeaders,
        ProductInner value,
        LroRetrysDeleteProvisioning202Accepted200SucceededHeaders headers) {
