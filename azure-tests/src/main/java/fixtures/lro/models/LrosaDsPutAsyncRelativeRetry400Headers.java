...
/** The LrosaDsPutAsyncRelativeRetry400Headers model. */
@Fluent
public final class LrosaDsPutAsyncRelativeRetry400Headers {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(LrosaDsPutAsyncRelativeRetry400Headers.class);
