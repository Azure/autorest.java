...
public final class LrosaDsDeleteAsyncRelativeRetry400Response
    extends ResponseBase<LrosaDsDeleteAsyncRelativeRetry400Headers, Void> {
    /**
     ...
     */
    public LrosaDsDeleteAsyncRelativeRetry400Response(
        HttpRequest request,
        int statusCode,
        HttpHeaders rawHeaders,
        Void value,
        LrosaDsDeleteAsyncRelativeRetry400Headers headers) {
