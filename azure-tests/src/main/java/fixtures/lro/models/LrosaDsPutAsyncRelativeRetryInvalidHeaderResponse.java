...
public final class LrosaDsPutAsyncRelativeRetryInvalidHeaderResponse
    extends ResponseBase<LrosaDsPutAsyncRelativeRetryInvalidHeaderHeaders, ProductInner> {
    /**
     ...
     */
    public LrosaDsPutAsyncRelativeRetryInvalidHeaderResponse(
        HttpRequest request,
        int statusCode,
        HttpHeaders rawHeaders,
        ProductInner value,
        LrosaDsPutAsyncRelativeRetryInvalidHeaderHeaders headers) {
