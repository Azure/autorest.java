 ...
 */
public final class LROsPutAsyncRetrySucceededResponse extends ResponseBase<LROsPutAsyncRetrySucceededHeaders, ProductInner> {
    /**
     ...
     */
    public LROsPutAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutAsyncRetrySucceededHeaders headers) {
