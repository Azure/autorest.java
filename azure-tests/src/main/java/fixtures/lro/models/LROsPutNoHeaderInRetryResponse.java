...
public final class LROsPutNoHeaderInRetryResponse extends ResponseBase<LROsPutNoHeaderInRetryHeaders, ProductInner> {
     ...
     */
    public LROsPutNoHeaderInRetryResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutNoHeaderInRetryHeaders headers) {
