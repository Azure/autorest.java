...
public final class LROsDeleteNoHeaderInRetryResponse extends ResponseBase<LROsDeleteNoHeaderInRetryHeaders, Void> {
     ...
     */
    public LROsDeleteNoHeaderInRetryResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROsDeleteNoHeaderInRetryHeaders headers) {
