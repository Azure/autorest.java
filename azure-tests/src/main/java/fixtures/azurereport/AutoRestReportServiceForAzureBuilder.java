...
public final class AutoRestReportServiceForAzureBuilder
        implements HttpTrait<AutoRestReportServiceForAzureBuilder>,
                ConfigurationTrait<AutoRestReportServiceForAzureBuilder> {
    ...
    @Generated
    @Override
    public AutoRestReportServiceForAzureBuilder retryOptions(RetryOptions retryOptions) {
