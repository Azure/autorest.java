...
public final class HeadersCustomNamedRequestIdParamGroupingResponse
     ...
     */
    public HeadersCustomNamedRequestIdParamGroupingResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        Void value, HeadersCustomNamedRequestIdParamGroupingHeaders headers) {
