...
public final class AutoRestAzureSpecialParametersTestClient {
     ...
     * 
     * @param subscriptionId The subscription id, which appears in the path, always modeled in credentials. The value
     * is always '1234-5678-9012-3456'.
     ...
     * @param apiVersion Api Version.
     */
    AutoRestAzureSpecialParametersTestClient(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
