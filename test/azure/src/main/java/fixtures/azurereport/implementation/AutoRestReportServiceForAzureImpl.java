 ...
 */
public final class AutoRestReportServiceForAzureImpl implements AutoRestReportServiceForAzure {
    /**
    ...
    public AutoRestReportServiceForAzureImpl(HttpPipeline httpPipeline, AzureEnvironment azureEnvironment) {
        ...
        this.service = AzureProxy.create(AutoRestReportServiceForAzureService.class, httpPipeline);
    }
    ...
    private interface AutoRestReportServiceForAzureService {
        ...
        Mono<SimpleResponse<Map<String, Integer>>> getReport(@QueryParam("qualifier") String qualifier, @HeaderParam("accept-language") String acceptLanguage);
    }
    ...
    public Mono<SimpleResponse<Map<String, Integer>>> getReportWithRestResponseAsync() {
        ...
        return service.getReport(qualifier, this.getAcceptLanguage());
    }
    ...
    public Mono<Map<String, Integer>> getReportAsync() {
        return getReportWithRestResponseAsync()
            .flatMap((SimpleResponse<Map<String, Integer>> res) -> Mono.just(res.value()));
    }
