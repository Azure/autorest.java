...
public final class HeaderCustomNamedRequestIdParamGroupingResponse extends RestResponse<HeaderCustomNamedRequestIdParamGroupingHeaders, Void> {
     ...
     */
    public HeaderCustomNamedRequestIdParamGroupingResponse(int statusCode, HeaderCustomNamedRequestIdParamGroupingHeaders headers, Map<String, String> rawHeaders, Void body) {
