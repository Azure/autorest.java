 ...
 */
public final class HeadersCustomNamedRequestIdResponse extends RestResponse<HeaderCustomNamedRequestIdHeaders, Void> {
    /**
     ...
     */
    public HeadersCustomNamedRequestIdResponse(HttpRequest request, int statusCode, HeaderCustomNamedRequestIdHeaders headers, Map<String, String> rawHeaders, Void body) {
