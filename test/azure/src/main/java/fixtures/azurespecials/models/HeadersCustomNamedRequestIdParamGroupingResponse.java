 ...
 */
public final class HeadersCustomNamedRequestIdParamGroupingResponse extends RestResponse<HeaderCustomNamedRequestIdParamGroupingHeaders, Void> {
    /**
     ...
     */
    public HeadersCustomNamedRequestIdParamGroupingResponse(HttpRequest request, int statusCode, HeaderCustomNamedRequestIdParamGroupingHeaders headers, Map<String, String> rawHeaders, Void body) {
