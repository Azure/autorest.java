 ...
 */
@Fluent
public final class LROsCustomHeaderPostAsyncRetrySucceededHeaders {
    /*
     ...
     * itself.
     */
    public LROsCustomHeaderPostAsyncRetrySucceededHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROsCustomHeaderPostAsyncRetrySucceededHeaders location(String location) {
     ...
     * itself.
     */
    public LROsCustomHeaderPostAsyncRetrySucceededHeaders retryAfter(Integer retryAfter) {
