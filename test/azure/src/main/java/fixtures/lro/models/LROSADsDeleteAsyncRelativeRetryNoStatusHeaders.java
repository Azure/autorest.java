...
public final class LROSADsDeleteAsyncRelativeRetryNoStatusHeaders {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryNoStatusHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryNoStatusHeaders location(String location) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryNoStatusHeaders retryAfter(Integer retryAfter) {
