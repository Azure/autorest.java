...
public final class LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeaders {
     ...
     * object itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * object itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeaders location(String location) {
     ...
     * object itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeaders retryAfter(Integer retryAfter) {
