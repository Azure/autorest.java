...
public final class LROsPostAsyncNoRetrySucceededHeaders {
     ...
     */
    public LROsPostAsyncNoRetrySucceededHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsPostAsyncNoRetrySucceededHeaders object itself.
     */
    public LROsPostAsyncNoRetrySucceededHeaders location(String location) {
     ...
     * @return the LROsPostAsyncNoRetrySucceededHeaders object itself.
     */
    public LROsPostAsyncNoRetrySucceededHeaders retryAfter(Integer retryAfter) {
