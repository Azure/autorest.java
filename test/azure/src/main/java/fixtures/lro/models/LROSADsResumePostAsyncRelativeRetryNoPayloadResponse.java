...
public final class LROSADsResumePostAsyncRelativeRetryNoPayloadResponse extends RestResponse<LROSADsPostAsyncRelativeRetryNoPayloadHeaders, Void> {
     ...
     */
    public LROSADsResumePostAsyncRelativeRetryNoPayloadResponse(int statusCode, LROSADsPostAsyncRelativeRetryNoPayloadHeaders headers, Map<String, String> rawHeaders, Void body) {
