...
public final class LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeaders {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeaders location(String location) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeaders retryAfter(Integer retryAfter) {
