...
public final class LROSADsBeginPutAsyncRelativeRetryInvalidHeaderResponse extends RestResponse<LROSADsPutAsyncRelativeRetryInvalidHeaderHeaders, Product> {
     ...
     */
    public LROSADsBeginPutAsyncRelativeRetryInvalidHeaderResponse(int statusCode, LROSADsPutAsyncRelativeRetryInvalidHeaderHeaders headers, Map<String, String> rawHeaders, Product body) {
