...
public final class LROSADsPostAsyncRelativeRetryInvalidHeaderResponse extends RestResponse<LROSADsPostAsyncRelativeRetryInvalidHeaderHeaders, Void> {
     ...
     */
    public LROSADsPostAsyncRelativeRetryInvalidHeaderResponse(int statusCode, LROSADsPostAsyncRelativeRetryInvalidHeaderHeaders headers, Map<String, String> rawHeaders, Void body) {
