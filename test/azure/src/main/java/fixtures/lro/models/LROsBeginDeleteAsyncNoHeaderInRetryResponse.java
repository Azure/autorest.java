...
public final class LROsBeginDeleteAsyncNoHeaderInRetryResponse extends RestResponse<LROsDeleteAsyncNoHeaderInRetryHeaders, Void> {
     ...
     */
    public LROsBeginDeleteAsyncNoHeaderInRetryResponse(int statusCode, LROsDeleteAsyncNoHeaderInRetryHeaders headers, Map<String, String> rawHeaders, Void body) {
