...
public final class LRORetrysPostAsyncRelativeRetrySucceededHeaders {
     ...
     * itself.
     */
    public LRORetrysPostAsyncRelativeRetrySucceededHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LRORetrysPostAsyncRelativeRetrySucceededHeaders location(String location) {
     ...
     * itself.
     */
    public LRORetrysPostAsyncRelativeRetrySucceededHeaders retryAfter(Integer retryAfter) {
