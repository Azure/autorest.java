...
public final class LROSADsResumeDeleteAsyncRelativeRetryInvalidJsonPollingResponse extends RestResponse<LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeaders, Void> {
     ...
     */
    public LROSADsResumeDeleteAsyncRelativeRetryInvalidJsonPollingResponse(int statusCode, LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeaders headers, Map<String, String> rawHeaders, Void body) {
