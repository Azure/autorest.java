...
public final class LRORetrysBeginDeleteAsyncRelativeRetrySucceededResponse extends RestResponse<LRORetrysDeleteAsyncRelativeRetrySucceededHeaders, Void> {
     ...
     */
    public LRORetrysBeginDeleteAsyncRelativeRetrySucceededResponse(int statusCode, LRORetrysDeleteAsyncRelativeRetrySucceededHeaders headers, Map<String, String> rawHeaders, Void body) {
