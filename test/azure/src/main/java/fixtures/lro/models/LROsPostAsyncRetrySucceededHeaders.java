...
public final class LROsPostAsyncRetrySucceededHeaders {
     ...
     */
    public LROsPostAsyncRetrySucceededHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsPostAsyncRetrySucceededHeaders object itself.
     */
    public LROsPostAsyncRetrySucceededHeaders location(String location) {
     ...
     * @return the LROsPostAsyncRetrySucceededHeaders object itself.
     */
    public LROsPostAsyncRetrySucceededHeaders retryAfter(Integer retryAfter) {
