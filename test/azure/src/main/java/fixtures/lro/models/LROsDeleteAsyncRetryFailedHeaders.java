...
public final class LROsDeleteAsyncRetryFailedHeaders {
     ...
     */
    public LROsDeleteAsyncRetryFailedHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsDeleteAsyncRetryFailedHeaders object itself.
     */
    public LROsDeleteAsyncRetryFailedHeaders location(String location) {
     ...
     * @return the LROsDeleteAsyncRetryFailedHeaders object itself.
     */
    public LROsDeleteAsyncRetryFailedHeaders retryAfter(Integer retryAfter) {
