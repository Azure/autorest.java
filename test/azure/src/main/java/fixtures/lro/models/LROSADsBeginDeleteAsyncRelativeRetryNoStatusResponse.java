...
public final class LROSADsBeginDeleteAsyncRelativeRetryNoStatusResponse extends RestResponse<LROSADsDeleteAsyncRelativeRetryNoStatusHeaders, Void> {
     ...
     */
    public LROSADsBeginDeleteAsyncRelativeRetryNoStatusResponse(int statusCode, LROSADsDeleteAsyncRelativeRetryNoStatusHeaders headers, Map<String, String> rawHeaders, Void body) {
