...
public final class LROSADsResumeDeleteAsyncRelativeRetryInvalidHeaderResponse extends RestResponse<LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeaders, Void> {
     ...
     */
    public LROSADsResumeDeleteAsyncRelativeRetryInvalidHeaderResponse(int statusCode, LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeaders headers, Map<String, String> rawHeaders, Void body) {
