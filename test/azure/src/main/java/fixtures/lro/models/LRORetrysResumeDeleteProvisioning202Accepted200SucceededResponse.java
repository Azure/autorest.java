...
public final class LRORetrysResumeDeleteProvisioning202Accepted200SucceededResponse extends RestResponse<LRORetrysDeleteProvisioning202Accepted200SucceededHeaders, Product> {
     ...
     */
    public LRORetrysResumeDeleteProvisioning202Accepted200SucceededResponse(int statusCode, LRORetrysDeleteProvisioning202Accepted200SucceededHeaders headers, Map<String, String> rawHeaders, Product body) {
