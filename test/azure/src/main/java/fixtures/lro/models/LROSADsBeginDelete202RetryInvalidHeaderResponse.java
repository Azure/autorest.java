...
public final class LROSADsBeginDelete202RetryInvalidHeaderResponse extends RestResponse<LROSADsDelete202RetryInvalidHeaderHeaders, Void> {
     ...
     */
    public LROSADsBeginDelete202RetryInvalidHeaderResponse(int statusCode, LROSADsDelete202RetryInvalidHeaderHeaders headers, Map<String, String> rawHeaders, Void body) {
