...
public final class LROSADsResumePostAsyncRelativeRetryInvalidJsonPollingResponse extends RestResponse<LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeaders, Void> {
     ...
     */
    public LROSADsResumePostAsyncRelativeRetryInvalidJsonPollingResponse(int statusCode, LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeaders headers, Map<String, String> rawHeaders, Void body) {
