...
public final class LRORetrysResumePostAsyncRelativeRetrySucceededResponse extends RestResponse<LRORetrysPostAsyncRelativeRetrySucceededHeaders, Void> {
     ...
     */
    public LRORetrysResumePostAsyncRelativeRetrySucceededResponse(int statusCode, LRORetrysPostAsyncRelativeRetrySucceededHeaders headers, Map<String, String> rawHeaders, Void body) {
