...
public final class LROsPutAsyncNoRetrySucceededHeaders {
     ...
     */
    public LROsPutAsyncNoRetrySucceededHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsPutAsyncNoRetrySucceededHeaders object itself.
     */
    public LROsPutAsyncNoRetrySucceededHeaders location(String location) {
