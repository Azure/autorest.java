...
public final class LROSADsBeginDeleteAsyncRelativeRetry400Response extends RestResponse<LROSADsDeleteAsyncRelativeRetry400Headers, Void> {
     ...
     */
    public LROSADsBeginDeleteAsyncRelativeRetry400Response(int statusCode, LROSADsDeleteAsyncRelativeRetry400Headers headers, Map<String, String> rawHeaders, Void body) {
