...
public final class LROSADsPostAsyncRelativeRetryNoPayloadHeaders {
     ...
     */
    public LROSADsPostAsyncRelativeRetryNoPayloadHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROSADsPostAsyncRelativeRetryNoPayloadHeaders object itself.
     */
    public LROSADsPostAsyncRelativeRetryNoPayloadHeaders location(String location) {
     ...
     * @return the LROSADsPostAsyncRelativeRetryNoPayloadHeaders object itself.
     */
    public LROSADsPostAsyncRelativeRetryNoPayloadHeaders retryAfter(Integer retryAfter) {
