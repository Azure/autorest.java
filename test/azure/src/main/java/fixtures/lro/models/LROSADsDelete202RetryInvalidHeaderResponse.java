...
public final class LROSADsDelete202RetryInvalidHeaderResponse extends RestResponse<LROSADsDelete202RetryInvalidHeaderHeaders, Void> {
     ...
     */
    public LROSADsDelete202RetryInvalidHeaderResponse(int statusCode, LROSADsDelete202RetryInvalidHeaderHeaders headers, Map<String, String> rawHeaders, Void body) {
