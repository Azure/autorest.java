...
public final class LROSADsBeginPostAsyncRelativeRetryInvalidJsonPollingResponse extends RestResponse<LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeaders, Void> {
     ...
     */
    public LROSADsBeginPostAsyncRelativeRetryInvalidJsonPollingResponse(int statusCode, LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeaders headers, Map<String, String> rawHeaders, Void body) {
