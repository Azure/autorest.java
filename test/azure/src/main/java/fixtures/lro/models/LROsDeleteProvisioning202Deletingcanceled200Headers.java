...
public class LROsDeleteProvisioning202Deletingcanceled200Headers {
    ...
    /**
     * Get location to poll for result status: will be set to /lro/delete/provisioning/202/deleting/200/canceled.
     *
    ...
    /**
     * Set location to poll for result status: will be set to /lro/delete/provisioning/202/deleting/200/canceled.
     *
