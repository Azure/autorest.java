 ...
 */
public class LRORetrysDeleteProvisioning202Accepted200SucceededHeaders {
    /**
    ...
    /**
     * Get location to poll for result status: will be set to /lro/retryerror/delete/provisioning/202/accepted/200/succeeded.
     *
    ...
    /**
     * Set location to poll for result status: will be set to /lro/retryerror/delete/provisioning/202/accepted/200/succeeded.
     *
