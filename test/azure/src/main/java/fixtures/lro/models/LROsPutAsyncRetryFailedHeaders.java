...
public final class LROsPutAsyncRetryFailedHeaders {
     ...
     */
    public LROsPutAsyncRetryFailedHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsPutAsyncRetryFailedHeaders object itself.
     */
    public LROsPutAsyncRetryFailedHeaders location(String location) {
     ...
     * @return the LROsPutAsyncRetryFailedHeaders object itself.
     */
    public LROsPutAsyncRetryFailedHeaders retryAfter(Integer retryAfter) {
