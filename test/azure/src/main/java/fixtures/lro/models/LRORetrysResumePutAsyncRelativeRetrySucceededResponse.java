...
public final class LRORetrysResumePutAsyncRelativeRetrySucceededResponse extends RestResponse<LRORetrysPutAsyncRelativeRetrySucceededHeaders, Product> {
     ...
     */
    public LRORetrysResumePutAsyncRelativeRetrySucceededResponse(int statusCode, LRORetrysPutAsyncRelativeRetrySucceededHeaders headers, Map<String, String> rawHeaders, Product body) {
