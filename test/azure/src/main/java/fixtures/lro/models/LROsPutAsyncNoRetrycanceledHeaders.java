...
public final class LROsPutAsyncNoRetrycanceledHeaders {
     ...
     */
    public LROsPutAsyncNoRetrycanceledHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsPutAsyncNoRetrycanceledHeaders object itself.
     */
    public LROsPutAsyncNoRetrycanceledHeaders location(String location) {
