...
public final class LROSADsResumePutAsyncRelativeRetryNoStatusPayloadResponse extends RestResponse<LROSADsPutAsyncRelativeRetryNoStatusPayloadHeaders, Product> {
     ...
     */
    public LROSADsResumePutAsyncRelativeRetryNoStatusPayloadResponse(HttpRequest request, int statusCode, LROSADsPutAsyncRelativeRetryNoStatusPayloadHeaders headers, Map<String, String> rawHeaders, Product body) {
