...
public final class LROsPostAsyncRetryFailedHeaders {
     ...
     */
    public LROsPostAsyncRetryFailedHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsPostAsyncRetryFailedHeaders object itself.
     */
    public LROsPostAsyncRetryFailedHeaders location(String location) {
     ...
     * @return the LROsPostAsyncRetryFailedHeaders object itself.
     */
    public LROsPostAsyncRetryFailedHeaders retryAfter(Integer retryAfter) {
