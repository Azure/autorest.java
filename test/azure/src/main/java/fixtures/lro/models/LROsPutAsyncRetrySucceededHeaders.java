...
public final class LROsPutAsyncRetrySucceededHeaders {
     ...
     */
    public LROsPutAsyncRetrySucceededHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsPutAsyncRetrySucceededHeaders object itself.
     */
    public LROsPutAsyncRetrySucceededHeaders location(String location) {
     ...
     * @return the LROsPutAsyncRetrySucceededHeaders object itself.
     */
    public LROsPutAsyncRetrySucceededHeaders retryAfter(Integer retryAfter) {
