...
public final class LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeaders {
     ...
     * itself.
     */
    public LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeaders azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeaders location(String location) {
     ...
     * itself.
     */
    public LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeaders retryAfter(Integer retryAfter) {
