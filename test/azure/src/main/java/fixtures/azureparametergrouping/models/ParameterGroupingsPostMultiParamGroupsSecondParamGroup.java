 ...
 */
@Fluent
public final class ParameterGroupingsPostMultiParamGroupsSecondParamGroup {
    /*
     ...
     * @return the ParameterGroupingsPostMultiParamGroupsSecondParamGroup
     * object itself.
     */
    public ParameterGroupingsPostMultiParamGroupsSecondParamGroup headerTwo(String headerTwo) {
     ...
     * object itself.
     */
    public ParameterGroupingsPostMultiParamGroupsSecondParamGroup queryTwo(Integer queryTwo) {
