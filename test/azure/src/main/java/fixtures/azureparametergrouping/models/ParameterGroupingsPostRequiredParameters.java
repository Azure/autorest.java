...
public final class ParameterGroupingsPostRequiredParameters {
     ...
     */
    public ParameterGroupingsPostRequiredParameters body(int body) {
        this.body = body;
        return this;
    }
     ...
     * @return the ParameterGroupingsPostRequiredParameters object itself.
     */
    public ParameterGroupingsPostRequiredParameters customHeader(String customHeader) {
     ...
     * @return the ParameterGroupingsPostRequiredParameters object itself.
     */
    public ParameterGroupingsPostRequiredParameters query(Integer query) {
        this.query = query;
        return this;
    }
     ...
     * @return the ParameterGroupingsPostRequiredParameters object itself.
     */
    public ParameterGroupingsPostRequiredParameters path(String path) {
        this.path = path;
        return this;
    }
}
