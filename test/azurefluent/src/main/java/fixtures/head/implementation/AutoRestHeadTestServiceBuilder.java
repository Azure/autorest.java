...
public final class AutoRestHeadTestServiceBuilder {
     ...
     */
    public AutoRestHeadTestServiceBuilder acceptLanguage(String acceptLanguage) {
     ...
     * @return the AutoRestHeadTestServiceBuilder.
     */
    public AutoRestHeadTestServiceBuilder longRunningOperationRetryTimeout(Integer longRunningOperationRetryTimeout) {
     ...
     * @return the AutoRestHeadTestServiceBuilder.
     */
    public AutoRestHeadTestServiceBuilder generateClientRequestId(Boolean generateClientRequestId) {
     ...
     */
    public AutoRestHeadTestServiceImpl build() {
        if (pipeline == null) {
            this.pipeline = RestProxy.createDefaultPipeline();
        }
        AutoRestHeadTestServiceImpl client = new AutoRestHeadTestServiceImpl(pipeline, environment);
