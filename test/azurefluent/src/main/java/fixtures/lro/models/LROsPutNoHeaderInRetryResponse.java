 ...
 */
public final class LROsPutNoHeaderInRetryResponse extends ResponseBase<LROsPutNoHeaderInRetryHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsPutNoHeaderInRetryResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutNoHeaderInRetryHeadersInner headers) {
