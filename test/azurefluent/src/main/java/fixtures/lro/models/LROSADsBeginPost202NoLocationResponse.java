 ...
 */
public final class LROSADsBeginPost202NoLocationResponse extends ResponseBase<LROSADsPost202NoLocationHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsBeginPost202NoLocationResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsPost202NoLocationHeadersInner headers) {
