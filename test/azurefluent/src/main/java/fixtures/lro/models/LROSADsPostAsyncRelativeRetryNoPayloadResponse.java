 ...
 */
public final class LROSADsPostAsyncRelativeRetryNoPayloadResponse extends ResponseBase<LROSADsPostAsyncRelativeRetryNoPayloadHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsPostAsyncRelativeRetryNoPayloadResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsPostAsyncRelativeRetryNoPayloadHeadersInner headers) {
