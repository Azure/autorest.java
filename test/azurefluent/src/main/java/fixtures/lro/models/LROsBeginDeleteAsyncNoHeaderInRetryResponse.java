 ...
 */
public final class LROsBeginDeleteAsyncNoHeaderInRetryResponse extends ResponseBase<LROsDeleteAsyncNoHeaderInRetryHeadersInner, Void> {
    /**
     ...
     */
    public LROsBeginDeleteAsyncNoHeaderInRetryResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROsDeleteAsyncNoHeaderInRetryHeadersInner headers) {
