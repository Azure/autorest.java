 ...
 */
public final class LROsBeginDeleteAsyncRetrySucceededResponse extends ResponseBase<LROsDeleteAsyncRetrySucceededHeadersInner, Void> {
    /**
     ...
     */
    public LROsBeginDeleteAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROsDeleteAsyncRetrySucceededHeadersInner headers) {
