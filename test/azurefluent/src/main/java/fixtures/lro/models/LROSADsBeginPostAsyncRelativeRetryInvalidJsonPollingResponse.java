 ...
 */
public final class LROSADsBeginPostAsyncRelativeRetryInvalidJsonPollingResponse extends ResponseBase<LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsBeginPostAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeadersInner headers) {
