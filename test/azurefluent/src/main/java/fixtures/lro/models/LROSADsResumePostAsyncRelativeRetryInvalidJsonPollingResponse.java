 ...
 */
public final class LROSADsResumePostAsyncRelativeRetryInvalidJsonPollingResponse extends ResponseBase<LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsResumePostAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeadersInner headers) {
