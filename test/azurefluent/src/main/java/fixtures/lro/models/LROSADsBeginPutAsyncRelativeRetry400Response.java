...
public final class LROSADsBeginPutAsyncRelativeRetry400Response extends RestResponse<LROSADsPutAsyncRelativeRetry400HeadersInner, ProductInner> {
     ...
     */
    public LROSADsBeginPutAsyncRelativeRetry400Response(int statusCode, LROSADsPutAsyncRelativeRetry400HeadersInner headers, Map<String, String> rawHeaders, ProductInner body) {
