 ...
 */
public final class LROSADsBeginDelete202RetryInvalidHeaderResponse extends ResponseBase<LROSADsDelete202RetryInvalidHeaderHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsBeginDelete202RetryInvalidHeaderResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsDelete202RetryInvalidHeaderHeadersInner headers) {
