 ...
 */
public final class LROsResumePutAsyncNoRetrycanceledResponse extends ResponseBase<LROsPutAsyncNoRetrycanceledHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsResumePutAsyncNoRetrycanceledResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutAsyncNoRetrycanceledHeadersInner headers) {
