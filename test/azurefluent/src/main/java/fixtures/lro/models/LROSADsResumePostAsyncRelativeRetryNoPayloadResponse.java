 ...
 */
public final class LROSADsResumePostAsyncRelativeRetryNoPayloadResponse extends ResponseBase<LROSADsPostAsyncRelativeRetryNoPayloadHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsResumePostAsyncRelativeRetryNoPayloadResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsPostAsyncRelativeRetryNoPayloadHeadersInner headers) {
