...
public final class LROSADsDeleteAsyncRelativeRetryInvalidHeaderResponse extends RestResponse<LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeadersInner, Void> {
     ...
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidHeaderResponse(int statusCode, LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeadersInner headers, Map<String, String> rawHeaders, Void body) {
