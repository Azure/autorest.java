 ...
 */
public final class LROSADsPostAsyncRelativeRetryInvalidHeaderResponse extends ResponseBase<LROSADsPostAsyncRelativeRetryInvalidHeaderHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsPostAsyncRelativeRetryInvalidHeaderResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsPostAsyncRelativeRetryInvalidHeaderHeadersInner headers) {
