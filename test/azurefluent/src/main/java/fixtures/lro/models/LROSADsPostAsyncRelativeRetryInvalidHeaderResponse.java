...
public final class LROSADsPostAsyncRelativeRetryInvalidHeaderResponse extends RestResponse<LROSADsPostAsyncRelativeRetryInvalidHeaderHeadersInner, Void> {
     ...
     */
    public LROSADsPostAsyncRelativeRetryInvalidHeaderResponse(HttpRequest request, int statusCode, LROSADsPostAsyncRelativeRetryInvalidHeaderHeadersInner headers, Map<String, String> rawHeaders, Void body) {
