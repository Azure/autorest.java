 ...
 */
public final class LROsPutAsyncNoHeaderInRetryResponse extends ResponseBase<LROsPutAsyncNoHeaderInRetryHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsPutAsyncNoHeaderInRetryResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutAsyncNoHeaderInRetryHeadersInner headers) {
