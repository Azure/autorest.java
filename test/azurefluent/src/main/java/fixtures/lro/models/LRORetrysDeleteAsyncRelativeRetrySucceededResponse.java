 ...
 */
public final class LRORetrysDeleteAsyncRelativeRetrySucceededResponse extends ResponseBase<LRORetrysDeleteAsyncRelativeRetrySucceededHeadersInner, Void> {
    /**
     ...
     */
    public LRORetrysDeleteAsyncRelativeRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LRORetrysDeleteAsyncRelativeRetrySucceededHeadersInner headers) {
