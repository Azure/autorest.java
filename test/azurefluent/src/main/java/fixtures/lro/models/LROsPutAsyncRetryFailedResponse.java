 ...
 */
public final class LROsPutAsyncRetryFailedResponse extends ResponseBase<LROsPutAsyncRetryFailedHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsPutAsyncRetryFailedResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutAsyncRetryFailedHeadersInner headers) {
