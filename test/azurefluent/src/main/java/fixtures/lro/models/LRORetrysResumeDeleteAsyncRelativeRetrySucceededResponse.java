 ...
 */
public final class LRORetrysResumeDeleteAsyncRelativeRetrySucceededResponse extends ResponseBase<LRORetrysDeleteAsyncRelativeRetrySucceededHeadersInner, Void> {
    /**
     ...
     */
    public LRORetrysResumeDeleteAsyncRelativeRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LRORetrysDeleteAsyncRelativeRetrySucceededHeadersInner headers) {
