 ...
 */
public final class LROSADsBeginPutAsyncRelativeRetryNoStatusResponse extends ResponseBase<LROSADsPutAsyncRelativeRetryNoStatusHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROSADsBeginPutAsyncRelativeRetryNoStatusResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROSADsPutAsyncRelativeRetryNoStatusHeadersInner headers) {
