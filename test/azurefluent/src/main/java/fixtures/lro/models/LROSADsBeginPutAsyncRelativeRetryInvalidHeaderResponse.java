 ...
 */
public final class LROSADsBeginPutAsyncRelativeRetryInvalidHeaderResponse extends ResponseBase<LROSADsPutAsyncRelativeRetryInvalidHeaderHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROSADsBeginPutAsyncRelativeRetryInvalidHeaderResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROSADsPutAsyncRelativeRetryInvalidHeaderHeadersInner headers) {
