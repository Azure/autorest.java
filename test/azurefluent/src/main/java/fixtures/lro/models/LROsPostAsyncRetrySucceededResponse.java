 ...
 */
public final class LROsPostAsyncRetrySucceededResponse extends ResponseBase<LROsPostAsyncRetrySucceededHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsPostAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPostAsyncRetrySucceededHeadersInner headers) {
