 ...
 */
public final class LROSADsDeleteAsyncRelativeRetryNoStatusResponse extends ResponseBase<LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsDeleteAsyncRelativeRetryNoStatusResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner headers) {
