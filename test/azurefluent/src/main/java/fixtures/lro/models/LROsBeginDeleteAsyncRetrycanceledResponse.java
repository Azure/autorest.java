...
public final class LROsBeginDeleteAsyncRetrycanceledResponse extends RestResponse<LROsDeleteAsyncRetrycanceledHeadersInner, Void> {
     ...
     */
    public LROsBeginDeleteAsyncRetrycanceledResponse(int statusCode, LROsDeleteAsyncRetrycanceledHeadersInner headers, Map<String, String> rawHeaders, Void body) {
