...
public final class LROSADsBeginPutAsyncRelativeRetryInvalidJsonPollingResponse extends RestResponse<LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner, ProductInner> {
     ...
     */
    public LROSADsBeginPutAsyncRelativeRetryInvalidJsonPollingResponse(int statusCode, LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner headers, Map<String, String> rawHeaders, ProductInner body) {
