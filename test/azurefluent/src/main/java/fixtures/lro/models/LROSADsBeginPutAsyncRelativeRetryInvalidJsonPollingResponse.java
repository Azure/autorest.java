 ...
 */
public final class LROSADsBeginPutAsyncRelativeRetryInvalidJsonPollingResponse extends ResponseBase<LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROSADsBeginPutAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner headers) {
