 ...
 */
public final class LROsBeginPutAsyncNoRetrySucceededResponse extends ResponseBase<LROsPutAsyncNoRetrySucceededHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsBeginPutAsyncNoRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutAsyncNoRetrySucceededHeadersInner headers) {
