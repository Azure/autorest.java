...
public final class LROSADsPutAsyncRelativeRetryNoStatusPayloadResponse extends RestResponse<LROSADsPutAsyncRelativeRetryNoStatusPayloadHeadersInner, ProductInner> {
     ...
     */
    public LROSADsPutAsyncRelativeRetryNoStatusPayloadResponse(int statusCode, LROSADsPutAsyncRelativeRetryNoStatusPayloadHeadersInner headers, Map<String, String> rawHeaders, ProductInner body) {
