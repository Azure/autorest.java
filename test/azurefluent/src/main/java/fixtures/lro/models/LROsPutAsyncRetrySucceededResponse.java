 ...
 */
public final class LROsPutAsyncRetrySucceededResponse extends ResponseBase<LROsPutAsyncRetrySucceededHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsPutAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutAsyncRetrySucceededHeadersInner headers) {
