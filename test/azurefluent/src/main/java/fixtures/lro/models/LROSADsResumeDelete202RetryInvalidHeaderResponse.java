 ...
 */
public final class LROSADsResumeDelete202RetryInvalidHeaderResponse extends RestResponse<LROSADsDelete202RetryInvalidHeaderHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsResumeDelete202RetryInvalidHeaderResponse(HttpRequest request, int statusCode, LROSADsDelete202RetryInvalidHeaderHeadersInner headers, Map<String, String> rawHeaders, Void body) {
