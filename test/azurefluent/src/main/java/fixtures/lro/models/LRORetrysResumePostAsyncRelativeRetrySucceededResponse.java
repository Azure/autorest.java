 ...
 */
public final class LRORetrysResumePostAsyncRelativeRetrySucceededResponse extends ResponseBase<LRORetrysPostAsyncRelativeRetrySucceededHeadersInner, Void> {
    /**
     ...
     */
    public LRORetrysResumePostAsyncRelativeRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LRORetrysPostAsyncRelativeRetrySucceededHeadersInner headers) {
