...
public final class LROSADsResumeDeleteAsyncRelativeRetryInvalidJsonPollingResponse extends RestResponse<LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner, Void> {
     ...
     */
    public LROSADsResumeDeleteAsyncRelativeRetryInvalidJsonPollingResponse(int statusCode, LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner headers, Map<String, String> rawHeaders, Void body) {
