 ...
 */
public final class LROSADsResumeDeleteAsyncRelativeRetryInvalidJsonPollingResponse extends ResponseBase<LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsResumeDeleteAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner headers) {
