...
public final class LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingResponse extends RestResponse<LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner, Void> {
     ...
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingResponse(int statusCode, LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner headers, Map<String, String> rawHeaders, Void body) {
