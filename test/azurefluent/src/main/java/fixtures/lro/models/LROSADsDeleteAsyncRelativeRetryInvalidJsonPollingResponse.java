 ...
 */
public final class LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingResponse extends ResponseBase<LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner headers) {
