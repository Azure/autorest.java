 ...
 */
public final class LROsDeleteProvisioning202Accepted200SucceededResponse extends RestResponse<LROsDeleteProvisioning202Accepted200SucceededHeaders, ProductInner> {
    /**
     ...
     */
    public LROsDeleteProvisioning202Accepted200SucceededResponse(HttpRequest request, int statusCode, LROsDeleteProvisioning202Accepted200SucceededHeaders headers, Map<String, String> rawHeaders, ProductInner body) {
