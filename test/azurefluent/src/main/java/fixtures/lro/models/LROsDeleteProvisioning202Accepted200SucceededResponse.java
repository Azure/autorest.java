...
public final class LROsDeleteProvisioning202Accepted200SucceededResponse extends RestResponse<LROsDeleteProvisioning202Accepted200SucceededHeadersInner, ProductInner> {
     ...
     */
    public LROsDeleteProvisioning202Accepted200SucceededResponse(int statusCode, LROsDeleteProvisioning202Accepted200SucceededHeadersInner headers, Map<String, String> rawHeaders, ProductInner body) {
