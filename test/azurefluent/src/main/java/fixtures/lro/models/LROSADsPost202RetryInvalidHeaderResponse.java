...
public final class LROSADsPost202RetryInvalidHeaderResponse extends RestResponse<LROSADsPost202RetryInvalidHeaderHeadersInner, Void> {
     ...
     */
    public LROSADsPost202RetryInvalidHeaderResponse(int statusCode, LROSADsPost202RetryInvalidHeaderHeadersInner headers, Map<String, String> rawHeaders, Void body) {
