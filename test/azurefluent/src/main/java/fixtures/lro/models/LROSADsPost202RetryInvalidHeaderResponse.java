 ...
 */
public final class LROSADsPost202RetryInvalidHeaderResponse extends ResponseBase<LROSADsPost202RetryInvalidHeaderHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsPost202RetryInvalidHeaderResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsPost202RetryInvalidHeaderHeadersInner headers) {
