 ...
 */
public final class LROSADsPostAsyncRelativeRetryInvalidJsonPollingResponse extends ResponseBase<LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsPostAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsPostAsyncRelativeRetryInvalidJsonPollingHeadersInner headers) {
