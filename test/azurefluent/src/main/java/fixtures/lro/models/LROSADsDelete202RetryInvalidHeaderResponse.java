 ...
 */
public final class LROSADsDelete202RetryInvalidHeaderResponse extends ResponseBase<LROSADsDelete202RetryInvalidHeaderHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsDelete202RetryInvalidHeaderResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsDelete202RetryInvalidHeaderHeadersInner headers) {
