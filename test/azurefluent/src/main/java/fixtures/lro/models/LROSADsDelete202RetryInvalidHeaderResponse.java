 ...
 */
public final class LROSADsDelete202RetryInvalidHeaderResponse extends RestResponse<LROSADsDelete202RetryInvalidHeaderHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsDelete202RetryInvalidHeaderResponse(HttpRequest request, int statusCode, LROSADsDelete202RetryInvalidHeaderHeadersInner headers, Map<String, String> rawHeaders, Void body) {
