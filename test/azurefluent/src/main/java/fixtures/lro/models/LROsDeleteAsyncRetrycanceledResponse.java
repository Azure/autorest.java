 ...
 */
public final class LROsDeleteAsyncRetrycanceledResponse extends ResponseBase<LROsDeleteAsyncRetrycanceledHeadersInner, Void> {
    /**
     ...
     */
    public LROsDeleteAsyncRetrycanceledResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROsDeleteAsyncRetrycanceledHeadersInner headers) {
