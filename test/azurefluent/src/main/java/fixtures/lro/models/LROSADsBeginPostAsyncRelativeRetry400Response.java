...
public final class LROSADsBeginPostAsyncRelativeRetry400Response extends RestResponse<LROSADsPostAsyncRelativeRetry400HeadersInner, Void> {
     ...
     */
    public LROSADsBeginPostAsyncRelativeRetry400Response(HttpRequest request, int statusCode, LROSADsPostAsyncRelativeRetry400HeadersInner headers, Map<String, String> rawHeaders, Void body) {
