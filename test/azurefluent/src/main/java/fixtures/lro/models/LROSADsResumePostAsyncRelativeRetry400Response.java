...
public final class LROSADsResumePostAsyncRelativeRetry400Response extends RestResponse<LROSADsPostAsyncRelativeRetry400HeadersInner, Void> {
     ...
     */
    public LROSADsResumePostAsyncRelativeRetry400Response(int statusCode, LROSADsPostAsyncRelativeRetry400HeadersInner headers, Map<String, String> rawHeaders, Void body) {
