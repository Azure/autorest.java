 ...
 */
public final class LROsResumePostAsyncRetrySucceededResponse extends ResponseBase<LROsPostAsyncRetrySucceededHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsResumePostAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPostAsyncRetrySucceededHeadersInner headers) {
