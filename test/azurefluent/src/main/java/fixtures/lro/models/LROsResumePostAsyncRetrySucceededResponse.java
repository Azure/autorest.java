...
public final class LROsResumePostAsyncRetrySucceededResponse extends RestResponse<LROsPostAsyncRetrySucceededHeadersInner, ProductInner> {
     ...
     */
    public LROsResumePostAsyncRetrySucceededResponse(int statusCode, LROsPostAsyncRetrySucceededHeadersInner headers, Map<String, String> rawHeaders, ProductInner body) {
