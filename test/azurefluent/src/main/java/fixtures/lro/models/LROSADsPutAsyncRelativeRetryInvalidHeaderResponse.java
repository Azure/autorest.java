 ...
 */
public final class LROSADsPutAsyncRelativeRetryInvalidHeaderResponse extends ResponseBase<LROSADsPutAsyncRelativeRetryInvalidHeaderHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROSADsPutAsyncRelativeRetryInvalidHeaderResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROSADsPutAsyncRelativeRetryInvalidHeaderHeadersInner headers) {
