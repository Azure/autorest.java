...
public final class LROSADsBeginDeleteAsyncRelativeRetry400Response extends RestResponse<LROSADsDeleteAsyncRelativeRetry400HeadersInner, Void> {
     ...
     */
    public LROSADsBeginDeleteAsyncRelativeRetry400Response(int statusCode, LROSADsDeleteAsyncRelativeRetry400HeadersInner headers, Map<String, String> rawHeaders, Void body) {
