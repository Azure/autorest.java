 ...
 */
public final class LROsResumePutAsyncRetrySucceededResponse extends ResponseBase<LROsPutAsyncRetrySucceededHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROsResumePutAsyncRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROsPutAsyncRetrySucceededHeadersInner headers) {
