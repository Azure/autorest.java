 ...
 */
public final class LROSADsResumePutAsyncRelativeRetryInvalidJsonPollingResponse extends ResponseBase<LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner, ProductInner> {
    /**
     ...
     */
    public LROSADsResumePutAsyncRelativeRetryInvalidJsonPollingResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, ProductInner value, LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner headers) {
