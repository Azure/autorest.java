 ...
 */
public final class LRORetrysPostAsyncRelativeRetrySucceededResponse extends ResponseBase<LRORetrysPostAsyncRelativeRetrySucceededHeadersInner, Void> {
    /**
     ...
     */
    public LRORetrysPostAsyncRelativeRetrySucceededResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LRORetrysPostAsyncRelativeRetrySucceededHeadersInner headers) {
