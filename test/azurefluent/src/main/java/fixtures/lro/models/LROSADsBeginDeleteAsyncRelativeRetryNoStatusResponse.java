...
public final class LROSADsBeginDeleteAsyncRelativeRetryNoStatusResponse extends RestResponse<LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner, Void> {
     ...
     */
    public LROSADsBeginDeleteAsyncRelativeRetryNoStatusResponse(int statusCode, LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner headers, Map<String, String> rawHeaders, Void body) {
