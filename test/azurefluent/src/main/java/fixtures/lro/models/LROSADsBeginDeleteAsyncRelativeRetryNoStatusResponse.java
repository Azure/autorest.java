 ...
 */
public final class LROSADsBeginDeleteAsyncRelativeRetryNoStatusResponse extends ResponseBase<LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner, Void> {
    /**
     ...
     */
    public LROSADsBeginDeleteAsyncRelativeRetryNoStatusResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner headers) {
