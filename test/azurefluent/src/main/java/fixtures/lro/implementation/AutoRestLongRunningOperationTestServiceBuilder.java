...
public final class AutoRestLongRunningOperationTestServiceBuilder {
     ...
     */
    public AutoRestLongRunningOperationTestServiceBuilder acceptLanguage(String acceptLanguage) {
     ...
     * @return the AutoRestLongRunningOperationTestServiceBuilder.
     */
    public AutoRestLongRunningOperationTestServiceBuilder longRunningOperationRetryTimeout(Integer longRunningOperationRetryTimeout) {
     ...
     * @return the AutoRestLongRunningOperationTestServiceBuilder.
     */
    public AutoRestLongRunningOperationTestServiceBuilder generateClientRequestId(Boolean generateClientRequestId) {
     ...
     */
    public AutoRestLongRunningOperationTestServiceImpl build() {
        if (pipeline == null) {
            this.pipeline = RestProxy.createDefaultPipeline();
        }
        AutoRestLongRunningOperationTestServiceImpl client = new AutoRestLongRunningOperationTestServiceImpl(pipeline, environment);
