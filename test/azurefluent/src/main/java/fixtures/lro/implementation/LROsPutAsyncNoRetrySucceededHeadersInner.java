 ...
 */
@Fluent
public final class LROsPutAsyncNoRetrySucceededHeadersInner {
    /*
     ...
     */
    public LROsPutAsyncNoRetrySucceededHeadersInner azureAsyncOperation(String azureAsyncOperation) {
     ...
     * @return the LROsPutAsyncNoRetrySucceededHeadersInner object itself.
     */
    public LROsPutAsyncNoRetrySucceededHeadersInner location(String location) {
