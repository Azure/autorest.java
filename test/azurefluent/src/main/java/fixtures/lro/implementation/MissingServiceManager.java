...
public final class MissingServiceManager extends Manager<MissingServiceManager, AutoRestLongRunningOperationTestServiceImpl> {
    /**
    ...
    private MissingServiceManager(RestClient restClient, String subscriptionId) {
        super(
            restClient,
            subscriptionId,
            new AutoRestLongRunningOperationTestServiceImpl(restClient).withSubscriptionId(subscriptionId));
    }
}
