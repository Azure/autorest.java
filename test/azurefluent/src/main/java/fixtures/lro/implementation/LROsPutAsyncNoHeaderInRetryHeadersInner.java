 ...
 */
@Fluent
public final class LROsPutAsyncNoHeaderInRetryHeadersInner {
    /*
     ...
     */
    public LROsPutAsyncNoHeaderInRetryHeadersInner azureAsyncOperation(String azureAsyncOperation) {
