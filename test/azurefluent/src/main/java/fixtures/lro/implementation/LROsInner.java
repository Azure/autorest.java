...
public class LROsInner {
    ...
    public Observable<ServiceResponse<SkuInner>> post200WithPayloadWithServiceResponseAsync() {
        ...
        return client.getAzureClient().getPostOrDeleteResultAsync(observable, new LongRunningOperationOptions().withFinalStateVia(LongRunningFinalState.AZURE_ASYNC_OPERATION), new TypeToken<SkuInner>() { }.getType());
    }
    ...
    public Observable<ServiceResponseWithHeaders<ProductInner, LROsPost202NoRetry204Headers>> post202NoRetry204WithServiceResponseAsync() {
        ...
        return client.getAzureClient().getPostOrDeleteResultWithHeadersAsync(observable, new LongRunningOperationOptions().withFinalStateVia(LongRunningFinalState.AZURE_ASYNC_OPERATION), new TypeToken<ProductInner>() { }.getType(), LROsPost202NoRetry204Headers.class);
    }
    /**
     * Long running post request, service returns a 202 to the initial request, with 'Location' header, 204 with noresponse body after success.
     *
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ProductInner> postDoubleHeadersFinalAzureHeaderGetDefaultAsync(final ServiceCallback<ProductInner> serviceCallback) {
     ...
     * @return the observable for the request
     */
    public Observable<ProductInner> postDoubleHeadersFinalAzureHeaderGetDefaultAsync() {
        return postDoubleHeadersFinalAzureHeaderGetDefaultWithServiceResponseAsync().map(new Func1<ServiceResponse<ProductInner>, ProductInner>() {
            @Override
            public ProductInner call(ServiceResponse<ProductInner> response) {
                return response.body();
            }
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponse<ProductInner>> postDoubleHeadersFinalAzureHeaderGetDefaultWithServiceResponseAsync() {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ProductInner> beginPostDoubleHeadersFinalAzureHeaderGetDefaultAsync(final ServiceCallback<ProductInner> serviceCallback) {
     ...
     * @return the observable to the ProductInner object
     */
    public Observable<ProductInner> beginPostDoubleHeadersFinalAzureHeaderGetDefaultAsync() {
        return beginPostDoubleHeadersFinalAzureHeaderGetDefaultWithServiceResponseAsync().map(new Func1<ServiceResponse<ProductInner>, ProductInner>() {
            @Override
            public ProductInner call(ServiceResponse<ProductInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ProductInner object
     */
    public Observable<ServiceResponse<ProductInner>> beginPostDoubleHeadersFinalAzureHeaderGetDefaultWithServiceResponseAsync() {
        return service.beginPostDoubleHeadersFinalAzureHeaderGetDefault(this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ProductInner>>>() {
                @Override
                public Observable<ServiceResponse<ProductInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<ProductInner> clientResponse = beginPostDoubleHeadersFinalAzureHeaderGetDefaultDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<ProductInner> beginPostDoubleHeadersFinalAzureHeaderGetDefaultDelegate(Response<ResponseBody> response) throws CloudException, IOException {
        return this.client.restClient().responseBuilderFactory().<ProductInner, CloudException>newInstance(this.client.serializerAdapter())
                .register(202, new TypeToken<ProductInner>() { }.getType())
                .registerError(CloudException.class)
                .build(response);
    ...
    public Observable<ServiceResponseWithHeaders<ProductInner, LROsPostAsyncRetrySucceededHeaders>> postAsyncRetrySucceededWithServiceResponseAsync() {
        ...
        return client.getAzureClient().getPostOrDeleteResultWithHeadersAsync(observable, new LongRunningOperationOptions().withFinalStateVia(LongRunningFinalState.AZURE_ASYNC_OPERATION), new TypeToken<ProductInner>() { }.getType(), LROsPostAsyncRetrySucceededHeaders.class);
    }
    /**
     * Long running post request, service returns a 202 to the initial request, with an entity that contains ProvisioningState=’Creating’. Poll the endpoint indicated in the Azure-AsyncOperation header for operation status.
     *
    ...
    public Observable<ServiceResponseWithHeaders<ProductInner, LROsPostAsyncNoRetrySucceededHeaders>> postAsyncNoRetrySucceededWithServiceResponseAsync() {
        ...
        return client.getAzureClient().getPostOrDeleteResultWithHeadersAsync(observable, new LongRunningOperationOptions().withFinalStateVia(LongRunningFinalState.AZURE_ASYNC_OPERATION), new TypeToken<ProductInner>() { }.getType(), LROsPostAsyncNoRetrySucceededHeaders.class);
    }
    /**
     * Long running post request, service returns a 202 to the initial request, with an entity that contains ProvisioningState=’Creating’. Poll the endpoint indicated in the Azure-AsyncOperation header for operation status.
     *
