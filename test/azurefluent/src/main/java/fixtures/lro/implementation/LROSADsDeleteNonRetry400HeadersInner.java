 ...
 */
@Fluent
public final class LROSADsDeleteNonRetry400HeadersInner {
    /*
     ...
     */
    public LROSADsDeleteNonRetry400HeadersInner location(String location) {
     ...
     * @return the LROSADsDeleteNonRetry400HeadersInner object itself.
     */
    public LROSADsDeleteNonRetry400HeadersInner retryAfter(Integer retryAfter) {
