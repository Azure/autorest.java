 ...
 */
@Fluent
public final class LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner {
    /*
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner location(String location) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryNoStatusHeadersInner retryAfter(Integer retryAfter) {
