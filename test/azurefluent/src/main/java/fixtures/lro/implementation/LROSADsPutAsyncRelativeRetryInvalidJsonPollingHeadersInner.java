 ...
 */
@Fluent
public final class LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner {
    /*
     ...
     * status: will be set to /lro/putasync/retry/failed/operationResults/200.
     *
     ...
     * @return the LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner
     * object itself.
     */
    public LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner azureAsyncOperation(String azureAsyncOperation) {
     ...
     * object itself.
     */
    public LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner location(String location) {
     ...
     * object itself.
     */
    public LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner retryAfter(Integer retryAfter) {
