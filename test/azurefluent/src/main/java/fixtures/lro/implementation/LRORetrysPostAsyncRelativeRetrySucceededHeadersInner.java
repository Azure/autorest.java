 ...
 */
@Fluent
public final class LRORetrysPostAsyncRelativeRetrySucceededHeadersInner {
    /*
     ...
     * itself.
     */
    public LRORetrysPostAsyncRelativeRetrySucceededHeadersInner azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LRORetrysPostAsyncRelativeRetrySucceededHeadersInner location(String location) {
     ...
     * itself.
     */
    public LRORetrysPostAsyncRelativeRetrySucceededHeadersInner retryAfter(Integer retryAfter) {
