...
public final class LROSADsDeleteAsyncRelativeRetry400HeadersInner {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetry400HeadersInner azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetry400HeadersInner location(String location) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetry400HeadersInner retryAfter(Integer retryAfter) {
