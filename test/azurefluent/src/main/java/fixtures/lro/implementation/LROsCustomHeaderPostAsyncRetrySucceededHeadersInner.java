...
public final class LROsCustomHeaderPostAsyncRetrySucceededHeadersInner {
     ...
     * itself.
     */
    public LROsCustomHeaderPostAsyncRetrySucceededHeadersInner azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROsCustomHeaderPostAsyncRetrySucceededHeadersInner location(String location) {
     ...
     * itself.
     */
    public LROsCustomHeaderPostAsyncRetrySucceededHeadersInner retryAfter(Integer retryAfter) {
