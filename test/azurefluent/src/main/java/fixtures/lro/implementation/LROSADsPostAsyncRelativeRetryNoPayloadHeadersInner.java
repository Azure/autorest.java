...
public final class LROSADsPostAsyncRelativeRetryNoPayloadHeadersInner {
     ...
     * itself.
     */
    public LROSADsPostAsyncRelativeRetryNoPayloadHeadersInner azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROSADsPostAsyncRelativeRetryNoPayloadHeadersInner location(String location) {
     ...
     * itself.
     */
    public LROSADsPostAsyncRelativeRetryNoPayloadHeadersInner retryAfter(Integer retryAfter) {
