...
public final class LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner azureAsyncOperation(String azureAsyncOperation) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner location(String location) {
     ...
     * itself.
     */
    public LROSADsDeleteAsyncRelativeRetryInvalidJsonPollingHeadersInner retryAfter(Integer retryAfter) {
