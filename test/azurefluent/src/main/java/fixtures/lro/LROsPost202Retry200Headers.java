 ...
 */
public class LROsPost202Retry200Headers {
    /**
    ...
    /**
     * Get location to poll for result status: will be set to /lro/post/202/retry/200.
     *
    ...
    /**
     * Set location to poll for result status: will be set to /lro/post/202/retry/200.
     *
