 ...
 */
public final class HeadersCustomNamedRequestIdResponse extends RestResponse<HeaderCustomNamedRequestIdHeadersInner, Void> {
    /**
     ...
     */
    public HeadersCustomNamedRequestIdResponse(HttpRequest request, int statusCode, HeaderCustomNamedRequestIdHeadersInner headers, Map<String, String> rawHeaders, Void body) {
