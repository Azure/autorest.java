 ...
 */
public final class HeadersCustomNamedRequestIdParamGroupingResponse extends RestResponse<HeaderCustomNamedRequestIdParamGroupingHeadersInner, Void> {
    /**
     ...
     */
    public HeadersCustomNamedRequestIdParamGroupingResponse(HttpRequest request, int statusCode, HeaderCustomNamedRequestIdParamGroupingHeadersInner headers, Map<String, String> rawHeaders, Void body) {
