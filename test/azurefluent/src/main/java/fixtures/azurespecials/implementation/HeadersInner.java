...
public final class HeadersInner {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    public void customNamedRequestIdParamGrouping(@NonNull HeadersCustomNamedRequestIdParamGroupingParametersInner headersCustomNamedRequestIdParamGroupingParameters) {
     ...
     * @return a ServiceFuture which will be completed with the result of the network request.
     */
    public ServiceFuture<Void> customNamedRequestIdParamGroupingAsync(@NonNull HeadersCustomNamedRequestIdParamGroupingParametersInner headersCustomNamedRequestIdParamGroupingParameters, ServiceCallback<Void> serviceCallback) {
     ...
     * @return a Mono which performs the network request upon subscription.
     */
    public Mono<HeadersCustomNamedRequestIdParamGroupingResponse> customNamedRequestIdParamGroupingWithRestResponseAsync(@NonNull HeadersCustomNamedRequestIdParamGroupingParametersInner headersCustomNamedRequestIdParamGroupingParameters) {
     ...
     * @return a Mono which performs the network request upon subscription.
     */
    public Mono<Void> customNamedRequestIdParamGroupingAsync(@NonNull HeadersCustomNamedRequestIdParamGroupingParametersInner headersCustomNamedRequestIdParamGroupingParameters) {
