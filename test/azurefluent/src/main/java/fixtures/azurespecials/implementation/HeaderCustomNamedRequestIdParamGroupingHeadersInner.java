 ...
 */
@Fluent
public final class HeaderCustomNamedRequestIdParamGroupingHeadersInner {
    /*
     ...
     * itself.
     */
    public HeaderCustomNamedRequestIdParamGroupingHeadersInner fooRequestId(String fooRequestId) {
