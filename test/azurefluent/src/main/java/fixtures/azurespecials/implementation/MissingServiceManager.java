...
public final class MissingServiceManager extends Manager<MissingServiceManager, AutoRestAzureSpecialParametersTestClientImpl> {
    /**
    ...
    private MissingServiceManager(RestClient restClient, String subscriptionId) {
        super(
            restClient,
            subscriptionId,
            new AutoRestAzureSpecialParametersTestClientImpl(restClient).withSubscriptionId(subscriptionId));
    }
}
