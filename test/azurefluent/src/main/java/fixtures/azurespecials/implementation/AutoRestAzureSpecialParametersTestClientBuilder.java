...
/**
 * A builder for creating a new instance of the AutoRestAzureSpecialParametersTestClientImpl type.
 */
@ServiceClientBuilder(serviceClients = AutoRestAzureSpecialParametersTestClientImpl.class)
public final class AutoRestAzureSpecialParametersTestClientBuilder {
     ...
     * @return the AutoRestAzureSpecialParametersTestClientBuilder.
     */
    public AutoRestAzureSpecialParametersTestClientBuilder acceptLanguage(String acceptLanguage) {
     ...
     * @return the AutoRestAzureSpecialParametersTestClientBuilder.
     */
    public AutoRestAzureSpecialParametersTestClientBuilder longRunningOperationRetryTimeout(Integer longRunningOperationRetryTimeout) {
     ...
     * @return the AutoRestAzureSpecialParametersTestClientBuilder.
     */
    public AutoRestAzureSpecialParametersTestClientBuilder generateClientRequestId(Boolean generateClientRequestId) {
     ...
     * @return the AutoRestAzureSpecialParametersTestClientBuilder.
     */
    public AutoRestAzureSpecialParametersTestClientBuilder environment(AzureEnvironment environment) {
    ...
    /**
     * Builds an instance of AutoRestAzureSpecialParametersTestClientImpl with the provided parameters.
     *
     * @return an instance of AutoRestAzureSpecialParametersTestClientImpl.
     */
    public AutoRestAzureSpecialParametersTestClientImpl build() {
        if (pipeline == null) {
            this.pipeline = RestProxy.createDefaultPipeline();
        }
        AutoRestAzureSpecialParametersTestClientImpl client = new AutoRestAzureSpecialParametersTestClientImpl(pipeline, environment);
