...
public final class GroupsInner {
    ...
    private interface GroupsService {
        ...
        Mono<BodyResponse<SampleResourceGroupInner>> getSampleResourceGroup(@PathParam("subscriptionId") String subscriptionId, @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion, @HeaderParam("accept-language") String acceptLanguage);
    }
     ...
     */
    public ServiceFuture<SampleResourceGroupInner> getSampleResourceGroupAsync(@NonNull String resourceGroupName, ServiceCallback<SampleResourceGroupInner> serviceCallback) {
     ...
     */
    public Mono<BodyResponse<SampleResourceGroupInner>> getSampleResourceGroupWithRestResponseAsync(@NonNull String resourceGroupName) {
     ...
     * @return a Mono which performs the network request upon subscription.
     */
    public Mono<SampleResourceGroupInner> getSampleResourceGroupAsync(@NonNull String resourceGroupName) {
        return getSampleResourceGroupWithRestResponseAsync(resourceGroupName)
            .flatMap((BodyResponse<SampleResourceGroupInner> res) -> Mono.just(res.body()));
    }
}
