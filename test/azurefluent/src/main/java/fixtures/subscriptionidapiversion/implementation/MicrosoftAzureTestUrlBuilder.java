...
/**
 * A builder for creating a new instance of the MicrosoftAzureTestUrlImpl type.
 */
@ServiceClientBuilder(serviceClients = MicrosoftAzureTestUrlImpl.class)
public final class MicrosoftAzureTestUrlBuilder {
     ...
     * @return the MicrosoftAzureTestUrlBuilder.
     */
    public MicrosoftAzureTestUrlBuilder acceptLanguage(String acceptLanguage) {
     ...
     * @return the MicrosoftAzureTestUrlBuilder.
     */
    public MicrosoftAzureTestUrlBuilder longRunningOperationRetryTimeout(Integer longRunningOperationRetryTimeout) {
     ...
     * @return the MicrosoftAzureTestUrlBuilder.
     */
    public MicrosoftAzureTestUrlBuilder generateClientRequestId(Boolean generateClientRequestId) {
     ...
     * @return the MicrosoftAzureTestUrlBuilder.
     */
    public MicrosoftAzureTestUrlBuilder environment(AzureEnvironment environment) {
    ...
    /**
     * Builds an instance of MicrosoftAzureTestUrlImpl with the provided parameters.
     *
     * @return an instance of MicrosoftAzureTestUrlImpl.
     */
    public MicrosoftAzureTestUrlImpl build() {
        if (pipeline == null) {
            this.pipeline = RestProxy.createDefaultPipeline();
        }
        MicrosoftAzureTestUrlImpl client = new MicrosoftAzureTestUrlImpl(pipeline, environment);
