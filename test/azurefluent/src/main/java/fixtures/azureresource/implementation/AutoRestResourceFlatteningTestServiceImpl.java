 ...
 */
public final class AutoRestResourceFlatteningTestServiceImpl {
    /**
    ...
    private interface AutoRestResourceFlatteningTestServiceService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SimpleResponse<List<FlattenedProductInner>>> getArray(@HeaderParam("accept-language") String acceptLanguage);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SimpleResponse<Map<String, FlattenedProductInner>>> getDictionary(@HeaderParam("accept-language") String acceptLanguage);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SimpleResponse<ResourceCollectionInner>> getResourceCollection(@HeaderParam("accept-language") String acceptLanguage);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<List<FlattenedProductInner>>> getArrayWithRestResponseAsync() {
    ...
    public Mono<List<FlattenedProductInner>> getArrayAsync() {
        return getArrayWithRestResponseAsync()
            .flatMap((SimpleResponse<List<FlattenedProductInner>> res) -> Mono.just(res.value()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<Map<String, FlattenedProductInner>>> getDictionaryWithRestResponseAsync() {
    ...
    public Mono<Map<String, FlattenedProductInner>> getDictionaryAsync() {
        return getDictionaryWithRestResponseAsync()
            .flatMap((SimpleResponse<Map<String, FlattenedProductInner>> res) -> Mono.just(res.value()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<ResourceCollectionInner>> getResourceCollectionWithRestResponseAsync() {
    ...
    public Mono<ResourceCollectionInner> getResourceCollectionAsync() {
        return getResourceCollectionWithRestResponseAsync()
            .flatMap((SimpleResponse<ResourceCollectionInner> res) -> Mono.just(res.value()));
    }
}
