...
public final class MissingServiceManager extends Manager<MissingServiceManager, AutoRestPagingTestServiceImpl> {
    /**
    ...
    private MissingServiceManager(RestClient restClient, String subscriptionId) {
        super(
            restClient,
            subscriptionId,
            new AutoRestPagingTestServiceImpl(restClient).withSubscriptionId(subscriptionId));
    }
}
