...
public final class MissingServiceManager extends Manager<MissingServiceManager, AutoRestReportServiceForAzureImpl> {
    /**
    ...
    private MissingServiceManager(RestClient restClient, String subscriptionId) {
        super(
            restClient,
            subscriptionId,
            new AutoRestReportServiceForAzureImpl(restClient).withSubscriptionId(subscriptionId));
    }
}
