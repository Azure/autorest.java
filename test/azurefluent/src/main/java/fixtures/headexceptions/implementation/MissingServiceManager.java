...
public final class MissingServiceManager extends Manager<MissingServiceManager, AutoRestHeadExceptionTestServiceImpl> {
    /**
    ...
    private MissingServiceManager(RestClient restClient, String subscriptionId) {
        super(
            restClient,
            subscriptionId,
            new AutoRestHeadExceptionTestServiceImpl(restClient).withSubscriptionId(subscriptionId));
    }
}
