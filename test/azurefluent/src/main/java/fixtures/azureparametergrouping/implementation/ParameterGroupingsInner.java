...
public final class ParameterGroupingsInner {
    ...
    public void postRequired(ParameterGroupingsPostRequiredParametersInner parameterGroupingsPostRequiredParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> postRequiredWithRestResponseAsync(ParameterGroupingsPostRequiredParametersInner parameterGroupingsPostRequiredParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> postRequiredAsync(ParameterGroupingsPostRequiredParametersInner parameterGroupingsPostRequiredParameters) {
