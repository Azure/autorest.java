...
public final class HeaderResponseEnumResponse extends RestResponse<HeaderResponseEnumHeaders, Void> {
     ...
     *
     * @param request the request which resulted in this HeaderResponseEnumResponse.
     * @param statusCode the status code of the HTTP response.
     * @param headers the deserialized headers of the HTTP response.
     * @param rawHeaders the raw headers of the HTTP response.
     * @param body the deserialized body of the HTTP response.
     */
    public HeaderResponseEnumResponse(HttpRequest request, int statusCode, HeaderResponseEnumHeaders headers, Map<String, String> rawHeaders, Void body) {
