...
public final class HeaderResponseDatetimeResponse extends RestResponse<HeaderResponseDatetimeHeaders, Void> {
     ...
     *
     * @param request the request which resulted in this HeaderResponseDatetimeResponse.
     * @param statusCode the status code of the HTTP response.
     * @param headers the deserialized headers of the HTTP response.
     * @param rawHeaders the raw headers of the HTTP response.
     * @param body the deserialized body of the HTTP response.
     */
    public HeaderResponseDatetimeResponse(HttpRequest request, int statusCode, HeaderResponseDatetimeHeaders headers, Map<String, String> rawHeaders, Void body) {
