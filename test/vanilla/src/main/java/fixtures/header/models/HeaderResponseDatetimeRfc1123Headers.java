...
public final class HeaderResponseDatetimeRfc1123Headers {
    ...
    /**
     * Get the value property: response with header values "Wed, 01 Jan 2010
    ...
    /**
     * Set the value property: response with header values "Wed, 01 Jan 2010
     * 12:34:56 GMT" or "Mon, 01 Jan 0001 00:00:00 GMT".
     *
     * @param value the value value to set.
     * @return the HeaderResponseDatetimeRfc1123Headers object itself.
     */
    public HeaderResponseDatetimeRfc1123Headers value(OffsetDateTime value) {
        if (value == null) {
            this.value = null;
        } else {
