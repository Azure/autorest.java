...
public final class HeaderResponseLongResponse extends RestResponse<HeaderResponseLongHeaders, Void> {
     ...
     *
     * @param request the request which resulted in this HeaderResponseLongResponse.
     * @param statusCode the status code of the HTTP response.
     * @param headers the deserialized headers of the HTTP response.
     * @param rawHeaders the raw headers of the HTTP response.
     * @param body the deserialized body of the HTTP response.
     */
    public HeaderResponseLongResponse(HttpRequest request, int statusCode, HeaderResponseLongHeaders headers, Map<String, String> rawHeaders, Void body) {
