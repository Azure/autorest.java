...
public final class HeaderResponseDoubleResponse extends RestResponse<HeaderResponseDoubleHeaders, Void> {
     ...
     *
     * @param request the request which resulted in this HeaderResponseDoubleResponse.
     * @param statusCode the status code of the HTTP response.
     * @param headers the deserialized headers of the HTTP response.
     * @param rawHeaders the raw headers of the HTTP response.
     * @param body the deserialized body of the HTTP response.
     */
    public HeaderResponseDoubleResponse(HttpRequest request, int statusCode, HeaderResponseDoubleHeaders headers, Map<String, String> rawHeaders, Void body) {
