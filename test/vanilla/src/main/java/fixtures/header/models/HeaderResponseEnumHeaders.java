...
public final class HeaderResponseEnumHeaders {
    ...
    /**
     * Get the value property: response with header values "GREY" or null.
    ...
    /**
     * Set the value property: response with header values "GREY" or null.
     * Possible values include: 'White', 'black', 'GREY'.
     *
     * @param value the value value to set.
     * @return the HeaderResponseEnumHeaders object itself.
     */
    public HeaderResponseEnumHeaders value(GreyscaleColors value) {
        this.value = value;
        return this;
    }
}
