...
public final class HeaderResponseProtectedKeyHeaders {
    ...
    /**
     * Get the contentType property: response with header value "Content-Type":
     * "text/html".
     *
    ...
    /**
     * Set the contentType property: response with header value "Content-Type":
     * "text/html".
     *
     * @param contentType the contentType value to set.
     * @return the HeaderResponseProtectedKeyHeaders object itself.
     */
    public HeaderResponseProtectedKeyHeaders contentType(String contentType) {
