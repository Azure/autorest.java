...
public final class HeaderResponseDateResponse extends RestResponse<HeaderResponseDateHeaders, Void> {
     ...
     *
     * @param request the request which resulted in this HeaderResponseDateResponse.
     * @param statusCode the status code of the HTTP response.
     * @param headers the deserialized headers of the HTTP response.
     * @param rawHeaders the raw headers of the HTTP response.
     * @param body the deserialized body of the HTTP response.
     */
    public HeaderResponseDateResponse(HttpRequest request, int statusCode, HeaderResponseDateHeaders headers, Map<String, String> rawHeaders, Void body) {
