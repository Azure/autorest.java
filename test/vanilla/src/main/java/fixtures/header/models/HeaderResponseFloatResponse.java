...
public final class HeaderResponseFloatResponse extends RestResponse<HeaderResponseFloatHeaders, Void> {
     ...
     *
     * @param request the request which resulted in this HeaderResponseFloatResponse.
     * @param statusCode the status code of the HTTP response.
     * @param headers the deserialized headers of the HTTP response.
     * @param rawHeaders the raw headers of the HTTP response.
     * @param body the deserialized body of the HTTP response.
     */
    public HeaderResponseFloatResponse(HttpRequest request, int statusCode, HeaderResponseFloatHeaders headers, Map<String, String> rawHeaders, Void body) {
