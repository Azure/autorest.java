...
public final class SmartSalmon extends Salmon {
     ...
     */
    public SmartSalmon additionalProperties(Map<String, Object> additionalProperties) {
        this.additionalProperties = additionalProperties;
        return this;
    }

    /**
     * Get the collegeDegree property: The collegeDegree property.
     *
    ...
    /**
     * Set the collegeDegree property: The collegeDegree property.
     *
     * @param collegeDegree the collegeDegree value to set.
     * @return the SmartSalmon object itself.
     */
    public SmartSalmon collegeDegree(String collegeDegree) {
