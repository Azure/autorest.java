...
public class FormdatasImpl implements Formdatas {
     ...
     */
    public ServiceFuture<Flowable<ByteBuffer>> uploadFileAsync(Flowable<ByteBuffer> fileContent, String fileName, final ServiceCallback<Flowable<ByteBuffer>> serviceCallback) {
     ...
     * @return the {@link ServiceFuture&lt;Flowable&lt;ByteBuffer&gt;&gt;} object.
     */
    public ServiceFuture<Flowable<ByteBuffer>> uploadFileViaBodyAsync(Flowable<ByteBuffer> fileContent, final ServiceCallback<Flowable<ByteBuffer>> serviceCallback) {
