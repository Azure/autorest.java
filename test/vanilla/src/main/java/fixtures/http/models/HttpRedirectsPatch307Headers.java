...
public class HttpRedirectsPatch307Headers {
    ...
    /**
     * Get the redirect location for this request. Possible values include: '/http/success/patch/200'.
     *
    ...
    /**
     * Set the redirect location for this request. Possible values include: '/http/success/patch/200'.
     *
