...
public class HttpRedirectsPut307Headers {
    ...
    /**
     * Get the redirect location for this request. Possible values include: '/http/success/put/200'.
     *
    ...
    /**
     * Set the redirect location for this request. Possible values include: '/http/success/put/200'.
     *
