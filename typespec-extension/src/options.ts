...
export const EmitterOptionsSchema: JSONSchemaType<EmitterOptions> = {
  ...
  properties: {
    ...
    "clear-output-folder": {
      type: "boolean",
      description:
        "When set to `true`, the emitter will delete generated Java code (Java file that contains `// Code generated by Microsoft (R) TypeSpec Code Generator.`) in `emitter-output-dir` folder. Default value is `false`.",
      nullable: true,
      default: false,
    },
