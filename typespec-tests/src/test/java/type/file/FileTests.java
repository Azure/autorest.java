...
public class FileTests {
    ...
    public void testUploadFileMultipleContentTypes() {
        client.uploadFileMultipleContentTypesWithResponse("image/png", BinaryData.fromFile(PNG_FILE), new RequestOptions());
    }

    @Test
    public void testDownloadFileMultipleContentTypes() {
        BinaryData response = client.downloadFileMultipleContentTypes(DownloadFileMultipleContentTypesContentType.IMAGE_PNG);
        Assertions.assertNotNull(response);
    }
