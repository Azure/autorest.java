...
public final class ManagedServiceIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedServiceIdentity model = BinaryData.fromString(
            "{\"principalId\":\"s\",\"tenantId\":\"cmpoyfdkfogkny\",\"type\":\"SystemAssigned\",\"userAssignedIdentities\":{\"arhmofcqhsmy\":{\"principalId\":\"ddeqsrdeupewnwre\",\"clientId\":\"jzyflu\"},\"rcryuanzwuxzdxta\":{\"principalId\":\"kdtmlxhekuk\",\"clientId\":\"txukcdmp\"}}}")
    ...
    public void testSerialize() throws Exception {
        ManagedServiceIdentity model = new ManagedServiceIdentity().withType(ManagedServiceIdentityType.SYSTEM_ASSIGNED)
            .withUserAssignedIdentities(
                mapOf("arhmofcqhsmy", new UserAssignedIdentity(), "rcryuanzwuxzdxta", new UserAssignedIdentity()));
