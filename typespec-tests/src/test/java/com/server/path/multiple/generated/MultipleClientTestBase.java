...
package com.server.path.multiple.generated;
...
import com.server.path.multiple.MultipleAsyncClient;
import com.server.path.multiple.MultipleClient;
import com.server.path.multiple.MultipleClientBuilder;
...
import reactor.core.publisher.Mono;
 ...
 class MultipleClientTestBase extends TestProxyTestBase {
    ...
    protected void beforeTest() {
        MultipleClientBuilder multipleClientbuilder = new MultipleClientBuilder()
