...
package com._specs_.azure.core.lro.standard.generated;
...
class StandardClientTestBase extends TestProxyTestBase {
    ...
    protected void beforeTest() {
        StandardClientBuilder standardClientbuilder
            = new StandardClientBuilder().endpoint(Configuration.getGlobalConfiguration().get("ENDPOINT", "endpoint"))
