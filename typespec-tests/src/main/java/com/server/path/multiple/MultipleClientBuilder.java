...
public final class MultipleClientBuilder implements HttpTrait<MultipleClientBuilder>, ConfigurationTrait<MultipleClientBuilder>, EndpointTrait<MultipleClientBuilder> {
    @Generated
     ...
     */
    @Generated
    public MultipleClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private MultipleClientImpl buildInnerClient() {
        ...
        MultipleServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : MultipleServiceVersion.getLatest();
        MultipleClientImpl client = new MultipleClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, localServiceVersion);
        return client;
    }
     ...
     */
    @Generated
    public MultipleAsyncClient buildAsyncClient() {
        return new MultipleAsyncClient(buildInnerClient());
    }
