...
public final class SingleClientBuilder implements HttpTrait<SingleClientBuilder>, ConfigurationTrait<SingleClientBuilder>, EndpointTrait<SingleClientBuilder> {
    @Generated
    ...
    private SingleClientImpl buildInnerClient() {
        ...
        SingleClientImpl client = new SingleClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
