 ...
 */
@ServiceClientBuilder(serviceClients = { NotDefinedClient.class, NotDefinedAsyncClient.class })
public final class NotDefinedClientBuilder implements HttpTrait<NotDefinedClientBuilder>,
    ...
    private static final Map<String, String> PROPERTIES
        = CoreUtils.getProperties("server-endpoint-notdefined.properties");
    ...
    @Generated
    @Override
    public NotDefinedClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public NotDefinedClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public NotDefinedClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public NotDefinedClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public NotDefinedClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the NotDefinedClientBuilder.
     */
    @Generated
    public NotDefinedClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    /**
     * Builds an instance of NotDefinedAsyncClient class.
     * 
     * @return an instance of NotDefinedAsyncClient.
     */
    @Generated
    public NotDefinedAsyncClient buildAsyncClient() {
        return new NotDefinedAsyncClient(buildInnerClient());
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(NotDefinedClientBuilder.class);
}
