...
public final class StringOperationsImpl {
    ...
    public interface StringOperationsService {
        @Get("/models/properties/nullable/string/non-null")
        ...
        @Get("/models/properties/nullable/string/null")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
        ...
        @Patch("/models/properties/nullable/string/non-null")
        ...
        @Patch("/models/properties/nullable/string/null")
        @ExpectedResponses({204})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
