...
public final class DurationOperationsImpl {
    ...
    public interface DurationOperationsService {
        @Get("/models/properties/nullable/duration/non-null")
        ...
        @Get("/models/properties/nullable/duration/null")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
        ...
        @Patch("/models/properties/nullable/duration/non-null")
        ...
        @Patch("/models/properties/nullable/duration/null")
        @ExpectedResponses({204})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
