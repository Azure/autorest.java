 ...
 * 1. Client spec version: refers to the spec that the client is generated from. 'v1' is a client generated from
 * old.tsp and 'v2' is a client generated from main.tsp.
