 ...
 */
@Immutable
public final class In implements JsonSerializable<In> {
    /*
     * The name property.
     */
    @Generated
    ...
    /**
     * Creates an instance of In class.
     * 
     ...
     * @return An instance of In if the JsonReader was pointing to an instance of it, or null if it was pointing to
     * JSON null.
