 ...
 */
@Immutable
public final class Continue implements JsonSerializable<Continue> {
    /*
     * The name property.
     */
    @Generated
    ...
    /**
     * Creates an instance of Continue class.
     * 
    ...
    public static Continue fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            if (nameFound) {
                Continue deserializedContinue = new Continue(name);

                return deserializedContinue;
            }
