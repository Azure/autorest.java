 ...
 */
@Immutable
public final class Constructor implements JsonSerializable<Constructor> {
    /*
     * The name property.
     */
    @Generated
    ...
    public static Constructor fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            if (nameFound) {
                Constructor deserializedConstructor = new Constructor(name);

                return deserializedConstructor;
            }
