 ...
 */
@Immutable
public final class Break implements JsonSerializable<Break> {
    /*
     * The name property.
     */
    @Generated
    ...
    /**
     * Creates an instance of Break class.
     * 
    ...
    public static Break fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            if (nameFound) {
                Break deserializedBreak = new Break(name);

                return deserializedBreak;
            }
