 ...
 */
@Immutable
public final class Async implements JsonSerializable<Async> {
    /*
     * The name property.
     */
    @Generated
    ...
    /**
     * Creates an instance of Async class.
     * 
    ...
    public static Async fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            if (nameFound) {
                Async deserializedAsync = new Async(name);

                return deserializedAsync;
            }
