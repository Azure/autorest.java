 ...
 */
@Immutable
public final class Finally implements JsonSerializable<Finally> {
    /*
     * The name property.
     */
    @Generated
    ...
    /**
     * Creates an instance of Finally class.
     * 
     ...
     * @return An instance of Finally if the JsonReader was pointing to an instance of it, or null if it was pointing
     * to JSON null.
