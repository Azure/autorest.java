 ...
 */
@ServiceClientBuilder(serviceClients = {QueryClient.class, PropertyClient.class, HeaderClient.class, QueryAsyncClient.class, PropertyAsyncClient.class, HeaderAsyncClient.class})
public final class DurationClientBuilder implements HttpTrait<DurationClientBuilder>, ConfigurationTrait<DurationClientBuilder> {
    @Generated
     ...
     */
    @Generated
    public DurationClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private DurationClientImpl buildInnerClient() {
        ...
        DurationClientImpl client = new DurationClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
