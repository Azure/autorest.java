...
public final class Rfc3339DatetimeProperty implements JsonSerializable<Rfc3339DatetimeProperty> {
     ...
     * The value property.
     */
    @Generated private final OffsetDateTime value;
    ...
    public static Rfc3339DatetimeProperty fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(
                reader -> {
                    ...
                    if (valueFound) {
                        Rfc3339DatetimeProperty deserializedRfc3339DatetimeProperty =
                                new Rfc3339DatetimeProperty(value);

                        return deserializedRfc3339DatetimeProperty;
                    }
