 ...
 */
@ServiceClientBuilder(serviceClients = {QueryClient.class, PropertyClient.class, HeaderClient.class, ResponseHeaderClient.class, QueryAsyncClient.class, PropertyAsyncClient.class, HeaderAsyncClient.class, ResponseHeaderAsyncClient.class})
public final class DatetimeClientBuilder implements HttpTrait<DatetimeClientBuilder>, ConfigurationTrait<DatetimeClientBuilder> {
    @Generated
    ...
    private DatetimeClientImpl buildInnerClient() {
        ...
        DatetimeClientImpl client = new DatetimeClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
     ...
     */
    @Generated
    public ResponseHeaderAsyncClient buildResponseHeaderAsyncClient() {
        return new ResponseHeaderAsyncClient(buildInnerClient().getResponseHeaders());
    }
