...
import com.encode.numeric.implementation.NumericClientImpl;
...
public final class NumericClientBuilder
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("encode-numeric.properties");
    ...
    @Generated
    @Override
    public NumericClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public NumericClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public NumericClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public NumericClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the NumericClientBuilder.
     */
    @Generated
    public NumericClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    /**
     * Builds an instance of NumericAsyncClient class.
     * 
     * @return an instance of NumericAsyncClient.
     */
    @Generated
    public NumericAsyncClient buildAsyncClient() {
        return new NumericAsyncClient(buildInnerClient().getProperties());
    }
     ...
     */
    @Generated
    public NumericClient buildClient() {
