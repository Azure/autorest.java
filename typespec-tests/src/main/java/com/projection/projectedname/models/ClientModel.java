...
/**
 * The ClientModel model.
 */
@Immutable
public final class ClientModel implements JsonSerializable<ClientModel> {
    ...
    /**
     * Creates an instance of ClientModel class.
     *
     * @param defaultName the defaultName value to set.
     */
    @Generated
    public ClientModel(boolean defaultName) {
    ...
    public static ClientModel fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new ClientModel(defaultName);
        });
    }
}
