...
public final class PageableClientBuilder implements HttpTrait<PageableClientBuilder>, ConfigurationTrait<PageableClientBuilder> {
    @Generated
    ...
    private PageableClientImpl buildInnerClient() {
        ...
        PageableClientImpl client = new PageableClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
