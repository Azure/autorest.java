...
import com.payload.mediatype.implementation.MediaTypeClientImpl;
...
public final class MediaTypeClientBuilder implements HttpTrait<MediaTypeClientBuilder>,
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("payload-mediatype.properties");
    ...
    @Generated
    @Override
    public MediaTypeClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public MediaTypeClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public MediaTypeClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public MediaTypeClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the MediaTypeClientBuilder.
     */
    @Generated
    public MediaTypeClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private MediaTypeClientImpl buildInnerClient() {
        ...
        MediaTypeClientImpl client
            = new MediaTypeClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
    ...
    /**
     * Builds an instance of MediaTypeAsyncClient class.
     * 
     * @return an instance of MediaTypeAsyncClient.
     */
    @Generated
    public MediaTypeAsyncClient buildAsyncClient() {
        return new MediaTypeAsyncClient(buildInnerClient().getStringBodies());
    }
     ...
     */
    @Generated
    public MediaTypeClient buildClient() {
