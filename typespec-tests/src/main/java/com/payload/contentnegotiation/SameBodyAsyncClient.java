...
public final class SameBodyAsyncClient {
     ...
     */
    @Generated
     SameBodyAsyncClient(SameBodiesImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getAvatarAsJpegWithResponse(RequestOptions requestOptions) {
        return this.serviceClient.getAvatarAsJpegWithResponseAsync(requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BinaryData> getAvatarAsJpeg() {
        // Generated convenience method for getAvatarAsJpegWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getAvatarAsJpegWithResponse(requestOptions).flatMap(FluxUtil::toMono);
    }
}
