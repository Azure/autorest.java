 ...
 */
@ServiceClientBuilder(serviceClients = {SameBodyClient.class, DifferentBodyClient.class, SameBodyAsyncClient.class, DifferentBodyAsyncClient.class})
public final class ContentNegotiationClientBuilder implements HttpTrait<ContentNegotiationClientBuilder>, ConfigurationTrait<ContentNegotiationClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("payload-contentnegotiation.properties");
    ...
    private ContentNegotiationClientImpl buildInnerClient() {
        ...
        ContentNegotiationClientImpl client = new ContentNegotiationClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
