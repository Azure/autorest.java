...
public final class CustomClientBuilder implements HttpTrait<CustomClientBuilder>, ConfigurationTrait<CustomClientBuilder>, KeyCredentialTrait<CustomClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("authentication-http-custom.properties");
