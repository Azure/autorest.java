...
public final class PartialUpdateClientBuilder implements HttpTrait<PartialUpdateClientBuilder>, ConfigurationTrait<PartialUpdateClientBuilder>, EndpointTrait<PartialUpdateClientBuilder> {
    ...
    private PartialUpdateClientImpl buildInnerClient() {
        ...
        PartialUpdateClientImpl client = new PartialUpdateClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
