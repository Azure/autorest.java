...
public final class FirstClientBuilder implements HttpTrait<FirstClientBuilder>, ConfigurationTrait<FirstClientBuilder>, EndpointTrait<FirstClientBuilder> {
    @Generated
    ...
    private FirstClientImpl buildInnerClient() {
        ...
        FirstServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : FirstServiceVersion.getLatest();
        FirstClientImpl client = new FirstClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, localServiceVersion);
        return client;
    }
