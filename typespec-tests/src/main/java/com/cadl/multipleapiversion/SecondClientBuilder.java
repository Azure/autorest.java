...
public final class SecondClientBuilder implements HttpTrait<SecondClientBuilder>, ConfigurationTrait<SecondClientBuilder>, EndpointTrait<SecondClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("cadl-multipleapiversion.properties");
    ...
    private SecondClientImpl buildInnerClient() {
        ...
        SecondServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : SecondServiceVersion.getLatest();
        SecondClientImpl client = new SecondClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, localServiceVersion);
        return client;
    }
