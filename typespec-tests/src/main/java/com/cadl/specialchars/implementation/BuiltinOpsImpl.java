...
public final class BuiltinOpsImpl {
    ...
    public Mono<Response<BinaryData>> readWithResponseAsync(BinaryData request, RequestOptions requestOptions) {
        ...
        return FluxUtil
            .withContext(context -> service.read(this.client.getEndpoint(), accept, request, requestOptions, context));
    }
    ...
    public Response<BinaryData> readWithResponse(BinaryData request, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.readSync(this.client.getEndpoint(), accept, request, requestOptions, Context.NONE);
    }
}
