...
@Immutable
public final class ApiResponse implements JsonSerializable<ApiResponse> {
    /*
     * The name property.
     */
     ...
     */
    @Generated
    private ApiResponse(String name) {
        this.name = name;
    }
    ...
    public static ApiResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(
                reader -> {
                    ...
                    if (nameFound) {
                        ApiResponse deserializedApiResponse = new ApiResponse(name);
