...
public final class StandAloneData implements JsonSerializable<StandAloneData> {
     ...
     */
    @Generated private final StandAloneDataInner property;
    ...
    public static StandAloneData fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(
                reader -> {
                    ...
                    if (propertyFound) {
                        StandAloneData deserializedStandAloneData = new StandAloneData(property);

                        return deserializedStandAloneData;
                    }
