...
public final class InternalClientBuilder implements HttpTrait<InternalClientBuilder>, ConfigurationTrait<InternalClientBuilder>, EndpointTrait<InternalClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("cadl-internal.properties");

    @Generated
    private final List<HttpPipelinePolicy> pipelinePolicies;

    /**
     * Create an instance of the InternalClientBuilder.
     */
    @Generated
    public InternalClientBuilder() {
    ...
    @Generated
    @Override
    public InternalClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public InternalClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public InternalClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public InternalClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public InternalClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Generated
    @Override
    public InternalClientBuilder configuration(Configuration configuration) {
    ...
    @Generated
    @Override
    public InternalClientBuilder endpoint(String endpoint) {
     ...
     * @return the InternalClientBuilder.
     */
    @Generated
    public InternalClientBuilder retryPolicy(RetryPolicy retryPolicy) {
        this.retryPolicy = retryPolicy;
        return this;
    }

    /**
     * Builds an instance of InternalClientImpl with the provided parameters.
     * 
     * @return an instance of InternalClientImpl.
     */
    @Generated
    private InternalClientImpl buildInnerClient() {
        HttpPipeline localPipeline = (pipeline != null) ? pipeline : createHttpPipeline();
        InternalClientImpl client = new InternalClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
    ...
    /**
     * Builds an instance of InternalAsyncClient class.
     * 
     * @return an instance of InternalAsyncClient.
     */
    @Generated
