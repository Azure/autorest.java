...
public final class InternalClientImpl {
    ...
    public interface InternalClientService {
        ...
        Mono<Response<BinaryData>> postInternal(
                ...
                @BodyParam("application/json") BinaryData apiRequest,
    ...
    public Mono<Response<BinaryData>> postInternalWithResponseAsync(
            BinaryData apiRequest, RequestOptions requestOptions) {
