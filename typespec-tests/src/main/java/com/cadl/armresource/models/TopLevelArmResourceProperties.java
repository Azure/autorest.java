...
public final class TopLevelArmResourceProperties {
    ...
    /**
     * Get the childResources property: ChildResources References List.
     * 
     * @return the childResources value.
     */
    public List<ResourceId> childResources() {
    ...
    public void validate() {
        if (childResources() != null) {
            childResources().forEach(e -> e.validate());
        }
    }
}
