...
public final class ChildResourceImpl implements ChildResource, ChildResource.Definition, ChildResource.Update {
    ...
    ChildResourceImpl(String name, com.cadl.armresource.ArmResourceManager serviceManager) {
    ...
    ChildResourceImpl(ChildResourceInner innerObject, com.cadl.armresource.ArmResourceManager serviceManager) {
