...
public final class ChildResourcesInterfacesClientImpl implements ChildResourcesInterfacesClient {
     ...
     */
    private final ArmResourceClientImpl client;
     ...
     */
    ChildResourcesInterfacesClientImpl(ArmResourceClientImpl client) {
    ...
    /**
     * The interface defining all the services for ArmResourceClientChildResourcesInterfaces to be used by the proxy
     * service to perform REST calls.
     */
    @Host("https://management.azure.com")
    @ServiceInterface(name = "ArmResourceClientChi")
    public interface ChildResourcesInterfacesService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Cadl.ArmResource/topLevelArmResources/{topLevelArmResourceName}/childResources/{childResourceName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ChildResourceInner>> get(@QueryParam("api-version") String apiVersion,
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Cadl.ArmResource/topLevelArmResources/{topLevelArmResourceName}/childResources/{childResourceName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Cadl.ArmResource/topLevelArmResources/{topLevelArmResourceName}/childResources/{childResourceName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ChildResourceInner>> update(@QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("topLevelArmResourceName") String topLevelArmResourceName,
            @PathParam("childResourceName") String childResourceName, @HeaderParam("accept") String accept,
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Cadl.ArmResource/topLevelArmResources/{topLevelArmResourceName}/childResources/{childResourceName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Cadl.ArmResource/topLevelArmResources/{topLevelArmResourceName}/childResources")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<Response<ChildResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName,
            topLevelArmResourceName, childResourceName, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, topLevelArmResourceName, childResourceName, accept, resource, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName,
            topLevelArmResourceName, childResourceName, accept, resource, context);
    }
    ...
    private Mono<Response<ChildResourceInner>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName,
            topLevelArmResourceName, childResourceName, accept, properties, context);
    }
