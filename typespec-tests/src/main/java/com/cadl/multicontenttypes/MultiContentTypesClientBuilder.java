...
public final class MultiContentTypesClientBuilder implements HttpTrait<MultiContentTypesClientBuilder>, ConfigurationTrait<MultiContentTypesClientBuilder>, EndpointTrait<MultiContentTypesClientBuilder> {
    @Generated
    ...
    private MultiContentTypesClientImpl buildInnerClient() {
        ...
        MultiContentTypesClientImpl client = new MultiContentTypesClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
