...
public final class BuiltinOpsImpl {
    ...
    public interface BuiltinOpsService {
        ...
        @Post("/builtin/writeconvenience")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> writeConvenience(@HostParam("endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> writeConvenienceSync(@HostParam("endpoint") String endpoint,
            @HeaderParam("accept") String accept, @BodyParam("application/json") BinaryData body,
            RequestOptions requestOptions, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> writeConvenienceWithResponseAsync(BinaryData body, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.writeConvenience(this.client.getEndpoint(), accept, body, requestOptions, context));
    }
    ...
    public Response<Void> writeConvenienceWithResponse(BinaryData body, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.writeConvenienceSync(this.client.getEndpoint(), accept, body, requestOptions, Context.NONE);
    }
}
