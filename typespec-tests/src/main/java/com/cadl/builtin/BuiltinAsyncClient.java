...
public final class BuiltinAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> writeConvenienceWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.serviceClient.writeConvenienceWithResponseAsync(body, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> writeConvenience(Builtin body) {
        // Generated convenience method for writeConvenienceWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return writeConvenienceWithResponse(BinaryData.fromObject(body), requestOptions).flatMap(FluxUtil::toMono);
    }
}
