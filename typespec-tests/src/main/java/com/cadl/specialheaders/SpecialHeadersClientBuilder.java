...
public final class SpecialHeadersClientBuilder implements HttpTrait<SpecialHeadersClientBuilder>, ConfigurationTrait<SpecialHeadersClientBuilder>, EndpointTrait<SpecialHeadersClientBuilder> {
    @Generated
    ...
    private SpecialHeadersClientImpl buildInnerClient() {
        ...
        SpecialHeadersServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : SpecialHeadersServiceVersion.getLatest();
        SpecialHeadersClientImpl client = new SpecialHeadersClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, localServiceVersion);
        return client;
    }
