...
public final class SpecialHeadersClientImpl {
    ...
    public Mono<Response<BinaryData>> putWithResponseAsync(String name, BinaryData resource,
        ...
        return FluxUtil.withContext(context -> service.put(this.getEndpoint(), this.getServiceVersion().getVersion(),
            name, accept, resource, requestOptionsLocal, context));
    }
    ...
    public Response<BinaryData> putWithResponse(String name, BinaryData resource, RequestOptions requestOptions) {
        ...
        return service.putSync(this.getEndpoint(), this.getServiceVersion().getVersion(), name, accept, resource,
    ...
    public Mono<Response<BinaryData>> postWithResponseAsync(String name, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.post(this.getEndpoint(), this.getServiceVersion().getVersion(),
            name, accept, requestOptionsLocal, context));
    }
    ...
    public Response<BinaryData> postWithResponse(String name, RequestOptions requestOptions) {
        ...
        return service.postSync(this.getEndpoint(), this.getServiceVersion().getVersion(), name, accept,
            requestOptionsLocal, Context.NONE);
    }
    ...
    private Mono<Response<BinaryData>> createLroWithResponseAsync(String name, BinaryData resource,
        ...
        return FluxUtil.withContext(context -> service.createLro(this.getEndpoint(),
            this.getServiceVersion().getVersion(), name, contentType, accept, resource, requestOptionsLocal, context));
    }
    ...
    private Response<BinaryData> createLroWithResponse(String name, BinaryData resource,
        ...
        return service.createLroSync(this.getEndpoint(), this.getServiceVersion().getVersion(), name, contentType,
            accept, resource, requestOptionsLocal, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> putWithRequestHeadersWithResponseAsync(String name, BinaryData resource,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.putWithRequestHeaders(this.getEndpoint(),
    ...
    public Response<BinaryData> putWithRequestHeadersWithResponse(String name, BinaryData resource,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.putWithRequestHeadersSync(this.getEndpoint(), this.getServiceVersion().getVersion(), name,
    ...
    public Mono<Response<BinaryData>> patchWithMatchHeadersWithResponseAsync(String name, BinaryData resource,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.patchWithMatchHeaders(this.getEndpoint(),
            this.getServiceVersion().getVersion(), name, accept, resource, requestOptions, context));
    }
    ...
    public Response<BinaryData> patchWithMatchHeadersWithResponse(String name, BinaryData resource,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.patchWithMatchHeadersSync(this.getEndpoint(), this.getServiceVersion().getVersion(), name,
            accept, resource, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> putWithOptionalBodyWithResponseAsync(String format,
        ...
        return FluxUtil.withContext(
            context -> service.putWithOptionalBody(this.getEndpoint(), format, accept, requestOptionsLocal, context));
    }
    ...
    public Mono<Response<Void>> deleteWithSpecialHeadersWithResponseAsync(String name, String foo,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.deleteWithSpecialHeaders(this.getEndpoint(),
            this.getServiceVersion().getVersion(), name, foo, accept, requestOptions, context));
    }
    ...
    public Response<Void> deleteWithSpecialHeadersWithResponse(String name, String foo, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.deleteWithSpecialHeadersSync(this.getEndpoint(), this.getServiceVersion().getVersion(), name,
            foo, accept, requestOptions, Context.NONE);
    }
}
