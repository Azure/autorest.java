...
public final class ContosoClientBuilder implements HttpTrait<ContosoClientBuilder>, ConfigurationTrait<ContosoClientBuilder>, EndpointTrait<ContosoClientBuilder> {
    @Generated
    ...
    private ContosoClientImpl buildInnerClient() {
        ...
        ContosoServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : ContosoServiceVersion.getLatest();
        ContosoClientImpl client = new ContosoClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, localServiceVersion);
        return client;
    }
