...
public final class EnumOpsImpl {
    ...
    /**
     * The interface defining all the services for EnumServiceClientEnumOps to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "EnumServiceClientEnu")
    public interface EnumOpsService {
        @Get("/enum/color")
    ...
    public Mono<Response<BinaryData>> getColorWithResponseAsync(RequestOptions requestOptions) {
        ...
        return FluxUtil
            .withContext(context -> service.getColor(this.client.getEndpoint(), accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getColorWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getColorSync(this.client.getEndpoint(), accept, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> getColorModelWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getColorModel(this.client.getEndpoint(), accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getColorModelWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getColorModelSync(this.client.getEndpoint(), accept, requestOptions, Context.NONE);
    }
    ...
    public Response<BinaryData> setColorModelWithResponse(String color, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.setColorModelSync(this.client.getEndpoint(), color, accept, requestOptions, Context.NONE);
    }
    ...
    public Response<BinaryData> setPriorityWithResponse(String priority, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.setPrioritySync(this.client.getEndpoint(), priority, accept, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> getRunningOperationWithResponseAsync(RequestOptions requestOptions) {
        ...
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.getRunningOperation(this.client.getEndpoint(), state, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getRunningOperationWithResponse(RequestOptions requestOptions) {
        final String state = "Running";
        final String accept = "application/json";
        return service.getRunningOperationSync(this.client.getEndpoint(), state, accept, requestOptions, Context.NONE);
    }
    ...
    public Response<BinaryData> getOperationWithResponse(String state, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getOperationSync(this.client.getEndpoint(), state, accept, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setStringEnumArrayWithResponseAsync(List<String> colorArray,
        ...
        return FluxUtil.withContext(context -> service.setStringEnumArray(this.client.getEndpoint(),
            colorArrayConverted, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> setStringEnumArrayWithResponse(List<String> colorArray, RequestOptions requestOptions) {
        ...
        String colorArrayConverted = colorArray.stream().map(paramItemValue -> Objects.toString(paramItemValue, ""))
            .collect(Collectors.joining(","));
        return service.setStringEnumArraySync(this.client.getEndpoint(), colorArrayConverted, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setIntEnumArrayWithResponseAsync(List<String> priorityArray,
        ...
        return FluxUtil.withContext(context -> service.setIntEnumArray(this.client.getEndpoint(),
            priorityArrayConverted, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> setIntEnumArrayWithResponse(List<String> priorityArray, RequestOptions requestOptions) {
        ...
        String priorityArrayConverted = priorityArray.stream()
            .map(paramItemValue -> Objects.toString(paramItemValue, "")).collect(Collectors.joining(","));
        return service.setIntEnumArraySync(this.client.getEndpoint(), priorityArrayConverted, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setStringArrayWithResponseAsync(List<String> stringArray,
        ...
        String stringArrayConverted = stringArray.stream().map(paramItemValue -> Objects.toString(paramItemValue, ""))
            .collect(Collectors.joining(","));
        return FluxUtil.withContext(context -> service.setStringArray(this.client.getEndpoint(), stringArrayConverted,
    ...
    public Response<BinaryData> setStringArrayWithResponse(List<String> stringArray, RequestOptions requestOptions) {
        ...
        String stringArrayConverted = stringArray.stream().map(paramItemValue -> Objects.toString(paramItemValue, ""))
            .collect(Collectors.joining(","));
        return service.setStringArraySync(this.client.getEndpoint(), stringArrayConverted, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setIntArrayWithResponseAsync(List<Integer> intArray,
        ...
        return FluxUtil.withContext(context -> service.setIntArray(this.client.getEndpoint(), intArrayConverted, accept,
    ...
    public Response<BinaryData> setIntArrayWithResponse(List<Integer> intArray, RequestOptions requestOptions) {
        ...
        String intArrayConverted
            = JacksonAdapter.createDefaultSerializerAdapter().serializeIterable(intArray, CollectionFormat.CSV);
        return service.setIntArraySync(this.client.getEndpoint(), intArrayConverted, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setStringEnumMultiWithResponseAsync(List<String> colorArray,
        ...
        return FluxUtil.withContext(context -> service.setStringEnumMulti(this.client.getEndpoint(),
            colorArrayConverted, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> setStringEnumMultiWithResponse(List<String> colorArray, RequestOptions requestOptions) {
        ...
        List<String> colorArrayConverted
            = colorArray.stream().map(item -> Objects.toString(item, "")).collect(Collectors.toList());
        return service.setStringEnumMultiSync(this.client.getEndpoint(), colorArrayConverted, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setIntEnumMultiWithResponseAsync(List<String> priorityArray,
        ...
        return FluxUtil.withContext(context -> service.setIntEnumMulti(this.client.getEndpoint(),
            priorityArrayConverted, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> setIntEnumMultiWithResponse(List<String> priorityArray, RequestOptions requestOptions) {
        ...
        List<String> priorityArrayConverted
            = priorityArray.stream().map(item -> Objects.toString(item, "")).collect(Collectors.toList());
        return service.setIntEnumMultiSync(this.client.getEndpoint(), priorityArrayConverted, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setStringMultiWithResponseAsync(List<String> stringArray,
        ...
        return FluxUtil.withContext(context -> service.setStringMulti(this.client.getEndpoint(), stringArrayConverted,
            accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> setStringMultiWithResponse(List<String> stringArray, RequestOptions requestOptions) {
        ...
        List<String> stringArrayConverted
            = stringArray.stream().map(item -> Objects.toString(item, "")).collect(Collectors.toList());
        return service.setStringMultiSync(this.client.getEndpoint(), stringArrayConverted, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setIntMultiWithResponseAsync(List<Integer> intArray,
        ...
        return FluxUtil.withContext(context -> service.setIntMulti(this.client.getEndpoint(), intArrayConverted, accept,
            requestOptions, context));
    }
    ...
    public Response<BinaryData> setIntMultiWithResponse(List<Integer> intArray, RequestOptions requestOptions) {
        ...
        List<String> intArrayConverted
            = intArray.stream().map(item -> Objects.toString(item, "")).collect(Collectors.toList());
        return service.setIntMultiSync(this.client.getEndpoint(), intArrayConverted, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> setStringEnumArrayHeaderWithResponseAsync(List<String> colorArray,
        ...
        String colorArrayConverted = colorArray.stream().map(paramItemValue -> Objects.toString(paramItemValue, ""))
            .collect(Collectors.joining(","));
        return FluxUtil.withContext(context -> service.setStringEnumArrayHeader(this.client.getEndpoint(),
            colorArrayConverted, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> setStringEnumArrayHeaderWithResponse(List<String> colorArray,
        ...
        String colorArrayConverted = colorArray.stream().map(paramItemValue -> Objects.toString(paramItemValue, ""))
            .collect(Collectors.joining(","));
        return service.setStringEnumArrayHeaderSync(this.client.getEndpoint(), colorArrayConverted, accept,
