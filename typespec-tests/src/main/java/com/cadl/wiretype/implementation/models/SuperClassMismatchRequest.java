...
import com.cadl.wiretype.models.SuperClassMismatch;
...
/**
 * The SuperClassMismatchRequest model.
 */
@Immutable
public final class SuperClassMismatchRequest extends SuperClassMismatch {
    /*
    ...
    /**
     * Creates an instance of SuperClassMismatchRequest class.
     * 
     * @param dateTimeRfc7231 the dateTimeRfc7231 value to set.
     * @param dateTime the dateTime value to set.
     */
    @Generated
    public SuperClassMismatchRequest(OffsetDateTime dateTimeRfc7231, OffsetDateTime dateTime) {
    ...
    /**
     * Reads an instance of SuperClassMismatchRequest from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SuperClassMismatchRequest if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the SuperClassMismatchRequest.
     */
    @Generated
    public static SuperClassMismatchRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new SuperClassMismatchRequest(dateTimeRfc7231, dateTime);
        });
    }
}
