...
/**
 * The BothClassMismatchRequest model.
 */
@Immutable
public final class BothClassMismatchRequest extends SuperClassMismatch {
    /*
    ...
    /**
     * Creates an instance of BothClassMismatchRequest class.
     * 
     * @param dateTimeRfc7231 the dateTimeRfc7231 value to set.
     * @param base64url the base64url value to set.
     */
    @Generated
    public BothClassMismatchRequest(OffsetDateTime dateTimeRfc7231, byte[] base64url) {
    ...
    /**
     * Reads an instance of BothClassMismatchRequest from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of BothClassMismatchRequest if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the BothClassMismatchRequest.
     */
    @Generated
    public static BothClassMismatchRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new BothClassMismatchRequest(dateTimeRfc7231, base64url);
        });
    }
}
