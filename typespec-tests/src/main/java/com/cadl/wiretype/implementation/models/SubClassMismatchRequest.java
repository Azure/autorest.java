...
import com.cadl.wiretype.models.SuperClass;
...
/**
 * The SubClassMismatchRequest model.
 */
@Immutable
public final class SubClassMismatchRequest extends SuperClass {
    /*
    ...
    /**
     * Creates an instance of SubClassMismatchRequest class.
     * 
     * @param dateTime the dateTime value to set.
     * @param dateTimeRfc7231 the dateTimeRfc7231 value to set.
     */
    @Generated
    public SubClassMismatchRequest(OffsetDateTime dateTime, OffsetDateTime dateTimeRfc7231) {
        super(dateTime);
    ...
    /**
     * Reads an instance of SubClassMismatchRequest from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SubClassMismatchRequest if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the SubClassMismatchRequest.
     */
    @Generated
    public static SubClassMismatchRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new SubClassMismatchRequest(dateTime, dateTimeRfc7231);
        });
    }
}
