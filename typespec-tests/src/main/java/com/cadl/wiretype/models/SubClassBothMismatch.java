...
public final class SubClassBothMismatch extends SuperClassMismatch {
     ...
     */
    @Generated private final Base64Url base64Url;
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        if (getDateTimeRfc7231() != null) {
            jsonWriter.writeStringField(
                    "dateTimeRfc7231", Objects.toString(new DateTimeRfc1123(getDateTimeRfc7231()), null));
        }
                ...
                reader -> {
                    ...
                    while (reader.nextToken() != JsonToken.END_OBJECT) {
                        ...
                        if ("dateTimeRfc7231".equals(fieldName)) {
                            ...
                            if (base64Url != null) {
                                base64Url = base64Url.decodedBytes();
                            }
                            base64UrlFound = true;
                        } else {
                            reader.skipChildren();
