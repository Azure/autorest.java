...
public final class UnionClientBuilder implements HttpTrait<UnionClientBuilder>, ConfigurationTrait<UnionClientBuilder>, EndpointTrait<UnionClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("cadl-union.properties");
     ...
     */
    @Generated
    private UnionServiceVersion serviceVersion;
     ...
     */
    @Generated
    public UnionClientBuilder serviceVersion(UnionServiceVersion serviceVersion) {
    ...
    private UnionClientImpl buildInnerClient() {
        ...
        UnionServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : UnionServiceVersion.getLatest();
        UnionClientImpl client = new UnionClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, localServiceVersion);
        return client;
    }
