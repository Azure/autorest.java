...
public final class ProtocolAndConvenientClientBuilder implements HttpTrait<ProtocolAndConvenientClientBuilder>, ConfigurationTrait<ProtocolAndConvenientClientBuilder>, EndpointTrait<ProtocolAndConvenientClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("cadl-protocolandconvenient.properties");
    ...
    private ProtocolAndConvenientClientImpl buildInnerClient() {
        ...
        ProtocolAndConvenientServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : ProtocolAndConvenientServiceVersion.getLatest();
        ProtocolAndConvenientClientImpl client = new ProtocolAndConvenientClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, localServiceVersion);
        return client;
    }
