...
public final class ModelClientBuilder
        implements HttpTrait<ModelClientBuilder>,
                ConfigurationTrait<ModelClientBuilder>,
                EndpointTrait<ModelClientBuilder> {
    @Generated private static final String SDK_NAME = "name";

    @Generated private static final String SDK_VERSION = "version";

    @Generated private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("cadl-model.properties");
    ...
    private ModelClientImpl buildInnerClient() {
        ...
        ModelClientImpl client =
                new ModelClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), endpoint);
        return client;
    }
