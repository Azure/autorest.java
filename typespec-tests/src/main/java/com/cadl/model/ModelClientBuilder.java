...
public final class ModelClientBuilder implements HttpTrait<ModelClientBuilder>, ConfigurationTrait<ModelClientBuilder>, EndpointTrait<ModelClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("cadl-model.properties");
    ...
    private ModelClientImpl buildInnerClient() {
        ...
        ModelClientImpl client = new ModelClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
