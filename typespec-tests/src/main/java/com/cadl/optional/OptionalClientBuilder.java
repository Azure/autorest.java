...
public final class OptionalClientBuilder implements HttpTrait<OptionalClientBuilder>, ConfigurationTrait<OptionalClientBuilder>, EndpointTrait<OptionalClientBuilder> {
    @Generated
    ...
    private OptionalClientImpl buildInnerClient() {
        ...
        OptionalClientImpl client = new OptionalClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
