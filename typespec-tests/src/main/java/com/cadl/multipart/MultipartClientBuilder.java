...
public final class MultipartClientBuilder implements HttpTrait<MultipartClientBuilder>, ConfigurationTrait<MultipartClientBuilder>, EndpointTrait<MultipartClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("cadl-multipart.properties");
    ...
    @Generated
    @Override
    public MultipartClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public MultipartClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public MultipartClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public MultipartClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public MultipartClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the MultipartClientBuilder.
     */
    @Generated
    public MultipartClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private MultipartClientImpl buildInnerClient() {
        ...
        MultipartClientImpl client = new MultipartClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
