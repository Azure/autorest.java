...
public final class NamingClientBuilder implements HttpTrait<NamingClientBuilder>, ConfigurationTrait<NamingClientBuilder>, EndpointTrait<NamingClientBuilder> {
    @Generated
    ...
    private NamingClientImpl buildInnerClient() {
        ...
        NamingClientImpl client = new NamingClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
