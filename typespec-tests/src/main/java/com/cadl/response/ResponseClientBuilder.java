...
public final class ResponseClientBuilder implements HttpTrait<ResponseClientBuilder>, ConfigurationTrait<ResponseClientBuilder>, EndpointTrait<ResponseClientBuilder> {
    @Generated
    ...
    private ResponseClientImpl buildInnerClient() {
        ...
        ResponseServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : ResponseServiceVersion.getLatest();
        ResponseClientImpl client = new ResponseClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, localServiceVersion);
        return client;
    }
