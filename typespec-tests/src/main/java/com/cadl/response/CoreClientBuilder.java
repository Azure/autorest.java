...
public final class CoreClientBuilder
        implements HttpTrait<CoreClientBuilder>,
                ConfigurationTrait<CoreClientBuilder>,
                EndpointTrait<CoreClientBuilder> {
    ...
    @Generated
    @Override
    public CoreClientBuilder endpoint(String endpoint) {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CoreClientBuilder.class);
}
