 ...
 */
@ServiceClientBuilder(serviceClients = { ReturnTypeChangedFromClient.class, ReturnTypeChangedFromAsyncClient.class })
public final class ReturnTypeChangedFromClientBuilder implements HttpTrait<ReturnTypeChangedFromClientBuilder>,
    ...
    @Generated
    @Override
    public ReturnTypeChangedFromClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public ReturnTypeChangedFromClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public ReturnTypeChangedFromClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public ReturnTypeChangedFromClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public ReturnTypeChangedFromClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     */
    @Generated
    public ReturnTypeChangedFromClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    /**
     * Builds an instance of ReturnTypeChangedFromAsyncClient class.
     * 
     * @return an instance of ReturnTypeChangedFromAsyncClient.
     */
    @Generated
    public ReturnTypeChangedFromAsyncClient buildAsyncClient() {
        return new ReturnTypeChangedFromAsyncClient(buildInnerClient());
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ReturnTypeChangedFromClientBuilder.class);
}
