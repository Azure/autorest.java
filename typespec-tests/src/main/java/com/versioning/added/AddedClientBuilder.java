...
@ServiceClientBuilder(
    serviceClients = {
        AddedClient.class,
        InterfaceV2Client.class,
        AddedAsyncClient.class,
        InterfaceV2AsyncClient.class })
public final class AddedClientBuilder implements HttpTrait<AddedClientBuilder>, ConfigurationTrait<AddedClientBuilder>,
    EndpointTrait<AddedClientBuilder> {
    @Generated
    ...
    @Generated
    @Override
    public AddedClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public AddedClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public AddedClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public AddedClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public AddedClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     */
    @Generated
    public AddedClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    /**
     * Builds an instance of AddedAsyncClient class.
     * 
     * @return an instance of AddedAsyncClient.
     */
    @Generated
    public AddedAsyncClient buildAsyncClient() {
        return new AddedAsyncClient(buildInnerClient());
    }

    /**
     * Builds an instance of InterfaceV2AsyncClient class.
     * 
     * @return an instance of InterfaceV2AsyncClient.
     */
    @Generated
    public InterfaceV2AsyncClient buildInterfaceV2AsyncClient() {
        return new InterfaceV2AsyncClient(buildInnerClient().getInterfaceV2s());
    }
