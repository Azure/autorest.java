...
package com.versioning.removed.implementation;
...
public final class RemovedClientImpl {
    ...
    public RemovedClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String endpoint,
        ...
        this.service = RestProxy.create(RemovedClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for RemovedClient to be used by the proxy service to perform REST calls.
     */
    @Host("{endpoint}/versioning/removed/api-version:{version}")
    @ServiceInterface(name = "RemovedClient")
