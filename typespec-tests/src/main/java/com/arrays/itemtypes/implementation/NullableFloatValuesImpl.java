...
public final class NullableFloatValuesImpl {
     ...
     */
    NullableFloatValuesImpl(ItemTypesClientImpl client) {
        this.service =
                RestProxy.create(
                        NullableFloatValuesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ItemTypesClientNullableFloatValues to be used by the proxy service to
     * perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "ItemTypesClientNulla")
    public interface NullableFloatValuesService {
        @Get("/arrays/item-types/nullable-float")
        ...
        @Put("/arrays/item-types/nullable-float")
