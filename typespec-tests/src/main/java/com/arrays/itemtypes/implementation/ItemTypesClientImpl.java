...
/** Initializes a new instance of the ItemTypesClient type. */
public final class ItemTypesClientImpl {
     ...
     */
    public ItemTypesClientImpl(HttpPipeline httpPipeline) {
     ...
     */
    public ItemTypesClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter) {
