...
public final class ServiceClientClientBuilder implements HttpTrait<ServiceClientClientBuilder>, ConfigurationTrait<ServiceClientClientBuilder>, EndpointTrait<ServiceClientClientBuilder> {
    @Generated
    ...
    private ServiceClientClientImpl buildInnerClient() {
        ...
        ServiceClientClientImpl client = new ServiceClientClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, this.client);
        return client;
    }
