...
/**
 * An instance of this class provides access to all the operations defined in FoosOperations.
 */
public final class FoosOperationsImpl {
    /**
    ...
    /**
     * Initializes an instance of FoosOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    FoosOperationsImpl(ServiceClientClientImpl client) {
        this.service = RestProxy.create(FoosService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ServiceClientClientFoosOperations to be used by the proxy service to
     * perform REST calls.
     */
