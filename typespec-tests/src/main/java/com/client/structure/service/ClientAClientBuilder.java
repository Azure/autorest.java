...
public final class ClientAClientBuilder implements HttpTrait<ClientAClientBuilder>, ConfigurationTrait<ClientAClientBuilder>, EndpointTrait<ClientAClientBuilder> {
    @Generated
     ...
     */
    @Generated
    public ClientAClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private ClientAClientImpl buildInnerClient() {
        ...
        ClientAClientImpl client = new ClientAClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, this.client);
        return client;
    }
     ...
     */
    @Generated
    public ClientAAsyncClient buildAsyncClient() {
        return new ClientAAsyncClient(buildInnerClient());
    }
     ...
     */
    @Generated
    public ClientAClient buildClient() {
        return new ClientAClient(buildInnerClient());
    }

    private static final ClientLogger LOGGER = new ClientLogger(ClientAClientBuilder.class);
}
