...
public final class ClientBClientImpl {
     ...
     * @param client
     */
    public ClientBClientImpl(ClientType client) {
        this(
     ...
     * @param client
     */
    public ClientBClientImpl(HttpPipeline httpPipeline, ClientType client) {
     ...
     * @param client
     */
    public ClientBClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, ClientType client) {
