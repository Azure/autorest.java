...
public final class ClientBClientImpl {
     ...
     * @param client Need to be set as 'default', 'multi-client', 'renamed-operation', 'two-operation-group' in client.
     */
    public ClientBClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String endpoint, String client) {
    ...
    public Mono<Response<Void>> renamedTwoWithResponseAsync(RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.renamedTwo(this.getEndpoint(), this.getClient(), accept, requestOptions, context));
    }
    ...
    public Mono<Response<Void>> renamedFourWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.renamedFour(this.getEndpoint(), this.getClient(), accept, requestOptions, context));
    }
    ...
    public Mono<Response<Void>> renamedSixWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.renamedSix(this.getEndpoint(), this.getClient(), accept, requestOptions, context));
    }
