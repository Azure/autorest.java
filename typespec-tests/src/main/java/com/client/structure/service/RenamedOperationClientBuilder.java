 ...
 */
@ServiceClientBuilder(serviceClients = {RenamedOperationClient.class, GroupClient.class, RenamedOperationAsyncClient.class, GroupAsyncClient.class})
public final class RenamedOperationClientBuilder implements HttpTrait<RenamedOperationClientBuilder>, ConfigurationTrait<RenamedOperationClientBuilder>, EndpointTrait<RenamedOperationClientBuilder> {
    @Generated
    ...
    private RenamedOperationClientImpl buildInnerClient() {
        ...
        RenamedOperationClientImpl client = new RenamedOperationClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint, this.client);
        return client;
    }
