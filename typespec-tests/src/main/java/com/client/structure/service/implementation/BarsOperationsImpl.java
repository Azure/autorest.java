...
/**
 * An instance of this class provides access to all the operations defined in BarsOperations.
 */
public final class BarsOperationsImpl {
    /**
    ...
    /**
     * Initializes an instance of BarsOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    BarsOperationsImpl(ServiceClientClientImpl client) {
        this.service = RestProxy.create(BarsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ServiceClientClientBarsOperations to be used by the proxy service to
     * perform REST calls.
     */
