...
public final class EnumsImpl {
     ...
     */
    EnumsImpl(NamingClientImpl client) {
        this.service = RestProxy.create(EnumsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NamingClientEnums to be used by the proxy service to perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "NamingClientEnums")
    public interface EnumsService {
        @Post("/client/naming/enum/client")
