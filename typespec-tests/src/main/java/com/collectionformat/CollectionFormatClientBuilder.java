...
@ServiceClientBuilder(serviceClients = {CollectionFormatClient.class, CollectionFormatAsyncClient.class})
public final class CollectionFormatClientBuilder
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("collectionformat.properties");
    ...
    /**
     * Builds an instance of CollectionFormatAsyncClient class.
     *
     * @return an instance of CollectionFormatAsyncClient.
     */
    @Generated
    public CollectionFormatAsyncClient buildAsyncClient() {
        return new CollectionFormatAsyncClient(buildInnerClient());
    }

    /**
     * Builds an instance of CollectionFormatClient class.
     *
     * @return an instance of CollectionFormatClient.
     */
    @Generated
