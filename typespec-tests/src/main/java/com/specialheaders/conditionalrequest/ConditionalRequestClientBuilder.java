...
public final class ConditionalRequestClientBuilder implements HttpTrait<ConditionalRequestClientBuilder>, ConfigurationTrait<ConditionalRequestClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("specialheaders-conditionalrequest.properties");
    ...
    @Generated
    @Override
    public ConditionalRequestClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public ConditionalRequestClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public ConditionalRequestClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public ConditionalRequestClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public ConditionalRequestClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the ConditionalRequestClientBuilder.
     */
    @Generated
    public ConditionalRequestClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private ConditionalRequestClientImpl buildInnerClient() {
        ...
        ConditionalRequestClientImpl client = new ConditionalRequestClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
    ...
    /**
     * Builds an instance of ConditionalRequestAsyncClient class.
     * 
     * @return an instance of ConditionalRequestAsyncClient.
     */
    @Generated
    public ConditionalRequestAsyncClient buildAsyncClient() {
        return new ConditionalRequestAsyncClient(buildInnerClient());
    }
