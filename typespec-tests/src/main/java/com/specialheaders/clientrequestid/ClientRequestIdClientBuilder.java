...
public final class ClientRequestIdClientBuilder implements HttpTrait<ClientRequestIdClientBuilder>, ConfigurationTrait<ClientRequestIdClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("specialheaders-clientrequestid.properties");
    ...
    private ClientRequestIdClientImpl buildInnerClient() {
        ...
        ClientRequestIdClientImpl client = new ClientRequestIdClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
