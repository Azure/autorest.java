...
public final class RepeatabilityClientBuilder implements HttpTrait<RepeatabilityClientBuilder>, ConfigurationTrait<RepeatabilityClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("specialheaders-repeatability.properties");
    ...
    private RepeatabilityClientImpl buildInnerClient() {
        ...
        RepeatabilityClientImpl client = new RepeatabilityClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
