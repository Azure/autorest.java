 ...
 */
@ServiceClientBuilder(serviceClients = {ModelClient.class, AliasClient.class, ModelAsyncClient.class, AliasAsyncClient.class})
public final class SpreadClientBuilder implements HttpTrait<SpreadClientBuilder>, ConfigurationTrait<SpreadClientBuilder> {
    @Generated
    ...
    @Generated
    @Override
    public SpreadClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public SpreadClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public SpreadClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public SpreadClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public SpreadClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the SpreadClientBuilder.
     */
    @Generated
    public SpreadClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    /**
     * Builds an instance of AliasAsyncClient class.
     * 
     * @return an instance of AliasAsyncClient.
     */
    @Generated
    public AliasAsyncClient buildAliasAsyncClient() {
        return new AliasAsyncClient(buildInnerClient().getAlias());
    }
    ...
    public AliasClient buildAliasClient() {
        return new AliasClient(buildInnerClient().getAlias());
    }

    private static final ClientLogger LOGGER = new ClientLogger(SpreadClientBuilder.class);
}
