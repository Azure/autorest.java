 ...
 */
@ServiceClientBuilder(serviceClients = {QueryClient.class, HeaderClient.class, QueryAsyncClient.class, HeaderAsyncClient.class})
public final class CollectionFormatClientBuilder implements HttpTrait<CollectionFormatClientBuilder>, ConfigurationTrait<CollectionFormatClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("parameters-collectionformat.properties");
     ...
     */
    @Generated
    public CollectionFormatClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private CollectionFormatClientImpl buildInnerClient() {
        ...
        CollectionFormatClientImpl client = new CollectionFormatClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
