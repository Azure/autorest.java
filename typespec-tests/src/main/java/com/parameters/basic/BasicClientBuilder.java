...
import com.parameters.basic.implementation.BasicClientImpl;
...
public final class BasicClientBuilder implements HttpTrait<BasicClientBuilder>, ConfigurationTrait<BasicClientBuilder> {
    ...
    /**
     * Builds an instance of ExplicitBodyAsyncClient class.
     * 
     * @return an instance of ExplicitBodyAsyncClient.
     */
    @Generated
    public ExplicitBodyAsyncClient buildExplicitBodyAsyncClient() {
        return new ExplicitBodyAsyncClient(buildInnerClient().getExplicitBodies());
    }

    /**
     * Builds an instance of ImplicitBodyAsyncClient class.
     * 
     * @return an instance of ImplicitBodyAsyncClient.
     */
    @Generated
    public ImplicitBodyAsyncClient buildImplicitBodyAsyncClient() {
        return new ImplicitBodyAsyncClient(buildInnerClient().getImplicitBodies());
    }
    ...
    public ExplicitBodyClient buildExplicitBodyClient() {
        return new ExplicitBodyClient(buildInnerClient().getExplicitBodies());
    }
    ...
    public ImplicitBodyClient buildImplicitBodyClient() {
        return new ImplicitBodyClient(buildInnerClient().getImplicitBodies());
    }
