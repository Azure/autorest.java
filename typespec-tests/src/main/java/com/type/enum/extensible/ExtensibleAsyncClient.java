...
import com.type.enum.extensible.models.DaysOfWeekExtensibleEnum;
...
public final class ExtensibleAsyncClient {
    ...
    public Mono<DaysOfWeekExtensibleEnum> getKnownValue() {
        ...
        return getKnownValueWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(DaysOfWeekExtensibleEnum::fromString);
    }
    ...
    public Mono<DaysOfWeekExtensibleEnum> getUnknownValue() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getUnknownValueWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(DaysOfWeekExtensibleEnum::fromString);
    }
