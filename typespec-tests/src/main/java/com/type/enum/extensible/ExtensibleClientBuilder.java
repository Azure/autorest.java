...
package com.type.enum.extensible;
...
import com.type.enum.extensible.implementation.ExtensibleClientImpl;
...
public final class ExtensibleClientBuilder implements HttpTrait<ExtensibleClientBuilder>, ConfigurationTrait<ExtensibleClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("type-enum-extensible.properties");
    ...
    @Generated
    @Override
    public ExtensibleClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public ExtensibleClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public ExtensibleClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public ExtensibleClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public ExtensibleClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the ExtensibleClientBuilder.
     */
    @Generated
    public ExtensibleClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private ExtensibleClientImpl buildInnerClient() {
        ...
        ExtensibleClientImpl client = new ExtensibleClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
    ...
    /**
     * Builds an instance of ExtensibleAsyncClient class.
     * 
     * @return an instance of ExtensibleAsyncClient.
     */
    @Generated
