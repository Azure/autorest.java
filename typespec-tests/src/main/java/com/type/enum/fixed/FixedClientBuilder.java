...
import com.type.enum.fixed.implementation.FixedClientImpl;
...
public final class FixedClientBuilder implements HttpTrait<FixedClientBuilder>, ConfigurationTrait<FixedClientBuilder> {
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("type-enum-fixed.properties");
