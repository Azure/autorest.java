...
import com.type.property.valuetypes.implementation.FloatLiteralsImpl;
...
public final class FloatLiteralAsyncClient {
     ...
     * @return model with a float literal property along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return model with a float literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FloatLiteralProperty> get() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(FloatLiteralProperty body) {
