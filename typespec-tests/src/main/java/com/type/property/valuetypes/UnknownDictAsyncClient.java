...
import com.type.property.valuetypes.implementation.UnknownDictsImpl;
...
public final class UnknownDictAsyncClient {
    @Generated
    private final UnknownDictsImpl serviceClient;

    /**
     * Initializes an instance of UnknownDictAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    UnknownDictAsyncClient(UnknownDictsImpl serviceClient) {
     ...
     * @return model with a property unknown, and the data is a dictionnary along with {@link Response} on successful
     ...
     * @return model with a property unknown, and the data is a dictionnary on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnknownDictProperty> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(UnknownDictProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(UnknownDictProperty body) {
