...
import com.type.property.valuetypes.implementation.BooleanLiteralsImpl;
...
public final class BooleanLiteralAsyncClient {
     ...
     * @return model with a boolean literal property along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return model with a boolean literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BooleanLiteralProperty> get() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(BooleanLiteralProperty body) {
