...
import com.type.property.valuetypes.implementation.BooleanOperationsImpl;
...
public final class BooleanOperationAsyncClient {
    ...
    public Mono<BooleanProperty> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(BooleanProperty.class));
    }
