...
import com.type.property.valuetypes.implementation.UnionIntLiteralsImpl;
...
public final class UnionIntLiteralAsyncClient {
     ...
     * @return model with a union of int literal as property along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return model with a union of int literal as property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnionIntLiteralProperty> get() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(UnionIntLiteralProperty body) {
