...
public final class BooleanLiteralsImpl {
    ...
    public interface BooleanLiteralsService {
        @Get("/type/property/value-types/boolean/literal")
        ...
        @Put("/type/property/value-types/boolean/literal")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return model with a boolean literal property along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
