...
/**
 * An instance of this class provides access to all the operations defined in EnumValues.
 */
public final class EnumValuesImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final EnumValuesService service;
    ...
    /**
     * Initializes an instance of EnumValuesImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    EnumValuesImpl(ValueTypesClientImpl client) {
        this.service
            = RestProxy.create(EnumValuesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ValueTypesClientEnumValues to be used by the proxy service to perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "ValueTypesClientEnum")
    public interface EnumValuesService {
        @Get("/type/property/value-types/enum-value")
        ...
        @Put("/type/property/value-types/enum-value")
     ...
     * <pre>{@code
     * {
     *     property: String(value1/value2) (Required)
     * }
     * }</pre>
     * 
