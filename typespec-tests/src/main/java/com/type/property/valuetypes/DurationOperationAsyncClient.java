...
import com.type.property.valuetypes.implementation.DurationOperationsImpl;
...
public final class DurationOperationAsyncClient {
    ...
    public Mono<DurationProperty> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DurationProperty.class));
    }
