...
import com.type.property.valuetypes.implementation.UnionFloatLiteralsImpl;
...
public final class UnionFloatLiteralAsyncClient {
     ...
     * @return model with a union of float literal as property along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return model with a union of float literal as property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnionFloatLiteralProperty> get() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(UnionFloatLiteralProperty body) {
