...
public final class UnionFloatLiteralClient {
     ...
     * @return model with a union of float literal as property along with {@link Response}.
     */
    @Generated
     ...
     * @return model with a union of float literal as property.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UnionFloatLiteralProperty get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(UnionFloatLiteralProperty.class);
    }
