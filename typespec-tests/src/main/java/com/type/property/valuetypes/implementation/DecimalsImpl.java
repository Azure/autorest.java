...
public final class DecimalsImpl {
     ...
     */
    private final DecimalsService service;
    ...
    DecimalsImpl(ValueTypesClientImpl client) {
        this.service = RestProxy.create(DecimalsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface DecimalsService {
        ...
        @Put("/type/property/value-types/decimal")
