...
import com.type.property.valuetypes.implementation.BytesImpl;
...
public final class BytesAsyncClient {
    ...
    public Mono<BytesProperty> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(BytesProperty.class));
    }
