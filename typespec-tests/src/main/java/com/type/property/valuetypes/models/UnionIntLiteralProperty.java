...
public final class UnionIntLiteralProperty implements JsonSerializable<UnionIntLiteralProperty> {
     ...
     * @return An instance of UnionIntLiteralProperty if the JsonReader was pointing to an instance of it, or null if
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("property".equals(fieldName)) {
                    property = UnionIntLiteralPropertyProperty.fromLong(reader.getLong());
                } else {
                    reader.skipChildren();
                }
            }
