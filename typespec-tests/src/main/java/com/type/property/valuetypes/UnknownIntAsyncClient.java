...
import com.type.property.valuetypes.implementation.UnknownIntsImpl;
...
public final class UnknownIntAsyncClient {
    @Generated
    private final UnknownIntsImpl serviceClient;

    /**
     * Initializes an instance of UnknownIntAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    UnknownIntAsyncClient(UnknownIntsImpl serviceClient) {
     ...
     * @return model with a property unknown, and the data is a int32 along with {@link Response} on successful
     ...
     * @return model with a property unknown, and the data is a int32 on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnknownIntProperty> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(UnknownIntProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(UnknownIntProperty body) {
