...
import com.type.property.valuetypes.implementation.UnknownArraysImpl;
...
public final class UnknownArrayAsyncClient {
    @Generated
    private final UnknownArraysImpl serviceClient;

    /**
     * Initializes an instance of UnknownArrayAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    UnknownArrayAsyncClient(UnknownArraysImpl serviceClient) {
     ...
     * @return model with a property unknown, and the data is an array along with {@link Response} on successful
     ...
     * @return model with a property unknown, and the data is an array on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnknownArrayProperty> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(UnknownArrayProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(UnknownArrayProperty body) {
