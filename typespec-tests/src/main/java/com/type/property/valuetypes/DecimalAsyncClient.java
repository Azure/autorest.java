...
import com.type.property.valuetypes.implementation.DecimalsImpl;
...
public final class DecimalAsyncClient {
    @Generated
    private final DecimalsImpl serviceClient;

    /**
     * Initializes an instance of DecimalAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    DecimalAsyncClient(DecimalsImpl serviceClient) {
     ...
     * @return model with a decimal property along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return model with a decimal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DecimalProperty> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DecimalProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(DecimalProperty body) {
