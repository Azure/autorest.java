...
public final class Decimal128sImpl {
    ...
    Decimal128sImpl(ValueTypesClientImpl client) {
        this.service
            = RestProxy.create(Decimal128sService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface Decimal128sService {
        ...
        @Put("/type/property/value-types/decimal128")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return model with a decimal128 property along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
