...
public final class UnionEnumValueClient {
     ...
     * @return template type for testing models with specific properties along with {@link Response}.
     */
    @Generated
     ...
     * @return template type for testing models with specific properties.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UnionEnumValueProperty get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(UnionEnumValueProperty.class);
    }
