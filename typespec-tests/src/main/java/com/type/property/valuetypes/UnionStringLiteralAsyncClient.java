...
import com.type.property.valuetypes.implementation.UnionStringLiteralsImpl;
...
public final class UnionStringLiteralAsyncClient {
     ...
     * @return model with a union of string literal as property along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return model with a union of string literal as property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnionStringLiteralProperty> get() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(UnionStringLiteralProperty body) {
