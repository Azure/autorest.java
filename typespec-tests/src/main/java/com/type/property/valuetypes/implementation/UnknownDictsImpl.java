...
public final class UnknownDictsImpl {
    ...
    UnknownDictsImpl(ValueTypesClientImpl client) {
        this.service
            = RestProxy.create(UnknownDictsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface UnknownDictsService {
        ...
        @Put("/type/property/value-types/unknown/dict")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return model with a property unknown, and the data is a dictionnary along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
