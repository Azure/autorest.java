...
public final class UnionIntLiteralClient {
     ...
     * @return model with a union of int literal as property along with {@link Response}.
     */
    @Generated
     ...
     * @return model with a union of int literal as property.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UnionIntLiteralProperty get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(UnionIntLiteralProperty.class);
    }
