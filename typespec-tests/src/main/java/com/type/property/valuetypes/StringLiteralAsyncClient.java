...
import com.type.property.valuetypes.implementation.StringLiteralsImpl;
...
public final class StringLiteralAsyncClient {
     ...
     * @return model with a string literal property along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return model with a string literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StringLiteralProperty> get() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(StringLiteralProperty body) {
