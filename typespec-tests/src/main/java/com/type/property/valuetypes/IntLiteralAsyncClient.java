...
import com.type.property.valuetypes.implementation.IntLiteralsImpl;
...
public final class IntLiteralAsyncClient {
     ...
     * @return model with a int literal property along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return model with a int literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IntLiteralProperty> get() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(IntLiteralProperty body) {
