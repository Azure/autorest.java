...
public final class UnknownStringsImpl {
    ...
    UnknownStringsImpl(ValueTypesClientImpl client) {
        this.service
            = RestProxy.create(UnknownStringsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface UnknownStringsService {
        @Get("/type/property/value-types/unknown/string")
        ...
        @Put("/type/property/value-types/unknown/string")
