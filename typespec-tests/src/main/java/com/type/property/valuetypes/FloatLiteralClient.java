...
public final class FloatLiteralClient {
     ...
     * @return model with a float literal property along with {@link Response}.
     */
    @Generated
     ...
     * @return model with a float literal property.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FloatLiteralProperty get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).getValue().toObject(FloatLiteralProperty.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void put(FloatLiteralProperty body) {
