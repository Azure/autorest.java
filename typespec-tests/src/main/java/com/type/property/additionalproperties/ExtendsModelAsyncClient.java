...
import com.type.property.additionalproperties.implementation.ExtendsModelsImpl;
...
public final class ExtendsModelAsyncClient {
    @Generated
    private final ExtendsModelsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsModelAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsModelAsyncClient(ExtendsModelsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExtendsModelAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ExtendsModelAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ExtendsModelAdditionalProperties body) {
