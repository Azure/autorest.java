...
import com.type.property.additionalproperties.implementation.IsUnknownDiscriminatedsImpl;
...
public final class IsUnknownDiscriminatedAsyncClient {
    @Generated
    private final IsUnknownDiscriminatedsImpl serviceClient;

    /**
     * Initializes an instance of IsUnknownDiscriminatedAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IsUnknownDiscriminatedAsyncClient(IsUnknownDiscriminatedsImpl serviceClient) {
     ...
     * @return the model is Record&lt;unknown&gt; with a discriminator along with {@link Response} on successful
     ...
     * @return the model is Record&lt;unknown&gt; with a discriminator on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IsUnknownAdditionalPropertiesDiscriminated> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(IsUnknownAdditionalPropertiesDiscriminated.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(IsUnknownAdditionalPropertiesDiscriminated body) {
