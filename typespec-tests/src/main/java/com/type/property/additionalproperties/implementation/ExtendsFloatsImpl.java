...
public final class ExtendsFloatsImpl {
    ...
    ExtendsFloatsImpl(AdditionalPropertiesClientImpl client) {
        this.service
            = RestProxy.create(ExtendsFloatsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ExtendsFloatsService {
        ...
        @Put("/type/property/additionalProperties/extendsRecordFloat")
