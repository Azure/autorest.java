...
public final class SpreadModelArraysImpl {
    ...
    SpreadModelArraysImpl(AdditionalPropertiesClientImpl client) {
        this.service
            = RestProxy.create(SpreadModelArraysService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface SpreadModelArraysService {
        @Get("/type/property/additionalProperties/spreadRecordModelArray")
        ...
        @Put("/type/property/additionalProperties/spreadRecordModelArray")
