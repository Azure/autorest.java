...
import com.type.property.additionalproperties.implementation.ExtendsUnknownDiscriminatedsImpl;
...
public final class ExtendsUnknownDiscriminatedAsyncClient {
    @Generated
    private final ExtendsUnknownDiscriminatedsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsUnknownDiscriminatedAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsUnknownDiscriminatedAsyncClient(ExtendsUnknownDiscriminatedsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExtendsUnknownAdditionalPropertiesDiscriminated> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(
            protocolMethodData -> protocolMethodData.toObject(ExtendsUnknownAdditionalPropertiesDiscriminated.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ExtendsUnknownAdditionalPropertiesDiscriminated body) {
