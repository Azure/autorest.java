...
import com.type.property.additionalproperties.implementation.SpreadStringsImpl;
...
public final class SpreadStringAsyncClient {
    @Generated
    private final SpreadStringsImpl serviceClient;

    /**
     * Initializes an instance of SpreadStringAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadStringAsyncClient(SpreadStringsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;string&gt; with the same known property type along with {@link Response} on
     ...
     * @return the model spread Record&lt;string&gt; with the same known property type on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SpreadStringRecord> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SpreadStringRecord.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SpreadStringRecord body) {
