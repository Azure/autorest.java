...
public final class ExtendsStringsImpl {
    ...
    ExtendsStringsImpl(AdditionalPropertiesClientImpl client) {
        this.service
            = RestProxy.create(ExtendsStringsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ExtendsStringsService {
        ...
        @Put("/type/property/additionalProperties/extendsRecordString")
