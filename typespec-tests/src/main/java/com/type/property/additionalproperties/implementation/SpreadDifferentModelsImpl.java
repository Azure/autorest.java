...
/**
 * An instance of this class provides access to all the operations defined in SpreadDifferentModels.
 */
public final class SpreadDifferentModelsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SpreadDifferentModelsService service;
    ...
    /**
     * Initializes an instance of SpreadDifferentModelsImpl.
     * 
    ...
    /**
     * The interface defining all the services for AdditionalPropertiesClientSpreadDifferentModels to be used by the
     * proxy service to perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "AdditionalProperties")
    public interface SpreadDifferentModelsService {
        @Get("/type/property/additionalProperties/spreadDifferentRecordModel")
        ...
        @Put("/type/property/additionalProperties/spreadDifferentRecordModel")
     ...
     * @return the model spread Record&lt;ModelForRecord&gt; with the different known property type along with
