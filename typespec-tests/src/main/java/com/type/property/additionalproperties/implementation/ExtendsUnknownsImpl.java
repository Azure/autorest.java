...
public final class ExtendsUnknownsImpl {
    ...
    ExtendsUnknownsImpl(AdditionalPropertiesClientImpl client) {
        this.service
            = RestProxy.create(ExtendsUnknownsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ExtendsUnknownsService {
        ...
        @Put("/type/property/additionalProperties/extendsRecordUnknown")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return the model extends from Record&lt;unknown&gt; type along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
