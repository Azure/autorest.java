...
public final class SpreadDifferentStringsImpl {
    ...
    SpreadDifferentStringsImpl(AdditionalPropertiesClientImpl client) {
        this.service = RestProxy.create(SpreadDifferentStringsService.class, client.getHttpPipeline(),
    ...
    public interface SpreadDifferentStringsService {
        @Get("/type/property/additionalProperties/spreadDifferentRecordString")
        ...
        @Put("/type/property/additionalProperties/spreadDifferentRecordString")
