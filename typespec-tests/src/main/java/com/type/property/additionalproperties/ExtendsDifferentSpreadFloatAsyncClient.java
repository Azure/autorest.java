...
import com.type.property.additionalproperties.implementation.ExtendsDifferentSpreadFloatsImpl;
...
public final class ExtendsDifferentSpreadFloatAsyncClient {
    @Generated
    private final ExtendsDifferentSpreadFloatsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsDifferentSpreadFloatAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsDifferentSpreadFloatAsyncClient(ExtendsDifferentSpreadFloatsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DifferentSpreadFloatDerived> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DifferentSpreadFloatDerived.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(DifferentSpreadFloatDerived body) {
