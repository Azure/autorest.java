...
import com.type.property.additionalproperties.implementation.ExtendsStringsImpl;
...
public final class ExtendsStringAsyncClient {
    @Generated
    private final ExtendsStringsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsStringAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsStringAsyncClient(ExtendsStringsImpl serviceClient) {
     ...
     * @return the model extends from Record&lt;string&gt; type along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return the model extends from Record&lt;string&gt; type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExtendsStringAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ExtendsStringAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ExtendsStringAdditionalProperties body) {
