...
public final class SpreadStringClient {
    @Generated
    private final SpreadStringsImpl serviceClient;

    /**
     * Initializes an instance of SpreadStringClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadStringClient(SpreadStringsImpl serviceClient) {
    ...
    public SpreadStringRecord get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(SpreadStringRecord.class);
    }
