...
import com.type.property.additionalproperties.implementation.ExtendsFloatsImpl;
...
public final class ExtendsFloatAsyncClient {
    @Generated
    private final ExtendsFloatsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsFloatAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsFloatAsyncClient(ExtendsFloatsImpl serviceClient) {
     ...
     * @return the model extends from Record&lt;float32&gt; type along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return the model extends from Record&lt;float32&gt; type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExtendsFloatAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ExtendsFloatAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ExtendsFloatAdditionalProperties body) {
