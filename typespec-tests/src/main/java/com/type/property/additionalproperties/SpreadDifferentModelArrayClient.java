...
public final class SpreadDifferentModelArrayClient {
     ...
     */
    @Generated
    SpreadDifferentModelArrayClient(SpreadDifferentModelArraysImpl serviceClient) {
     ...
     * @return the model spread Record&lt;ModelForRecord[]&gt; with the different known property type.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DifferentSpreadModelArrayRecord get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(DifferentSpreadModelArrayRecord.class);
    }
