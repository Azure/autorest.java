...
import com.type.property.additionalproperties.implementation.ExtendsDifferentSpreadStringsImpl;
...
public final class ExtendsDifferentSpreadStringAsyncClient {
    @Generated
    private final ExtendsDifferentSpreadStringsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsDifferentSpreadStringAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsDifferentSpreadStringAsyncClient(ExtendsDifferentSpreadStringsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DifferentSpreadStringDerived> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DifferentSpreadStringDerived.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(DifferentSpreadStringDerived body) {
