...
import com.type.property.additionalproperties.implementation.ExtendsUnknownsImpl;
...
public final class ExtendsUnknownAsyncClient {
    @Generated
    private final ExtendsUnknownsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsUnknownAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsUnknownAsyncClient(ExtendsUnknownsImpl serviceClient) {
     ...
     * @return the model extends from Record&lt;unknown&gt; type along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return the model extends from Record&lt;unknown&gt; type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExtendsUnknownAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ExtendsUnknownAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ExtendsUnknownAdditionalProperties body) {
