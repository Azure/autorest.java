...
import com.type.property.additionalproperties.implementation.SpreadFloatsImpl;
...
public final class SpreadFloatAsyncClient {
    @Generated
    private final SpreadFloatsImpl serviceClient;

    /**
     * Initializes an instance of SpreadFloatAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadFloatAsyncClient(SpreadFloatsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;float32&gt; with the same known property type along with {@link Response} on
     ...
     * @return the model spread Record&lt;float32&gt; with the same known property type on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SpreadFloatRecord> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SpreadFloatRecord.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SpreadFloatRecord body) {
