...
import com.type.property.additionalproperties.implementation.SpreadRecordNonDiscriminatedUnionsImpl;
...
public final class SpreadRecordNonDiscriminatedUnionAsyncClient {
    @Generated
    private final SpreadRecordNonDiscriminatedUnionsImpl serviceClient;

    /**
     * Initializes an instance of SpreadRecordNonDiscriminatedUnionAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadRecordNonDiscriminatedUnionAsyncClient(SpreadRecordNonDiscriminatedUnionsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;WidgetData0 | WidgetData1&gt; along with {@link Response} on successful
     ...
     * @return the model spread Record&lt;WidgetData0 | WidgetData1&gt; on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SpreadRecordForNonDiscriminatedUnion> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SpreadRecordForNonDiscriminatedUnion.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SpreadRecordForNonDiscriminatedUnion body) {
