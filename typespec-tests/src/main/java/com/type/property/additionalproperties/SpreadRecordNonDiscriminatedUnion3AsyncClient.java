...
public final class SpreadRecordNonDiscriminatedUnion3AsyncClient {
    @Generated
    private final SpreadRecordNonDiscriminatedUnion3sImpl serviceClient;

    /**
     * Initializes an instance of SpreadRecordNonDiscriminatedUnion3AsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadRecordNonDiscriminatedUnion3AsyncClient(SpreadRecordNonDiscriminatedUnion3sImpl serviceClient) {
     ...
     * @return the model spread Record&lt;WidgetData2[] | WidgetData1&gt; along with {@link Response} on successful
     ...
     * @return the model spread Record&lt;WidgetData2[] | WidgetData1&gt; on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SpreadRecordForNonDiscriminatedUnion3> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SpreadRecordForNonDiscriminatedUnion3.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SpreadRecordForNonDiscriminatedUnion3 body) {
