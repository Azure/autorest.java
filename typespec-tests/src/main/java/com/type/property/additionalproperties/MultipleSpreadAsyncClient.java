...
import com.type.property.additionalproperties.implementation.MultipleSpreadsImpl;
...
public final class MultipleSpreadAsyncClient {
    @Generated
    private final MultipleSpreadsImpl serviceClient;

    /**
     * Initializes an instance of MultipleSpreadAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    MultipleSpreadAsyncClient(MultipleSpreadsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;string&gt; and Record&lt;float32&gt; along with {@link Response} on successful
     ...
     * @return the model spread Record&lt;string&gt; and Record&lt;float32&gt; on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MultipleSpreadRecord> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(MultipleSpreadRecord.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(MultipleSpreadRecord body) {
