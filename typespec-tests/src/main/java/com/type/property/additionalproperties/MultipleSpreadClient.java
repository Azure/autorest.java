...
public final class MultipleSpreadClient {
    @Generated
    private final MultipleSpreadsImpl serviceClient;

    /**
     * Initializes an instance of MultipleSpreadClient class.
     * 
     ...
     * @return the model spread Record&lt;string&gt; and Record&lt;float32&gt; along with {@link Response}.
     */
    @Generated
     ...
     * @return the model spread Record&lt;string&gt; and Record&lt;float32&gt;.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MultipleSpreadRecord get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(MultipleSpreadRecord.class);
    }
