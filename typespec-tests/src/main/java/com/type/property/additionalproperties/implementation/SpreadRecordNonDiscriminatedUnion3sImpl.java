...
public final class SpreadRecordNonDiscriminatedUnion3sImpl {
    ...
    public interface SpreadRecordNonDiscriminatedUnion3sService {
        @Get("/type/property/additionalProperties/spreadRecordNonDiscriminatedUnion3")
        ...
        @Put("/type/property/additionalProperties/spreadRecordNonDiscriminatedUnion3")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return the model spread Record&lt;WidgetData2[] | WidgetData1&gt; along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
