...
public final class IsUnknownDerivedsImpl {
    ...
    IsUnknownDerivedsImpl(AdditionalPropertiesClientImpl client) {
        this.service
            = RestProxy.create(IsUnknownDerivedsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface IsUnknownDerivedsService {
        ...
        @Put("/type/property/additionalProperties/isRecordUnknownDerived")
     ...
     * @return the model extends from a type that is Record&lt;unknown&gt; type along with {@link Response} on
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return the model extends from a type that is Record&lt;unknown&gt; type along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
