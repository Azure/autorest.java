...
public final class SpreadRecordNonDiscriminatedUnionClient {
    @Generated
     ...
     * @return the model spread Record&lt;WidgetData0 | WidgetData1&gt; along with {@link Response}.
     */
    @Generated
     ...
     * @return the model spread Record&lt;WidgetData0 | WidgetData1&gt;.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SpreadRecordForNonDiscriminatedUnion get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).getValue().toObject(SpreadRecordForNonDiscriminatedUnion.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void put(SpreadRecordForNonDiscriminatedUnion body) {
