...
import com.type.property.additionalproperties.implementation.ExtendsModelArraysImpl;
...
public final class ExtendsModelArrayAsyncClient {
    @Generated
    private final ExtendsModelArraysImpl serviceClient;

    /**
     * Initializes an instance of ExtendsModelArrayAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsModelArrayAsyncClient(ExtendsModelArraysImpl serviceClient) {
     ...
     * @return the model extends from Record&lt;ModelForRecord[]&gt; type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExtendsModelArrayAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ExtendsModelArrayAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ExtendsModelArrayAdditionalProperties body) {
