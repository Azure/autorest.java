...
/**
 * An instance of this class provides access to all the operations defined in IsFloats.
 */
public final class IsFloatsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final IsFloatsService service;
    ...
    /**
     * Initializes an instance of IsFloatsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    IsFloatsImpl(AdditionalPropertiesClientImpl client) {
        this.service = RestProxy.create(IsFloatsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface IsFloatsService {
        ...
        @Put("/type/property/additionalProperties/isRecordFloat")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return the model is from Record&lt;float32&gt; type along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
