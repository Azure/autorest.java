...
import com.type.property.additionalproperties.implementation.ExtendsUnknownDerivedsImpl;
...
public final class ExtendsUnknownDerivedAsyncClient {
    @Generated
    private final ExtendsUnknownDerivedsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsUnknownDerivedAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsUnknownDerivedAsyncClient(ExtendsUnknownDerivedsImpl serviceClient) {
     ...
     * @return the model extends from a type that extends from Record&lt;unknown&gt; along with {@link Response} on
     ...
     * @return the model extends from a type that extends from Record&lt;unknown&gt; on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExtendsUnknownAdditionalPropertiesDerived> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ExtendsUnknownAdditionalPropertiesDerived.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ExtendsUnknownAdditionalPropertiesDerived body) {
