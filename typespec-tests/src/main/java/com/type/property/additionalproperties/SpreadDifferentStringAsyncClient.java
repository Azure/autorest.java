...
import com.type.property.additionalproperties.implementation.SpreadDifferentStringsImpl;
...
public final class SpreadDifferentStringAsyncClient {
    @Generated
    private final SpreadDifferentStringsImpl serviceClient;

    /**
     * Initializes an instance of SpreadDifferentStringAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadDifferentStringAsyncClient(SpreadDifferentStringsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;string&gt; with the different known property type along with {@link Response}
     ...
     * @return the model spread Record&lt;string&gt; with the different known property type on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DifferentSpreadStringRecord> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DifferentSpreadStringRecord.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(DifferentSpreadStringRecord body) {
