...
public final class MultipleSpreadsImpl {
    ...
    MultipleSpreadsImpl(AdditionalPropertiesClientImpl client) {
        this.service
            = RestProxy.create(MultipleSpreadsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface MultipleSpreadsService {
        ...
        @Put("/type/property/additionalProperties/multipleSpreadRecord")
