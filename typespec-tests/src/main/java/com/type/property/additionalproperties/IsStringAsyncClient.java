...
import com.type.property.additionalproperties.implementation.IsStringsImpl;
...
public final class IsStringAsyncClient {
    @Generated
    private final IsStringsImpl serviceClient;

    /**
     * Initializes an instance of IsStringAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IsStringAsyncClient(IsStringsImpl serviceClient) {
     ...
     * @return the model is from Record&lt;string&gt; type along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return the model is from Record&lt;string&gt; type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IsStringAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(IsStringAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(IsStringAdditionalProperties body) {
