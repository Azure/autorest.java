...
import com.type.property.additionalproperties.implementation.SpreadRecordUnionsImpl;
...
public final class SpreadRecordUnionAsyncClient {
    @Generated
    private final SpreadRecordUnionsImpl serviceClient;

    /**
     * Initializes an instance of SpreadRecordUnionAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadRecordUnionAsyncClient(SpreadRecordUnionsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;string | float32&gt; along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return the model spread Record&lt;string | float32&gt; on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SpreadRecordForUnion> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SpreadRecordForUnion.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SpreadRecordForUnion body) {
