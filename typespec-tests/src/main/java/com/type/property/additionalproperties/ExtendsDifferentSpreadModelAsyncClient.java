...
import com.type.property.additionalproperties.implementation.ExtendsDifferentSpreadModelsImpl;
...
public final class ExtendsDifferentSpreadModelAsyncClient {
    @Generated
    private final ExtendsDifferentSpreadModelsImpl serviceClient;

    /**
     * Initializes an instance of ExtendsDifferentSpreadModelAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsDifferentSpreadModelAsyncClient(ExtendsDifferentSpreadModelsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DifferentSpreadModelDerived> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DifferentSpreadModelDerived.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(DifferentSpreadModelDerived body) {
