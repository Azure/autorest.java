...
import com.type.property.additionalproperties.implementation.SpreadModelsImpl;
...
public final class SpreadModelAsyncClient {
    @Generated
    private final SpreadModelsImpl serviceClient;

    /**
     * Initializes an instance of SpreadModelAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadModelAsyncClient(SpreadModelsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;ModelForRecord&gt; with the same known property type along with
     ...
     * @return the model spread Record&lt;ModelForRecord&gt; with the same known property type on successful completion
     * of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SpreadModelRecord> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SpreadModelRecord.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SpreadModelRecord body) {
