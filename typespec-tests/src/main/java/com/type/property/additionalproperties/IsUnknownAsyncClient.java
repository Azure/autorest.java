...
public final class IsUnknownAsyncClient {
    @Generated
    private final IsUnknownsImpl serviceClient;

    /**
     * Initializes an instance of IsUnknownAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IsUnknownAsyncClient(IsUnknownsImpl serviceClient) {
     ...
     * @return the model is from Record&lt;unknown&gt; type along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return the model is from Record&lt;unknown&gt; type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IsUnknownAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(IsUnknownAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(IsUnknownAdditionalProperties body) {
