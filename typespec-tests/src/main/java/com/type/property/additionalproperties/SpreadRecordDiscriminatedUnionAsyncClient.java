...
import com.type.property.additionalproperties.implementation.SpreadRecordDiscriminatedUnionsImpl;
...
public final class SpreadRecordDiscriminatedUnionAsyncClient {
    @Generated
    private final SpreadRecordDiscriminatedUnionsImpl serviceClient;

    /**
     * Initializes an instance of SpreadRecordDiscriminatedUnionAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadRecordDiscriminatedUnionAsyncClient(SpreadRecordDiscriminatedUnionsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;WidgetData&gt; on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SpreadRecordForDiscriminatedUnion> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SpreadRecordForDiscriminatedUnion.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SpreadRecordForDiscriminatedUnion body) {
