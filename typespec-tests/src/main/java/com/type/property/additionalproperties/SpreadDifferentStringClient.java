...
public final class SpreadDifferentStringClient {
    @Generated
     ...
     * @return the model spread Record&lt;string&gt; with the different known property type.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DifferentSpreadStringRecord get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(DifferentSpreadStringRecord.class);
    }
