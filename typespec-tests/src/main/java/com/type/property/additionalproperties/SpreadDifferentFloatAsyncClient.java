...
public final class SpreadDifferentFloatAsyncClient {
    @Generated
    private final SpreadDifferentFloatsImpl serviceClient;

    /**
     * Initializes an instance of SpreadDifferentFloatAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadDifferentFloatAsyncClient(SpreadDifferentFloatsImpl serviceClient) {
     ...
     * @return the model spread Record&lt;float32&gt; with the different known property type along with {@link Response}
     ...
     * @return the model spread Record&lt;float32&gt; with the different known property type on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DifferentSpreadFloatRecord> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DifferentSpreadFloatRecord.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(DifferentSpreadFloatRecord body) {
