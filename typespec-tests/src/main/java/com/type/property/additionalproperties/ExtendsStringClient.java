...
public final class ExtendsStringClient {
     ...
     */
    @Generated
    ExtendsStringClient(ExtendsStringsImpl serviceClient) {
     ...
     * @return the model extends from Record&lt;string&gt; type along with {@link Response}.
     */
    @Generated
     ...
     * @return the model extends from Record&lt;string&gt; type.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ExtendsStringAdditionalProperties get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(ExtendsStringAdditionalProperties.class);
    }
