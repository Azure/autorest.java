...
public final class SpreadDifferentFloatsImpl {
    ...
    SpreadDifferentFloatsImpl(AdditionalPropertiesClientImpl client) {
        this.service = RestProxy.create(SpreadDifferentFloatsService.class, client.getHttpPipeline(),
    ...
    public interface SpreadDifferentFloatsService {
        ...
        @Put("/type/property/additionalProperties/spreadDifferentRecordFloat")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return the model spread Record&lt;float32&gt; with the different known property type along with
     * {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
