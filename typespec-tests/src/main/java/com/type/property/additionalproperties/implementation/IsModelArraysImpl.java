...
public final class IsModelArraysImpl {
    ...
    IsModelArraysImpl(AdditionalPropertiesClientImpl client) {
        this.service
            = RestProxy.create(IsModelArraysService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface IsModelArraysService {
        ...
        @Put("/type/property/additionalProperties/isRecordModelArray")
     ...
     * @return the model is from Record&lt;ModelForRecord[]&gt; type along with {@link Response} on successful
