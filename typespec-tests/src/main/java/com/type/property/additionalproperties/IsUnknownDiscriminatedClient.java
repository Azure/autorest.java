...
public final class IsUnknownDiscriminatedClient {
     ...
     * @return the model is Record&lt;unknown&gt; with a discriminator along with {@link Response}.
     */
    @Generated
     ...
     * @return the model is Record&lt;unknown&gt; with a discriminator.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public IsUnknownAdditionalPropertiesDiscriminated get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(IsUnknownAdditionalPropertiesDiscriminated.class);
    }
