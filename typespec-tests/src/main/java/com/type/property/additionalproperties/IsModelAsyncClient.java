...
public final class IsModelAsyncClient {
    @Generated
    private final IsModelsImpl serviceClient;

    /**
     * Initializes an instance of IsModelAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IsModelAsyncClient(IsModelsImpl serviceClient) {
     ...
     * @return the model is from Record&lt;ModelForRecord&gt; type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IsModelAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(IsModelAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(IsModelAdditionalProperties body) {
