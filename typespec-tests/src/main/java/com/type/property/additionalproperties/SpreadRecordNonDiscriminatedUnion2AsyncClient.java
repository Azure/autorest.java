...
public final class SpreadRecordNonDiscriminatedUnion2AsyncClient {
    @Generated
    private final SpreadRecordNonDiscriminatedUnion2sImpl serviceClient;

    /**
     * Initializes an instance of SpreadRecordNonDiscriminatedUnion2AsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SpreadRecordNonDiscriminatedUnion2AsyncClient(SpreadRecordNonDiscriminatedUnion2sImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SpreadRecordForNonDiscriminatedUnion2> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SpreadRecordForNonDiscriminatedUnion2.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SpreadRecordForNonDiscriminatedUnion2 body) {
