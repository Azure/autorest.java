...
public final class SpreadStringsImpl {
    ...
    SpreadStringsImpl(AdditionalPropertiesClientImpl client) {
        this.service
            = RestProxy.create(SpreadStringsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface SpreadStringsService {
        @Get("/type/property/additionalProperties/spreadRecordString")
        ...
        @Put("/type/property/additionalProperties/spreadRecordString")
