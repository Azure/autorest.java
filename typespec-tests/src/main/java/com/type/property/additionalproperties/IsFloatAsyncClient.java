...
import com.type.property.additionalproperties.implementation.IsFloatsImpl;
...
public final class IsFloatAsyncClient {
    @Generated
    private final IsFloatsImpl serviceClient;

    /**
     * Initializes an instance of IsFloatAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IsFloatAsyncClient(IsFloatsImpl serviceClient) {
     ...
     * @return the model is from Record&lt;float32&gt; type along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return the model is from Record&lt;float32&gt; type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IsFloatAdditionalProperties> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(IsFloatAdditionalProperties.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(IsFloatAdditionalProperties body) {
