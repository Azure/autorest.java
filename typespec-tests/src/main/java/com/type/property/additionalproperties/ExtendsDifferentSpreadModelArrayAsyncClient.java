...
public final class ExtendsDifferentSpreadModelArrayAsyncClient {
    @Generated
    private final ExtendsDifferentSpreadModelArraysImpl serviceClient;

    /**
     * Initializes an instance of ExtendsDifferentSpreadModelArrayAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtendsDifferentSpreadModelArrayAsyncClient(ExtendsDifferentSpreadModelArraysImpl serviceClient) {
     ...
     * property type along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return the model extends from a model that spread Record&lt;ModelForRecord[]&gt; with the different known
     * property type on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DifferentSpreadModelArrayDerived> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DifferentSpreadModelArrayDerived.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(DifferentSpreadModelArrayDerived body) {
