...
/**
 * An instance of this class provides access to all the operations defined in SpreadRecordDiscriminatedUnions.
 */
public final class SpreadRecordDiscriminatedUnionsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SpreadRecordDiscriminatedUnionsService service;
    ...
    /**
     * Initializes an instance of SpreadRecordDiscriminatedUnionsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SpreadRecordDiscriminatedUnionsImpl(AdditionalPropertiesClientImpl client) {
        this.service = RestProxy.create(SpreadRecordDiscriminatedUnionsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AdditionalPropertiesClientSpreadRecordDiscriminatedUnions to be used
     * by the proxy service to perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "AdditionalProperties")
    public interface SpreadRecordDiscriminatedUnionsService {
        @Get("/type/property/additionalProperties/spreadRecordDiscriminatedUnion")
        ...
        @Put("/type/property/additionalProperties/spreadRecordDiscriminatedUnion")
     ...
     * @return the model spread Record&lt;WidgetData&gt; along with {@link Response} on successful completion of
     * {@link Mono}.
     */
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return the model spread Record&lt;WidgetData&gt; along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
