...
public final class DurationOperationAsyncClient {
    ...
    public Mono<DurationProperty> getAll() {
        ...
        return getAllWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DurationProperty.class));
    }
    ...
    public Mono<DurationProperty> getDefault() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getDefaultWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DurationProperty.class));
    }
