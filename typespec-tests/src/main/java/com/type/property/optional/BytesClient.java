...
import com.type.property.optional.implementation.BytesImpl;
...
public final class BytesClient {
     ...
     * @return template type for testing models with optional property along with {@link Response}.
     */
    @Generated
     ...
     * @return template type for testing models with optional property.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BytesProperty getAll() {
        ...
        return getAllWithResponse(requestOptions).getValue().toObject(BytesProperty.class);
    }
    ...
    public BytesProperty getDefault() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getDefaultWithResponse(requestOptions).getValue().toObject(BytesProperty.class);
    }
