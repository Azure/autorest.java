...
public final class UnionFloatLiteralAsyncClient {
    @Generated
    private final UnionFloatLiteralsImpl serviceClient;

    /**
     * Initializes an instance of UnionFloatLiteralAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    UnionFloatLiteralAsyncClient(UnionFloatLiteralsImpl serviceClient) {
     ...
     * @return model with union of float literal property along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return model with union of float literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnionFloatLiteralProperty> getAll() {
        ...
        return getAllWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(UnionFloatLiteralProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnionFloatLiteralProperty> getDefault() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putAll(UnionFloatLiteralProperty body) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putDefault(UnionFloatLiteralProperty body) {
