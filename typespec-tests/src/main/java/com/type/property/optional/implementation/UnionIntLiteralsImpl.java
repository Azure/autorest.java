...
public final class UnionIntLiteralsImpl {
    ...
    UnionIntLiteralsImpl(OptionalClientImpl client) {
        this.service
            = RestProxy.create(UnionIntLiteralsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface UnionIntLiteralsService {
        @Get("/type/property/optional/union/int/literal/all")
        ...
        @Get("/type/property/optional/union/int/literal/default")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/type/property/optional/union/int/literal/all")
        ...
        @Put("/type/property/optional/union/int/literal/default")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return model with union of int literal property along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
