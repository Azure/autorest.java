...
import com.type.property.optional.implementation.IntLiteralsImpl;
...
public final class IntLiteralAsyncClient {
    @Generated
    private final IntLiteralsImpl serviceClient;

    /**
     * Initializes an instance of IntLiteralAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IntLiteralAsyncClient(IntLiteralsImpl serviceClient) {
     ...
     * @return model with int literal property along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return model with int literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IntLiteralProperty> getAll() {
        ...
        return getAllWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(IntLiteralProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IntLiteralProperty> getDefault() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putAll(IntLiteralProperty body) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putDefault(IntLiteralProperty body) {
