...
import com.type.property.optional.implementation.UnionIntLiteralsImpl;
...
public final class UnionIntLiteralAsyncClient {
    @Generated
    private final UnionIntLiteralsImpl serviceClient;

    /**
     * Initializes an instance of UnionIntLiteralAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    UnionIntLiteralAsyncClient(UnionIntLiteralsImpl serviceClient) {
     ...
     * @return model with union of int literal property along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return model with union of int literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnionIntLiteralProperty> getAll() {
        ...
        return getAllWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(UnionIntLiteralProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UnionIntLiteralProperty> getDefault() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putAll(UnionIntLiteralProperty body) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putDefault(UnionIntLiteralProperty body) {
