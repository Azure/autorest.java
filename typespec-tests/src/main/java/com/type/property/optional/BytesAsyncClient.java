...
public final class BytesAsyncClient {
    ...
    public Mono<BytesProperty> getAll() {
        ...
        return getAllWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(BytesProperty.class));
    }
    ...
    public Mono<BytesProperty> getDefault() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getDefaultWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(BytesProperty.class));
    }
