...
import com.type.property.optional.implementation.FloatLiteralsImpl;
...
public final class FloatLiteralAsyncClient {
    @Generated
    private final FloatLiteralsImpl serviceClient;

    /**
     * Initializes an instance of FloatLiteralAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    FloatLiteralAsyncClient(FloatLiteralsImpl serviceClient) {
     ...
     * @return model with float literal property along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return model with float literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FloatLiteralProperty> getAll() {
        ...
        return getAllWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(FloatLiteralProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FloatLiteralProperty> getDefault() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putAll(FloatLiteralProperty body) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putDefault(FloatLiteralProperty body) {
