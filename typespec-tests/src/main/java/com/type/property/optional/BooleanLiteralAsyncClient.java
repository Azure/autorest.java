...
import com.type.property.optional.implementation.BooleanLiteralsImpl;
...
public final class BooleanLiteralAsyncClient {
    ...
    /**
     * Initializes an instance of BooleanLiteralAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    BooleanLiteralAsyncClient(BooleanLiteralsImpl serviceClient) {
     ...
     * @return model with boolean literal property along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return model with boolean literal property on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BooleanLiteralProperty> getAll() {
        ...
        return getAllWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(BooleanLiteralProperty.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BooleanLiteralProperty> getDefault() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putAll(BooleanLiteralProperty body) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putDefault(BooleanLiteralProperty body) {
