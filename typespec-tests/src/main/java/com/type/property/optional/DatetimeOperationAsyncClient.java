...
import com.type.property.optional.implementation.DatetimeOperationsImpl;
...
public final class DatetimeOperationAsyncClient {
    ...
    public Mono<DatetimeProperty> getAll() {
        ...
        return getAllWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DatetimeProperty.class));
    }
    ...
    public Mono<DatetimeProperty> getDefault() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getDefaultWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DatetimeProperty.class));
    }
