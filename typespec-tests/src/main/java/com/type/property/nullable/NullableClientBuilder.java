 ...
 */
@ServiceClientBuilder(serviceClients = {StringOperationClient.class, BytesClient.class, DatetimeOperationClient.class, DurationOperationClient.class, CollectionsByteClient.class, CollectionsModelClient.class, StringOperationAsyncClient.class, BytesAsyncClient.class, DatetimeOperationAsyncClient.class, DurationOperationAsyncClient.class, CollectionsByteAsyncClient.class, CollectionsModelAsyncClient.class})
public final class NullableClientBuilder implements HttpTrait<NullableClientBuilder>, ConfigurationTrait<NullableClientBuilder> {
    @Generated
    ...
    private NullableClientImpl buildInnerClient() {
        ...
        NullableClientImpl client = new NullableClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
