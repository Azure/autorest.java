...
@ServiceClientBuilder(serviceClients = {
    StringOperationClient.class, BytesClient.class, DatetimeOperationClient.class, DurationOperationClient.class,
    CollectionsByteClient.class, CollectionsModelClient.class, StringOperationAsyncClient.class, BytesAsyncClient.class,
