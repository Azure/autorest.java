...
public final class DurationOperationAsyncClient {
    ...
    public Mono<DurationProperty> getNonNull() {
        ...
        return getNonNullWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DurationProperty.class));
    }
    ...
    public Mono<DurationProperty> getNull() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getNullWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DurationProperty.class));
    }
}
