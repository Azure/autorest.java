...
public final class CollectionsStringsImpl {
    ...
    public interface CollectionsStringsService {
        @Get("/type/property/nullable/collections/string/non-null")
        ...
        @Get("/type/property/nullable/collections/string/null")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Patch("/type/property/nullable/collections/string/non-null")
        ...
        @Patch("/type/property/nullable/collections/string/null")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
     ...
     * @return model with collection string properties along with {@link Response} on successful completion of
     * {@link Mono}.
     */
