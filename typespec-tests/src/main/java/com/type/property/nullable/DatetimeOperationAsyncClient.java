...
public final class DatetimeOperationAsyncClient {
    ...
    public Mono<DatetimeProperty> getNonNull() {
        ...
        return getNonNullWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DatetimeProperty.class));
    }
    ...
    public Mono<DatetimeProperty> getNull() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getNullWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(DatetimeProperty.class));
    }
}
