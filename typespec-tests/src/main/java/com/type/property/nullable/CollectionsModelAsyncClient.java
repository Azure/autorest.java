...
public final class CollectionsModelAsyncClient {
     ...
     * @return model with collection models properties along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @Generated
     ...
     * @return model with collection models properties on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CollectionsModelProperty> getNonNull() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CollectionsModelProperty> getNull() {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> patchNonNull(CollectionsModelProperty body) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> patchNull(CollectionsModelProperty body) {
