...
public final class StringOperationAsyncClient {
    ...
    public Mono<StringProperty> getNonNull() {
        ...
        return getNonNullWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(StringProperty.class));
    }
    ...
    public Mono<StringProperty> getNull() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getNullWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(StringProperty.class));
    }
}
