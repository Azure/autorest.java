...
public final class SendRequest9 implements JsonSerializable<SendRequest9> {
     ...
     */
    @Generated
    private final GetResponseProp6 prop;
     ...
     */
    @Generated
    public SendRequest9(GetResponseProp6 prop) {
        this.prop = prop;
    }
     ...
     */
    @Generated
    public GetResponseProp6 getProp() {
        return this.prop;
    }
    ...
    public static SendRequest9 fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            GetResponseProp6 prop = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("prop".equals(fieldName)) {
                    prop = GetResponseProp6.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
