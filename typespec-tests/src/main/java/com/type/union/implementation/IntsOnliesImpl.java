...
public final class IntsOnliesImpl {
    ...
    IntsOnliesImpl(UnionClientImpl client) {
        this.service
            = RestProxy.create(IntsOnliesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for UnionClientIntsOnlies to be used by the proxy service to perform
     * REST calls.
     */
