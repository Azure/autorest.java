...
public final class EnumsOnliesImpl {
    ...
    EnumsOnliesImpl(UnionClientImpl client) {
        this.service
            = RestProxy.create(EnumsOnliesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface EnumsOnliesService {
        ...
        Mono<Response<Void>> send(@HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") BinaryData sendRequest3, RequestOptions requestOptions, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> sendWithResponseAsync(BinaryData sendRequest3, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return FluxUtil.withContext(context -> service.send(contentType, sendRequest3, requestOptions, context));
    }
    ...
    public Response<Void> sendWithResponse(BinaryData sendRequest3, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return service.sendSync(contentType, sendRequest3, requestOptions, Context.NONE);
    }
}
