...
public final class StringAndArraysImpl {
    ...
    StringAndArraysImpl(UnionClientImpl client) {
        this.service
            = RestProxy.create(StringAndArraysService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface StringAndArraysService {
        ...
        @Post("/type/union/string-and-array")
    ...
    public Mono<Response<Void>> sendWithResponseAsync(BinaryData sendRequest2, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.send(contentType, sendRequest2, requestOptions, context));
    }
    ...
    public Response<Void> sendWithResponse(BinaryData sendRequest2, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return service.sendSync(contentType, sendRequest2, requestOptions, Context.NONE);
    }
}
