...
public final class StringExtensibleAsyncClient {

    @Generated
    private final StringExtensiblesImpl serviceClient;

    /**
     * Initializes an instance of StringExtensibleAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    StringExtensibleAsyncClient(StringExtensiblesImpl serviceClient) {
