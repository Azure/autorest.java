...
public final class VisibilityClientBuilder implements HttpTrait<VisibilityClientBuilder>, ConfigurationTrait<VisibilityClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("type-model-visibility.properties");
    ...
    private VisibilityClientImpl buildInnerClient() {
        ...
        VisibilityClientImpl client = new VisibilityClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
