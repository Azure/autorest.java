 ...
 */
@ServiceClient(builder = SingleDiscriminatorClientBuilder.class, isAsync = true)
public final class SingleDiscriminatorAsyncClient {
    @Generated
    private final SingleDiscriminatorClientImpl serviceClient;

    /**
     * Initializes an instance of SingleDiscriminatorAsyncClient class.
     * 
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getLegacyModelWithResponse(RequestOptions requestOptions) {
        return this.serviceClient.getLegacyModelWithResponseAsync(requestOptions);
    }
     ...
     * @return this is base model for polymorphic single level inheritance with a discriminator on successful
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putModel(Bird input) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> putRecursiveModel(Bird input) {
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return define a base class in the legacy way on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
