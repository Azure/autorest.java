...
public final class NestedDiscriminatorClientBuilder implements HttpTrait<NestedDiscriminatorClientBuilder>, ConfigurationTrait<NestedDiscriminatorClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("type-model-inheritance-nesteddiscriminator.properties");
    ...
    @Generated
    @Override
    public NestedDiscriminatorClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public NestedDiscriminatorClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public NestedDiscriminatorClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public NestedDiscriminatorClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public NestedDiscriminatorClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the NestedDiscriminatorClientBuilder.
     */
    @Generated
    public NestedDiscriminatorClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private NestedDiscriminatorClientImpl buildInnerClient() {
        ...
        NestedDiscriminatorClientImpl client = new NestedDiscriminatorClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
    ...
    /**
     * Builds an instance of NestedDiscriminatorAsyncClient class.
     * 
     * @return an instance of NestedDiscriminatorAsyncClient.
     */
    @Generated
    public NestedDiscriminatorAsyncClient buildAsyncClient() {
        return new NestedDiscriminatorAsyncClient(buildInnerClient());
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(NestedDiscriminatorClientBuilder.class);
}
