...
public final class EnumDiscriminatorClientBuilder implements HttpTrait<EnumDiscriminatorClientBuilder>, ConfigurationTrait<EnumDiscriminatorClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("type-model-inheritance-enumdiscriminator.properties");

    @Generated
    private final List<HttpPipelinePolicy> pipelinePolicies;

    /**
     * Create an instance of the EnumDiscriminatorClientBuilder.
     */
    @Generated
    ...
    @Generated
    @Override
    public EnumDiscriminatorClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public EnumDiscriminatorClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public EnumDiscriminatorClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public EnumDiscriminatorClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public EnumDiscriminatorClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public EnumDiscriminatorClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Generated
    @Override
    public EnumDiscriminatorClientBuilder configuration(Configuration configuration) {
     ...
     * @return the EnumDiscriminatorClientBuilder.
     */
    @Generated
    public EnumDiscriminatorClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private EnumDiscriminatorClientImpl buildInnerClient() {
        ...
        EnumDiscriminatorClientImpl client = new EnumDiscriminatorClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
    ...
    /**
     * Builds an instance of EnumDiscriminatorAsyncClient class.
     * 
     * @return an instance of EnumDiscriminatorAsyncClient.
     */
    @Generated
    public EnumDiscriminatorAsyncClient buildAsyncClient() {
        return new EnumDiscriminatorAsyncClient(buildInnerClient());
    }
