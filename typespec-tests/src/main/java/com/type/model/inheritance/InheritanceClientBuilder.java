...
public final class InheritanceClientBuilder
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("type-model-inheritance.properties");
    ...
    public InheritanceAsyncClient buildAsyncClient() {
        return new InheritanceAsyncClient(buildInnerClient());
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(InheritanceClientBuilder.class);
}
