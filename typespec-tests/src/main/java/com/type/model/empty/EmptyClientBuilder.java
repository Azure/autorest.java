...
public final class EmptyClientBuilder implements HttpTrait<EmptyClientBuilder>, ConfigurationTrait<EmptyClientBuilder>,
     ...
     */
    @Generated
    public EmptyClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private EmptyClientImpl buildInnerClient() {
        ...
        EmptyClientImpl client
            = new EmptyClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
     ...
     */
    @Generated
    public EmptyAsyncClient buildAsyncClient() {
        return new EmptyAsyncClient(buildInnerClient());
    }
