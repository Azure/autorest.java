...
public final class EmptyAsyncClient {
    ...
    public Mono<EmptyOutput> getEmpty() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getEmptyWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(EmptyOutput.class));
    }
    ...
    public Mono<EmptyInputOutput> postRoundTripEmpty(EmptyInputOutput body) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return postRoundTripEmptyWithResponse(BinaryData.fromObject(body), requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(EmptyInputOutput.class));
    }
}
