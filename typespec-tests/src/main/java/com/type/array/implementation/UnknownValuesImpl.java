...
public final class UnknownValuesImpl {
     ...
     */
     UnknownValuesImpl(ArrayClientImpl client) {
        this.service = RestProxy.create(UnknownValuesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
