...
public final class ModelValuesImpl {
     ...
     */
     ModelValuesImpl(ArrayClientImpl client) {
        this.service = RestProxy.create(ModelValuesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return array of InnerModel along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
