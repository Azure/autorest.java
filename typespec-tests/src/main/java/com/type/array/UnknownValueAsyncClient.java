...
import com.type.array.implementation.UnknownValuesImpl;
...
public final class UnknownValueAsyncClient {
     ...
     * @return array of any along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return array of any on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<Object>> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_LIST_OBJECT));
    }
