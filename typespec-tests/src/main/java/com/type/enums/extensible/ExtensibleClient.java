...
public final class ExtensibleClient {
    ...
    public DaysOfWeekExtensibleEnum getKnownValue() {
        ...
        return DaysOfWeekExtensibleEnum.fromString(getKnownValueWithResponse(requestOptions).getValue().toObject(String.class));
    }
    ...
    public DaysOfWeekExtensibleEnum getUnknownValue() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return DaysOfWeekExtensibleEnum.fromString(getUnknownValueWithResponse(requestOptions).getValue().toObject(String.class));
    }
