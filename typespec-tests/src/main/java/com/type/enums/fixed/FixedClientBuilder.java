...
public final class FixedClientBuilder implements HttpTrait<FixedClientBuilder>, ConfigurationTrait<FixedClientBuilder>,
    EndpointTrait<FixedClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("type-enums-fixed.properties");
    ...
    @Generated
    @Override
    public FixedClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public FixedClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public FixedClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public FixedClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public FixedClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     * @return the FixedClientBuilder.
     */
    @Generated
    public FixedClientBuilder retryPolicy(RetryPolicy retryPolicy) {
    ...
    private FixedClientImpl buildInnerClient() {
        ...
        FixedClientImpl client
            = new FixedClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
    ...
    /**
     * Builds an instance of FixedAsyncClient class.
     * 
     * @return an instance of FixedAsyncClient.
     */
    @Generated
