...
public final class FixedAsyncClient {
    ...
    public Mono<DaysOfWeekEnum> getKnownValue() {
        ...
        return getKnownValueWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> DaysOfWeekEnum.fromString(protocolMethodData.toObject(String.class)));
    }
