...
public final class UnknownValueAsyncClient {
    ...
    public Mono<Map<String, Object>> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_OBJECT));
    }
    ...
    @Generated
    private static final TypeReference<Map<String, Object>> TYPE_REFERENCE_MAP_STRING_OBJECT = new TypeReference<Map<String, Object>>() {};
}
