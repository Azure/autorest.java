...
public final class Int64ValueAsyncClient {
    ...
    public Mono<Map<String, Long>> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_LONG));
    }
    ...
    @Generated
    private static final TypeReference<Map<String, Long>> TYPE_REFERENCE_MAP_STRING_LONG = new TypeReference<Map<String, Long>>() {};
}
