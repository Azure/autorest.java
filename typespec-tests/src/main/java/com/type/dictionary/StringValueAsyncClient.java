...
import com.type.dictionary.implementation.StringValuesImpl;
...
public final class StringValueAsyncClient {
    ...
    public Mono<Map<String, String>> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_STRING));
    }
