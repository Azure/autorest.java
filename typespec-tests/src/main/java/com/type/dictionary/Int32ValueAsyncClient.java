...
import com.type.dictionary.implementation.Int32ValuesImpl;
...
public final class Int32ValueAsyncClient {
    @Generated
    private final Int32ValuesImpl serviceClient;

    /**
     * Initializes an instance of Int32ValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
     Int32ValueAsyncClient(Int32ValuesImpl serviceClient) {
     ...
     * @return dictionary of GetResponse on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Map<String, Integer>> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_INTEGER));
    }
    ...
    @Generated
    private static final TypeReference<Map<String, Integer>> TYPE_REFERENCE_MAP_STRING_INTEGER = new TypeReference<Map<String, Integer>>() {};
}
