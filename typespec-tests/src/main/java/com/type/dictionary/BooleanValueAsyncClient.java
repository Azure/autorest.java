...
public final class BooleanValueAsyncClient {
    ...
    public Mono<Map<String, Boolean>> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_BOOLEAN));
    }
    ...
    @Generated
    private static final TypeReference<Map<String, Boolean>> TYPE_REFERENCE_MAP_STRING_BOOLEAN = new TypeReference<Map<String, Boolean>>() {};
}
