...
import com.type.dictionary.implementation.NullableFloatValuesImpl;
...
public final class NullableFloatValueAsyncClient {
    ...
    public Mono<Map<String, Double>> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_DOUBLE));
    }
    ...
    @Generated
    private static final TypeReference<Map<String, Double>> TYPE_REFERENCE_MAP_STRING_DOUBLE = new TypeReference<Map<String, Double>>() {};
}
