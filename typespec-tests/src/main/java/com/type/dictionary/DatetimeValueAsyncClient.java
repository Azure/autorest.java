...
import com.type.dictionary.implementation.DatetimeValuesImpl;
...
public final class DatetimeValueAsyncClient {
    ...
    public Mono<Map<String, OffsetDateTime>> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_OFFSET_DATE_TIME));
    }
    ...
    @Generated
    private static final TypeReference<Map<String, OffsetDateTime>> TYPE_REFERENCE_MAP_STRING_OFFSET_DATE_TIME = new TypeReference<Map<String, OffsetDateTime>>() {};
}
