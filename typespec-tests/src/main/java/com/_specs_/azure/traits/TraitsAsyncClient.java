...
public final class TraitsAsyncClient {
    ...
    public Mono<Response<BinaryData>> getWithResponse(int id, String foo, RequestOptions requestOptions) {
        return this.serviceClient.getWithResponseAsync(id, foo, requestOptions);
    }
    ...
    public Mono<User> get(
        ...
        return getWithResponse(id, foo, requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<User> get(int id, String foo) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(id, foo, requestOptions)
                .flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> delete(int id, String clientRequestId) {
