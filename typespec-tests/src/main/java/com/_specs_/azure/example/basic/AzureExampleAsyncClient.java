...
/**
 * Initializes a new instance of the asynchronous AzureExampleClient type.
 */
@ServiceClient(builder = AzureExampleClientBuilder.class, isAsync = true)
public final class AzureExampleAsyncClient {
    @Generated
    private final AzureExampleClientImpl serviceClient;

    /**
     * Initializes an instance of AzureExampleAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    AzureExampleAsyncClient(AzureExampleClientImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> basicActionWithResponse(String queryParam, String headerParam, BinaryData body,
        RequestOptions requestOptions) {
        return this.serviceClient.basicActionWithResponseAsync(queryParam, headerParam, body, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ActionResponse> basicAction(String queryParam, String headerParam, ActionRequest body) {
        // Generated convenience method for basicActionWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return basicActionWithResponse(queryParam, headerParam, BinaryData.fromObject(body), requestOptions)
            .flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ActionResponse.class));
    }
}
