    ...
    public static PublicDecoratorModelInPublic fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(
                reader -> {
                    ...
                    if (nameFound) {
                        PublicDecoratorModelInPublic deserializedPublicDecoratorModelInPublic =
                                new PublicDecoratorModelInPublic(name);

                        return deserializedPublicDecoratorModelInPublic;
                    }
