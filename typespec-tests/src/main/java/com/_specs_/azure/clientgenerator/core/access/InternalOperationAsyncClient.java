...
public final class InternalOperationAsyncClient {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
     Mono<NoDecoratorModelInInternal> noDecoratorInInternal(String name) {
        ...
        return noDecoratorInInternalWithResponse(name, requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(NoDecoratorModelInInternal.class));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
     Mono<InternalDecoratorModelInInternal> internalDecoratorInInternal(String name) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return internalDecoratorInInternalWithResponse(name, requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(InternalDecoratorModelInInternal.class));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
     Mono<PublicDecoratorModelInInternal> publicDecoratorInInternal(String name) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return publicDecoratorInInternalWithResponse(name, requestOptions).flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(PublicDecoratorModelInInternal.class));
    }
}
