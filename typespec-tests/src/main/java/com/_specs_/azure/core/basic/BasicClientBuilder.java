...
public final class BasicClientBuilder implements HttpTrait<BasicClientBuilder>, ConfigurationTrait<BasicClientBuilder> {
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("_specs_-azure-core-basic.properties");
    ...
    private BasicClientImpl buildInnerClient() {
        ...
        BasicServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : BasicServiceVersion.getLatest();
        BasicClientImpl client = new BasicClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), localServiceVersion);
        return client;
    }
