...
public final class RpcClientBuilder implements HttpTrait<RpcClientBuilder>, ConfigurationTrait<RpcClientBuilder> {
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("_specs_-azure-core-lro-rpc.properties");
    ...
    private RpcClientImpl buildInnerClient() {
        ...
        RpcServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : RpcServiceVersion.getLatest();
        RpcClientImpl client = new RpcClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), localServiceVersion);
        return client;
    }
