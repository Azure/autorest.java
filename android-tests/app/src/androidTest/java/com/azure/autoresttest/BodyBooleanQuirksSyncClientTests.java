...
import com.azure.androidtest.fixtures.bodybooleanquirks.AutoRestBoolTestServiceClient;
...
public class BodyBooleanQuirksSyncClientTests {
    ...
    @Test
    public void putTrue() {
        final Response<Void> putResponse = client.putTrueWithRestResponse(true);
        assertEquals(200, putResponse.getStatusCode());
    }

    @Test
    public void putFalse() {
        final Response<Void> putResponse = client.putFalseWithRestResponse(false);
        assertEquals(200, putResponse.getStatusCode());
    }
}
