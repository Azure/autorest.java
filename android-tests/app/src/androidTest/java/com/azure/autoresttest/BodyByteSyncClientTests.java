...
public class BodyByteSyncClientTests {
    ...
    public void getNonAscii() {
        ...
        assertEquals(200, getResponse.getStatusCode());
        // Previously, byte[] response bodies were automatically base64 decoded by the
        // runtime.
    ...
    public void putNonAscii() {
        byte[] body = new byte[] { (byte) 255, (byte) 254, (byte) 253, (byte) 252, (byte) 251, (byte) 250, (byte) 249,
                (byte) 248, (byte) 247, (byte) 246 };
