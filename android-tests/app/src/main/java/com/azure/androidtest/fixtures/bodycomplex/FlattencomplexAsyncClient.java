...
import com.azure.androidtest.fixtures.bodycomplex.implementation.FlattencomplexsImpl;
...
public final class FlattencomplexAsyncClient {
    private FlattencomplexsImpl serviceClient;

    /**
     * Initializes an instance of Flattencomplexs client.
     */
    FlattencomplexAsyncClient(FlattencomplexsImpl serviceClient) {
    ...
    /**
     * A builder for creating a new instance of the FlattencomplexAsyncClient type.
     */
    public static final class Builder {
        ...
        /**
         * Builds an instance of FlattencomplexAsyncClient with the provided parameters.
         * 
         * @return an instance of FlattencomplexAsyncClient.
         */
        public FlattencomplexAsyncClient build() {
            if (host == null) {
            ...
            return new FlattencomplexAsyncClient(internalClient.getFlattencomplexs());
        }
    }
}
