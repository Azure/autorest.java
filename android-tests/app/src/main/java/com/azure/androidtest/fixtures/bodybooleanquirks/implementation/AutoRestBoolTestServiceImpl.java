package com.azure.androidtest.fixtures.bodybooleanquirks.implementation;
 ...
 */
public final class AutoRestBoolTestServiceImpl {
    /**
     * The serializer.
     */
    ...
    /**
     * The BoolsImpl object to access its operations.
     */
    private final BoolsImpl bools;

    /**
     * Gets the BoolsImpl object to access its operations.
     * 
     * @return the BoolsImpl object.
     */
    public BoolsImpl getBools() {
        return this.bools;
    }
     ...
     */
    public AutoRestBoolTestServiceImpl(ServiceClient serviceClient, String host) {
