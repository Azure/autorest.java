...
public final class InheritanceAsyncClient {
    ...
    /**
     * A builder for creating a new instance of the InheritanceAsyncClient type.
     */
    public static final class Builder {
        ...
        /**
         * Builds an instance of InheritanceAsyncClient with the provided parameters.
         * 
         * @return an instance of InheritanceAsyncClient.
         */
        public InheritanceAsyncClient build() {
            if (host == null) {
            ...
            return new InheritanceAsyncClient(internalClient.getInheritances());
        }
    }
}
