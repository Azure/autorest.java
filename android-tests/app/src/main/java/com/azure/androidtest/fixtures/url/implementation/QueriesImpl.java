...
public final class QueriesImpl {
    ...
    QueriesImpl(AutoRestUrlTestServiceImpl client) {
        this.client = client;
        this.service = this.client.getServiceClient().getRetrofit().create(QueriesService.class);
    }
    ...
    private interface QueriesService {
        ...
        Call<ResponseBody> floatScientificPositive(@Query("floatQuery") float floatQuery);

        @GET("/queries/float/-1.034E-20")
        Call<ResponseBody> floatScientificNegative(@Query("floatQuery") float floatQuery);

        @GET("/queries/float/null")
        Call<ResponseBody> floatNull(@Query("floatQuery") Float floatQuery);
        ...
        Call<ResponseBody> dateTimeValid(@Query("dateTimeQuery") OffsetDateTime dateTimeQuery);

        @GET("/queries/datetime/null")
        Call<ResponseBody> dateTimeNull(@Query("dateTimeQuery") OffsetDateTime dateTimeQuery);
        ...
        Call<ResponseBody> arrayStringNoCollectionFormatEmpty(@Query("arrayQuery") String arrayQuery);
    ...
    public Response<Void> getBooleanTrueWithRestResponse() {
        final boolean boolQuery = true;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getBooleanTrue(boolQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
    ...
    public Response<Void> getBooleanFalseWithRestResponse() {
        final boolean boolQuery = false;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getBooleanFalse(boolQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> getBooleanNullWithRestResponse(Boolean boolQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getBooleanNull(boolQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> getIntOneMillionWithRestResponse() {
        final int intQuery = 1000000;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getIntOneMillion(intQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> getIntNegativeOneMillionWithRestResponse() {
        final int intQuery = -1000000;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getIntNegativeOneMillion(intQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> getIntNullWithRestResponse(Integer intQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getIntNull(intQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> getTenBillionWithRestResponse() {
        final long longQuery = 10000000000L;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getTenBillion(longQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> getNegativeTenBillionWithRestResponse() {
        final long longQuery = -10000000000L;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getNegativeTenBillion(longQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> getLongNullWithRestResponse(Long longQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getLongNull(longQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> floatScientificPositiveWithRestResponse() {
        final float floatQuery = 103400000000000000000f;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.floatScientificPositive(floatQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> floatScientificNegativeWithRestResponse() {
        final float floatQuery = -1.034E-20f;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.floatScientificNegative(floatQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> floatNullWithRestResponse(Float floatQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.floatNull(floatQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> doubleDecimalPositiveWithRestResponse() {
        final double doubleQuery = 9999999.999;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.doubleDecimalPositive(doubleQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> doubleDecimalNegativeWithRestResponse() {
        final double doubleQuery = -9999999.999;
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.doubleDecimalNegative(doubleQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> doubleNullWithRestResponse(Double doubleQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.doubleNull(doubleQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> stringUnicodeWithRestResponse() {
        final String stringQuery = "啊齄丂狛狜隣郎隣兀﨩";
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.stringUnicode(stringQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> stringUrlEncodedWithRestResponse() {
        final String stringQuery = "begin!*'();:@ &=+$,/?#[]end";
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.stringUrlEncoded(stringQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> stringEmptyWithRestResponse() {
        final String stringQuery = "";
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.stringEmpty(stringQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> stringNullWithRestResponse(String stringQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.stringNull(stringQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> enumValidWithRestResponse(UriColor enumQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.enumValid(enumQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> enumNullWithRestResponse(UriColor enumQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.enumNull(enumQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> byteMultiByteWithRestResponse(byte[] byteQuery) {
        String byteQueryConverted = Base64Util.encodeToString(byteQuery);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.byteMultiByte(byteQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> byteEmptyWithRestResponse() {
        final byte[] byteQuery = "".getBytes();
        String byteQueryConverted = Base64Util.encodeToString(byteQuery);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.byteEmpty(byteQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> byteNullWithRestResponse(byte[] byteQuery) {
        String byteQueryConverted = Base64Util.encodeToString(byteQuery);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.byteNull(byteQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> dateValidWithRestResponse() {
        final LocalDate dateQuery = LocalDate.parse("2012-01-01");
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.dateValid(dateQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> dateNullWithRestResponse(LocalDate dateQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.dateNull(dateQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> dateTimeValidWithRestResponse() {
        final OffsetDateTime dateTimeQuery = OffsetDateTime.parse("2012-01-01T01:01:01Z");
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.dateTimeValid(dateTimeQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> dateTimeNullWithRestResponse(OffsetDateTime dateTimeQuery) {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.dateTimeNull(dateTimeQuery));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void arrayStringCsvValid(List<String> arrayQuery, final Callback<Void> callback) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.CSV);
    ...
    public Response<Void> arrayStringCsvValidWithRestResponse(List<String> arrayQuery) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.CSV);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.arrayStringCsvValid(arrayQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> arrayStringCsvNullWithRestResponse(List<String> arrayQuery) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.CSV);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.arrayStringCsvNull(arrayQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public Response<Void> arrayStringCsvEmptyWithRestResponse(List<String> arrayQuery) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.CSV);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.arrayStringCsvEmpty(arrayQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void arrayStringNoCollectionFormatEmpty(List<String> arrayQuery, final Callback<Void> callback) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.CSV);
        Call<ResponseBody> call = service.arrayStringNoCollectionFormatEmpty(arrayQueryConverted);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> arrayStringNoCollectionFormatEmptyWithRestResponse(List<String> arrayQuery) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.CSV);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.arrayStringNoCollectionFormatEmpty(arrayQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void arrayStringSsvValid(List<String> arrayQuery, final Callback<Void> callback) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.SSV);
    ...
    public Response<Void> arrayStringSsvValidWithRestResponse(List<String> arrayQuery) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.SSV);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.arrayStringSsvValid(arrayQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void arrayStringTsvValid(List<String> arrayQuery, final Callback<Void> callback) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.TSV);
    ...
    public Response<Void> arrayStringTsvValidWithRestResponse(List<String> arrayQuery) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.TSV);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.arrayStringTsvValid(arrayQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void arrayStringPipesValid(List<String> arrayQuery, final Callback<Void> callback) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.PIPES);
    ...
    public Response<Void> arrayStringPipesValidWithRestResponse(List<String> arrayQuery) {
        String arrayQueryConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(arrayQuery, SerializerAdapter.CollectionFormat.PIPES);
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.arrayStringPipesValid(arrayQueryConverted));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
