...
public final class PrimitivesImpl {
    ...
    PrimitivesImpl(AutoRestComplexTestServiceImpl client) {
        this.client = client;
        this.service = this.client.getServiceClient().getRetrofit().create(PrimitivesService.class);
    }
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final IntWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), IntWrapper.class);
                        } catch(Exception ex) {
    ...
    public Response<IntWrapper> getIntWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getInt());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), IntWrapper.class));
            } else {
    ...
    public void putInt(IntWrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putInt(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putIntWithRestResponse(IntWrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putInt(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getLong(final Callback<LongWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final LongWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), LongWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<LongWrapper> getLongWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getLong());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), LongWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putLong(LongWrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putLong(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putLongWithRestResponse(LongWrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putLong(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getFloat(final Callback<FloatWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final FloatWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), FloatWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<FloatWrapper> getFloatWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getFloat());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), FloatWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putFloat(FloatWrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putFloat(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putFloatWithRestResponse(FloatWrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putFloat(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getDouble(final Callback<DoubleWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final DoubleWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), DoubleWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<DoubleWrapper> getDoubleWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getDouble());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), DoubleWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putDouble(DoubleWrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putDouble(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putDoubleWithRestResponse(DoubleWrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putDouble(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getBool(final Callback<BooleanWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final BooleanWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), BooleanWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<BooleanWrapper> getBoolWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getBool());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), BooleanWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putBool(BooleanWrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putBool(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putBoolWithRestResponse(BooleanWrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putBool(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getString(final Callback<StringWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final StringWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), StringWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<StringWrapper> getStringWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getString());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), StringWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putString(StringWrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putString(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putStringWithRestResponse(StringWrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putString(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getDate(final Callback<DateWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final DateWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), DateWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<DateWrapper> getDateWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getDate());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), DateWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putDate(DateWrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putDate(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putDateWithRestResponse(DateWrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putDate(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getDateTime(final Callback<DatetimeWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final DatetimeWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), DatetimeWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<DatetimeWrapper> getDateTimeWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getDateTime());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), DatetimeWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putDateTime(DatetimeWrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putDateTime(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putDateTimeWithRestResponse(DatetimeWrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putDateTime(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getDateTimeRfc1123(final Callback<Datetimerfc1123Wrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final Datetimerfc1123Wrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), Datetimerfc1123Wrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<Datetimerfc1123Wrapper> getDateTimeRfc1123WithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getDateTimeRfc1123());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), Datetimerfc1123Wrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putDateTimeRfc1123(Datetimerfc1123Wrapper complexBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putDateTimeRfc1123(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putDateTimeRfc1123WithRestResponse(Datetimerfc1123Wrapper complexBody) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putDateTimeRfc1123(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getDuration(final Callback<DurationWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final DurationWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), DurationWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<DurationWrapper> getDurationWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getDuration());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), DurationWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putDuration(Duration field, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putDuration(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putDurationWithRestResponse(Duration field) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putDuration(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
    ...
    public void getByte(final Callback<ByteWrapper> callback) {
        ...
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            ...
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        final ByteWrapper decodedResult;
                        try {
                            decodedResult = client.deserializeContent(response.headers(), response.body(), ByteWrapper.class);
                        } catch(Exception ex) {
                            callback.onFailure(ex, response.raw());
                            return;
                        }
    ...
    public Response<ByteWrapper> getByteWithRestResponse() {
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.getByte());
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
                                        response.headers(),
                                        this.client.deserializeContent(response.headers(), response.body(), ByteWrapper.class));
            } else {
                final String strContent = this.client.readAsString(response.body());
                throw new ErrorException(strContent, response.raw());
            }
    ...
    public void putByte(byte[] field, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putByte(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public Response<Void> putByteWithRestResponse(byte[] field) {
        ...
        final retrofit2.Response<ResponseBody> response = this.client.executeRetrofitCall(service.putByte(okHttp3RequestBody));
        if (response.isSuccessful()) {
            if (response.code() == 200) {
                return new Response<>(response.raw().request(),
                                        response.code(),
