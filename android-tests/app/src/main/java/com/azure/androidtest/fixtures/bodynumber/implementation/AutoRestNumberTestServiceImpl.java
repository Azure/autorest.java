 ...
 */
public final class AutoRestNumberTestServiceImpl {
    /**
     * The serializer.
     */
    ...
    /**
     * The NumbersImpl object to access its operations.
     */
    private final NumbersImpl numbers;

    /**
     * Gets the NumbersImpl object to access its operations.
     * 
     * @return the NumbersImpl object.
     */
     ...
     */
    public AutoRestNumberTestServiceImpl(ServiceClient serviceClient, String host) {
