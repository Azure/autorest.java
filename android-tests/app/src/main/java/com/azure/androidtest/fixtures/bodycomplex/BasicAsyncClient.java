...
public final class BasicAsyncClient {
    ...
    /**
     * A builder for creating a new instance of the BasicAsyncClient type.
     */
    public static final class Builder {
        ...
        /**
         * Builds an instance of BasicAsyncClient with the provided parameters.
         * 
         * @return an instance of BasicAsyncClient.
         */
        public BasicAsyncClient build() {
            if (host == null) {
            ...
            return new BasicAsyncClient(internalClient.getBasics());
        }
    }
}
