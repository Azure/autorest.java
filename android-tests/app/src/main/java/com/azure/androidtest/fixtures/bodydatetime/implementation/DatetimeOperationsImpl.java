package com.azure.androidtest.fixtures.bodydatetime.implementation;
...
public final class DatetimeOperationsImpl {
     ...
     */
    private final AutoRestDateTimeTestServiceImpl client;
    ...
    DatetimeOperationsImpl(AutoRestDateTimeTestServiceImpl client) {
        this.client = client;
        this.service = this.client.getServiceClient().getRetrofit().create(DatetimeOperationsService.class);
    }
    ...
    private interface DatetimeOperationsService {
        ...
        Call<ResponseBody> putUtcMaxDateTime7Digits(@Body RequestBody datetimeBody);
        ...
        Call<ResponseBody> getUtcUppercaseMaxDateTime7Digits();

        @PUT("/datetime/max/localpositiveoffset")
        Call<ResponseBody> putLocalPositiveOffsetMaxDateTime(@Body RequestBody datetimeBody);
        ...
        Call<ResponseBody> putLocalNegativeOffsetMaxDateTime(@Body RequestBody datetimeBody);
        ...
        Call<ResponseBody> putLocalPositiveOffsetMinDateTime(@Body RequestBody datetimeBody);
        ...
        Call<ResponseBody> putLocalNegativeOffsetMinDateTime(@Body RequestBody datetimeBody);

        @GET("/datetime/min/localnegativeoffset")
        Call<ResponseBody> getLocalNegativeOffsetMinDateTime();

        @GET("/datetime/min/localnooffset")
        Call<ResponseBody> getLocalNoOffsetMinDateTime();
    }
    ...
    public void putUtcMaxDateTime7Digits(OffsetDateTime datetimeBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putUtcMaxDateTime7Digits(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public void putLocalPositiveOffsetMaxDateTime(OffsetDateTime datetimeBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putLocalPositiveOffsetMaxDateTime(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public void putLocalNegativeOffsetMaxDateTime(OffsetDateTime datetimeBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putLocalNegativeOffsetMaxDateTime(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public void putLocalPositiveOffsetMinDateTime(OffsetDateTime datetimeBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putLocalPositiveOffsetMinDateTime(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
    ...
    public void putLocalNegativeOffsetMinDateTime(OffsetDateTime datetimeBody, final Callback<Void> callback) {
        ...
        Call<ResponseBody> call = service.putLocalNegativeOffsetMinDateTime(okHttp3RequestBody);
        retrofit2.Callback<ResponseBody> retrofitCallback = new retrofit2.Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<okhttp3.ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
