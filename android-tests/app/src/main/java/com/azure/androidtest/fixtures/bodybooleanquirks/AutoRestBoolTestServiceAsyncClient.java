...
public final class AutoRestBoolTestServiceAsyncClient {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    public void putTrue(boolean boolBody, final Callback<Void> callback) {
        this.serviceClient.putTrue(boolBody, callback);
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    public void putFalse(boolean boolBody, final Callback<Void> callback) {
        this.serviceClient.putFalse(boolBody, callback);
    }
