 ...
 */
public final class AutoRestDateTestServiceImpl {
    /**
     * The serializer.
     */
    ...
    /**
     * The DateOperationsImpl object to access its operations.
     */
    private final DateOperationsImpl dateOperations;

    /**
     * Gets the DateOperationsImpl object to access its operations.
     * 
     * @return the DateOperationsImpl object.
     */
    public DateOperationsImpl getDateOperations() {
     ...
     */
    public AutoRestDateTestServiceImpl(ServiceClient serviceClient, String host) {
        this.serviceClient = serviceClient;
        this.host = host;
        this.dateOperations = new DateOperationsImpl(this);
    }
