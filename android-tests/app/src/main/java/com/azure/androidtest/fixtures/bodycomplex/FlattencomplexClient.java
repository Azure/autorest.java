...
public final class FlattencomplexClient {
     ...
     */
    FlattencomplexClient(FlattencomplexsImpl serviceClient) {
    ...
    public static final class Builder {
        ...
        /**
         * Builds an instance of FlattencomplexClient with the provided parameters.
         * 
         * @return an instance of FlattencomplexClient.
         */
        public FlattencomplexClient build() {
            if (host == null) {
            ...
            return new FlattencomplexClient(internalClient.getFlattencomplexs());
        }
    }
}
