...
import azure.signalr.models.PrivateLinkResourceList;
...
public final class SignalRPrivateLinkResourcesClientImpl implements SignalRPrivateLinkResourcesClient {
     ...
     * @return the private link resources that need to be created for a SignalR resource along with {@link
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the private link resources that need to be created for a SignalR resource as paginated response with
     *     {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return contains a list of AzSignalR.Models.Response.PrivateLink.PrivateLinkResource and a possible link to query
     *     more results along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
