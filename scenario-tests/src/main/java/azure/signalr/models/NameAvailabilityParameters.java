...
public final class NameAvailabilityParameters {
    ...
    /**
     * Get the name property: The SignalR service name to validate. e.g."my-signalR-name-here".
     *
    ...
    /**
     * Set the name property: The SignalR service name to validate. e.g."my-signalR-name-here".
     *
