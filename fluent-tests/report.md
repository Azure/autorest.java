# Java Codegen Report
Generated at 2020-12-04T19:19:43.852785
## Success
<details>
...
INFORMATION (FluentMapper): Add Inner to response types: [ProviderOperationsMetadata, RoleDefinition, ClassicAdministrator, Permission, RoleAssignment, DenyAssignment, Error]
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [RolloutRequest, Rollout, ServiceResource, ServiceUnitResource, ServiceTopologyResource, StepResource, ArtifactSource, OperationsList]
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@63ec60b3 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@db0b9ab)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@63ec60b3 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@db0b9ab)
...
FATAL (FluentGen): Unhandled error: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@63ec60b3 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@db0b9ab)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@63ec60b3 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@db0b9ab)
	at java.base/java.util.stream.Collectors.duplicateKeyException(Collectors.java:133)
	at java.base/java.util.stream.Collectors.lambda$uniqKeysMapAccumulator$1(Collectors.java:180)
	at java.base/java.util.stream.ReduceOps$3ReducingSink.accept(ReduceOps.java:169)
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Automation, SecureScoreControlDefinitionItem, AutomationValidationStatus, ScanResults, RuleResults, SecuritySubAssessment, IoTSecuritySolutionAnalyticsModelList, Device, IotAlertTypeList, IotSitesModel, JitNetworkAccessRequest, Scans, IotRecommendationType, ComplianceResult, WorkspaceSetting, ConnectorSetting, SecureScoreControlDetails, SecuritySolutionsReferenceDataList, PackageDownloads, IoTSecurityAggregatedRecommendation, TopologyResource, Alert, AdaptiveApplicationControlGroup, JitNetworkAccessPolicy, IoTSecurityAggregatedAlert, IotRecommendationModel, IotSensorsModel, ServerVulnerabilityAssessment, IotAlertType, AdaptiveNetworkHardening, RulesResults, ServerVulnerabilityAssessmentsList, OnPremiseIotSensorsList, IoTSecuritySolutionModel, AdaptiveApplicationControlGroups, RegulatoryComplianceControl, IoTSecuritySolutionAnalyticsModel, IotSensorsList, SecureScoreItem, OnPremiseIotSensor, Scan, ScanResult, IotAlertModel, IotSitesList, AllowedConnectionsResource, SecuritySolution, AlertsSuppressionRule, Pricing, SettingResource, SecurityContact, AdvancedThreatProtectionSetting, DeviceSecurityGroup, IotDefenderSettingsModel, IotRecommendation, AscLocation, PricingList, RegulatoryComplianceAssessment, DiscoveredSecuritySolution, AutoProvisioningSetting, IotRecommendationTypeList, SecurityAssessment, SecurityTask, RegulatoryComplianceStandard, ExternalSecuritySolution, SecurityAssessmentMetadata, IotAlert, InformationProtectionPolicy, Operation, Compliance, IotDefenderSettingsList]
...
FATAL: [object Object]
(node:22778) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:22778) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:22778) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2020-12-04T19:04:50Z
[INFO] ------------------------------------------------------------------------
