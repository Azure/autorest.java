# Java Codegen Report
Generated at 2021-03-16T19:17:10.412381
## Success
<details>
...
[INFO] Finished at: 2021-03-16T18:13:03Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentMapper): Add Inner to response types: [ServiceTopologyResource, Rollout, ServiceUnitResource, StepResource, OperationsList, RolloutRequest, ArtifactSource, ServiceResource]
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@738462b6 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@58079326)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@738462b6 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@58079326)
...
FATAL (FluentGen): Unhandled error: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@738462b6 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@58079326)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@738462b6 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@58079326)
	at java.base/java.util.stream.Collectors.duplicateKeyException(Collectors.java:133)
	at java.base/java.util.stream.Collectors.lambda$uniqKeysMapAccumulator$1(Collectors.java:180)
	at java.base/java.util.stream.ReduceOps$3ReducingSink.accept(ReduceOps.java:169)
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Application, WipeDeviceOperationResult, OperationResult, Location, FlaggedEnrolledApp, AndroidMamPolicy, FlaggedUser, Device, IOsmamPolicy, GroupItem]
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [IotRecommendation, SecurityContact, AdvancedThreatProtectionSetting, IotSitesList, ComplianceResult, IotSensorsList, SecurityTask, RegulatoryComplianceControl, SecuritySubAssessment, Pricing, OnPremiseIotSensor, IotRecommendationTypeList, Compliance, AutoProvisioningSetting, Alert, AdaptiveApplicationControlGroups, AllowedConnectionsResource, AscLocation, RegulatoryComplianceAssessment, Automation, PackageDownloads, RegulatoryComplianceStandard, IoTSecuritySolutionAnalyticsModel, AdaptiveApplicationControlGroup, ConnectorSetting, Scans, IotSitesModel, RulesResults, IotAlertType, DiscoveredSecuritySolution, TopologyResource, ScanResults, SecurityAssessmentMetadata, WorkspaceSetting, OnPremiseIotSensorsList, RuleResults, IotDefenderSettingsModel, InformationProtectionPolicy, PricingList, DeviceSecurityGroup, IoTSecurityAggregatedAlert, JitNetworkAccessRequest, ServerVulnerabilityAssessment, SecureScoreControlDetails, IotAlertModel, IotSensorsModel, IotDefenderSettingsList, AdaptiveNetworkHardening, Device, IotRecommendationType, ServerVulnerabilityAssessmentsList, SecureScoreControlDefinitionItem, ScanResult, IotAlertTypeList, IoTSecuritySolutionModel, IoTSecurityAggregatedRecommendation, AlertsSuppressionRule, SecuritySolution, SecuritySolutionsReferenceDataList, IotAlert, SecurityAssessment, SecureScoreItem, IoTSecuritySolutionAnalyticsModelList, JitNetworkAccessPolicy, Operation, ExternalSecuritySolution, AutomationValidationStatus, Setting, IotRecommendationModel, Scan]
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [MachinesSummary, ClientGroupMember, MachineGroup, ClientGroupMembersCount, Process, Port, ClientGroup, MapResponse, Connection, Machine, Liveness]
INFORMATION (FluentGen): Java template for client model
INFORMATION (FluentGen): Process for Fluent Lite, SDK integration disabled
...
FATAL: [object Object]
(node:24969) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:24969) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:24969) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-03-16T19:01:45Z
[INFO] ------------------------------------------------------------------------
