# Java Codegen Report
Generated at 2020-12-05T19:17:14.614287
## Success
<details>
...
INFORMATION (FluentMapper): Add Inner to response types: [RoleDefinition, Error, RoleAssignment, ClassicAdministrator, DenyAssignment, ProviderOperationsMetadata, Permission]
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@1861a9c7 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@5f216d4a)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@1861a9c7 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@5f216d4a)
...
FATAL (FluentGen): Unhandled error: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@1861a9c7 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@5f216d4a)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@1861a9c7 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@5f216d4a)
	at java.base/java.util.stream.Collectors.duplicateKeyException(Collectors.java:133)
	at java.base/java.util.stream.Collectors.lambda$uniqKeysMapAccumulator$1(Collectors.java:180)
	at java.base/java.util.stream.ReduceOps$3ReducingSink.accept(ReduceOps.java:169)
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Scans, AlertsSuppressionRule, IotSensorsList, ScanResult, IoTSecuritySolutionAnalyticsModel, RegulatoryComplianceControl, IotSitesList, ComplianceResult, IotRecommendationType, Automation, AutomationValidationStatus, PackageDownloads, IotAlert, SecureScoreControlDetails, IoTSecurityAggregatedAlert, AutoProvisioningSetting, IotRecommendation, IoTSecuritySolutionAnalyticsModelList, IotDefenderSettingsModel, JitNetworkAccessRequest, AdaptiveApplicationControlGroups, SecurityTask, IotSensorsModel, ServerVulnerabilityAssessment, SecuritySolutionsReferenceDataList, IotAlertTypeList, AdaptiveNetworkHardening, RegulatoryComplianceStandard, SecurityContact, IotRecommendationModel, AdvancedThreatProtectionSetting, IotRecommendationTypeList, Operation, WorkspaceSetting, IotDefenderSettingsList, Scan, PricingList, IoTSecuritySolutionModel, TopologyResource, AscLocation, ExternalSecuritySolution, SettingResource, SecurityAssessmentMetadata, AdaptiveApplicationControlGroup, RulesResults, RuleResults, SecuritySolution, RegulatoryComplianceAssessment, AllowedConnectionsResource, IotSitesModel, Alert, SecureScoreItem, DiscoveredSecuritySolution, ConnectorSetting, Device, ServerVulnerabilityAssessmentsList, ScanResults, IoTSecurityAggregatedRecommendation, IotAlertModel, Pricing, SecuritySubAssessment, IotAlertType, OnPremiseIotSensorsList, InformationProtectionPolicy, SecureScoreControlDefinitionItem, Compliance, JitNetworkAccessPolicy, DeviceSecurityGroup, OnPremiseIotSensor, SecurityAssessment]
...
FATAL: [object Object]
(node:22753) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:22753) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:22753) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2020-12-05T19:03:24Z
[INFO] ------------------------------------------------------------------------
