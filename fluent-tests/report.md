# Java Codegen Report
Generated at 2021-03-22T19:29:04.209171
## Success
<details>
...
[INFO] Finished at: 2021-03-22T18:16:27Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentMapper): Add Inner to response types: [RolloutRequest, ServiceResource, ServiceUnitResource, ArtifactSource, Rollout, StepResource, ServiceTopologyResource, OperationsList]
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@1c7bfeec and com.azure.autorest.model.clientmodel.ProxyMethodParameter@5650ef79)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@1c7bfeec and com.azure.autorest.model.clientmodel.ProxyMethodParameter@5650ef79)
...
FATAL (FluentGen): Unhandled error: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@1c7bfeec and com.azure.autorest.model.clientmodel.ProxyMethodParameter@5650ef79)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@1c7bfeec and com.azure.autorest.model.clientmodel.ProxyMethodParameter@5650ef79)
	at java.base/java.util.stream.Collectors.duplicateKeyException(Collectors.java:133)
	at java.base/java.util.stream.Collectors.lambda$uniqKeysMapAccumulator$1(Collectors.java:180)
	at java.base/java.util.stream.ReduceOps$3ReducingSink.accept(ReduceOps.java:169)
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [PricingList, Pricing, RuleResults, Automation, IotSensorsModel, IotAlertModel, AllowedConnectionsResource, SecuritySubAssessment, AutomationValidationStatus, OnPremiseIotSensor, AdaptiveNetworkHardening, IotSitesModel, ServerVulnerabilityAssessment, AdaptiveApplicationControlGroup, SecurityContact, SecurityAssessmentMetadata, Alert, InformationProtectionPolicy, AscLocation, IotAlertType, AdvancedThreatProtectionSetting, ServerVulnerabilityAssessmentsList, AlertsSuppressionRule, ScanResults, Scan, ComplianceResult, Compliance, SecurityAssessment, IoTSecurityAggregatedRecommendation, IotSensorsList, ScanResult, JitNetworkAccessRequest, RulesResults, AdaptiveApplicationControlGroups, SecuritySolution, IotAlert, RegulatoryComplianceAssessment, IotRecommendationType, TopologyResource, PackageDownloads, IoTSecuritySolutionModel, ConnectorSetting, SecureScoreControlDetails, DeviceSecurityGroup, IotRecommendationTypeList, IoTSecuritySolutionAnalyticsModel, SecurityTask, Scans, OnPremiseIotSensorsList, IotRecommendationModel, IotDefenderSettingsList, IotSitesList, Setting, JitNetworkAccessPolicy, SecureScoreItem, WorkspaceSetting, SecuritySolutionsReferenceDataList, IoTSecuritySolutionAnalyticsModelList, SecureScoreControlDefinitionItem, IoTSecurityAggregatedAlert, Device, IotRecommendation, AutoProvisioningSetting, ExternalSecuritySolution, RegulatoryComplianceControl, IotDefenderSettingsModel, DiscoveredSecuritySolution, IotAlertTypeList, Operation, RegulatoryComplianceStandard]
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [MachinesSummary, Port, ClientGroupMembersCount, ClientGroupMember, Process, ClientGroup, Machine, Liveness, Connection, MachineGroup, MapResponse]
INFORMATION (FluentGen): Java template for client model
INFORMATION (FluentGen): Process for Fluent Lite, SDK integration disabled
...
FATAL: [object Object]
(node:24402) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:24402) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:24402) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-03-22T19:12:11Z
[INFO] ------------------------------------------------------------------------
