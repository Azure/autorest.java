# Java Codegen Report
Generated at 2021-08-03T10:28:50.738076
## Success
<details>
...
INFORMATION (FluentMapper): Add Inner to response types: [SourceControlSyncJobStreamById, JobCollectionItem, Usage, Credential, PrivateLinkResource, Activity, SoftwareUpdateConfigurationMachineRunListResult, DscCompilationJob, SourceControlSyncJob, SoftwareUpdateConfigurationRunListResult, ConnectionType, RunbookDraftUndoEditResult, TypeField, RunbookDraft, Connection, Runbook, Job, SourceControl, Statistics, HybridRunbookWorkerGroup, DscNodeConfiguration, SoftwareUpdateConfigurationRun, KeyListResult, Webhook, Schedule, Watcher, AgentRegistration, JobStreamListResult, SourceControlSyncJobStream, PrivateEndpointConnection, JobSchedule, JobStream, DscConfiguration, SourceControlSyncJobById, Module, NodeCounts, AutomationAccount, TestJob, SoftwareUpdateConfigurationListResult, SoftwareUpdateConfiguration, Certificate, DscNode, SoftwareUpdateConfigurationMachineRun, DscNodeReport, LinkedWorkspace, Operation, Variable]
...
java.lang.IllegalStateException: model type not found for type String and value {name=SetupServer, location=East US 2, properties={description=sample configuration, source={type=embeddedContent, hash={algorithm=sha256, value=A9E5DB56BA21513F61E0B3868816FDC6D4DF5131F5617D7FF0D769674BD5072F}, value=Configuration SetupServer {
	...
	at com.azure.autorest.fluent.mapper.ExampleParser.parseNode(ExampleParser.java:467)
	at com.azure.autorest.fluent.mapper.ExampleParser.parseNodeFromParameter(ExampleParser.java:373)
	at com.azure.autorest.fluent.mapper.ExampleParser.parseMethodForExample(ExampleParser.java:150)
	at com.azure.autorest.fluent.mapper.ExampleParser.parseMethod(ExampleParser.java:136)
	at com.azure.autorest.fluent.mapper.ExampleParser.lambda$parseResourceCollection$0(ExampleParser.java:76)
	at java.base/java.util.ArrayList.forEach(ArrayList.java:1541)
	at com.azure.autorest.fluent.mapper.ExampleParser.parseResourceCollection(ExampleParser.java:75)
...
WARNING (PreCheck/SchemaMissingType): The schema 'ServiceAccessPolicyEntry' with an undefined type and declared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'ServicesResource' with an undefined type and declared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'PrivateEndpointConnectionDescription' with an undefined type and declared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'PrivateLinkResourceDescription' with an undefined type and declared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'PrivateEndpointConnectionListResultDescription' with an undefined type and declared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'PrivateLinkResourceListResultDescription' with an undefined type and declared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/CheckDuplicateSchemas): Checking for duplicate schemas, this could take a (long) while.  Run with --verbose for more detail.

WARNING (PreNamer/DeduplicateName): Deduplicating schema name: 'ServiceManagedIdentity' -> 'ServiceManagedIdentityAutoGenerated'
INFORMATION (FluentNamer): Load fluent settings
INFORMATION (FluentJavaSettings): Option, string, add-inner : null
INFORMATION (FluentJavaSettings): Option, string, remove-inner : null
INFORMATION (FluentJavaSettings): Option, string, rename-model : null
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentNamer): Transform code model
INFORMATION (OperationNameNormalization): Rename operation from 'get' to 'getByResourceGroup', in operation group 'Services'
INFORMATION (OperationNameNormalization): Rename operation from 'listBySubscription' to 'list', in operation group 'Workspaces'
INFORMATION (OperationNameNormalization): Rename operation from 'get' to 'getByResourceGroup', in operation group 'Workspaces'
INFORMATION (ResourceTypeNormalization): Change parent from 'Resource' to 'ProxyResource', for 'PrivateEndpointConnection'
INFORMATION (ResourceTypeNormalization): Add parent Resource, for 'ServicesResource'
INFORMATION (ResourceTypeNormalization): Change parent from 'Resource' to 'ProxyResource', for 'PrivateLinkResource'
INFORMATION (ResourceTypeNormalization): Add parent ProxyResource, for 'ResourceCore'
INFORMATION (ErrorTypeNormalization): Rename error from 'ErrorDetails' to 'ManagementError'
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [OperationResultsDescription, OperationDetail, PrivateLinkResourceDescription, ServicesDescription, DicomService, PrivateLinkResourceListResultDescription, IotConnector, FhirService, IotFhirDestination, ServicesNameAvailabilityInfo, Workspace, PrivateEndpointConnectionDescription]
...
java.lang.NullPointerException
	at com.azure.autorest.mapper.ModelMapper.map(ModelMapper.java:109)
...
[INFO] Finished at: 2021-08-03T09:49:25Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Liveness, ClientGroupMembersCount, MachineGroup, Process, Port, MapResponse, Machine, ClientGroup, ClientGroupMember, Connection, MachinesSummary]
INFORMATION (FluentGen): Java template for client model
INFORMATION (FluentGen): Process for Fluent Lite, SDK integration disabled
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.NullPointerException
java.lang.NullPointerException
	at com.azure.autorest.fluent.mapper.ExampleParser.parseNodeFromParameter(ExampleParser.java:359)
	at com.azure.autorest.fluent.mapper.ExampleParser.parseResourceCreate(ExampleParser.java:200)
	at com.azure.autorest.fluent.mapper.ExampleParser.lambda$parseResourceCollection$1(ExampleParser.java:82)
	at java.base/java.util.ArrayList.forEach(ArrayList.java:1541)
	at com.azure.autorest.fluent.mapper.ExampleParser.parseResourceCollection(ExampleParser.java:81)
	at com.azure.autorest.fluent.mapper.FluentMapper.lambda$map$1(FluentMapper.java:65)
	at java.base/java.util.stream.ReferencePipeline$7$1.accept(ReferencePipeline.java:271)
	at java.base/java.util.ArrayList$ArrayListSpliterator.forEachRemaining(ArrayList.java:1655)
	at java.base/java.util.stream.AbstractPipeline.copyInto(AbstractPipeline.java:484)
...
[INFO] Finished at: 2021-08-03T10:22:01Z
[INFO] ------------------------------------------------------------------------
...
[INFO] Finished at: 2021-08-03T10:24:58Z
[INFO] ------------------------------------------------------------------------
