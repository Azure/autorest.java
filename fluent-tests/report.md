# Java Codegen Report
Generated at 2020-12-16T03:45:40.946787
## Success
<details>
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Rollout, ServiceResource, OperationsList, RolloutRequest, ArtifactSource, ServiceTopologyResource, StepResource, ServiceUnitResource]
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@693aff29 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@6eacdd57)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@693aff29 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@6eacdd57)
...
FATAL (FluentGen): Unhandled error: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@693aff29 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@6eacdd57)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@693aff29 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@6eacdd57)
	at java.base/java.util.stream.Collectors.duplicateKeyException(Collectors.java:133)
	at java.base/java.util.stream.Collectors.lambda$uniqKeysMapAccumulator$1(Collectors.java:180)
	at java.base/java.util.stream.ReduceOps$3ReducingSink.accept(ReduceOps.java:169)
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Fabric, ReplicationEligibilityResults, Network, MigrationItem, NetworkMapping, RecoveryPlan, RecoveryPoint, VCenter, Alert, Event, LogicalNetwork, Job, ReplicationEligibilityResultsCollection, TargetComputeSize, Policy, OperationsDiscovery, ProtectionContainer, VaultSetting, ReplicationProtectionIntent, MigrationRecoveryPoint, StorageClassification, VaultHealthDetails, ProtectionContainerMapping, ProtectableItem, SupportedOperatingSystems, ReplicationProtectedItem, StorageClassificationMapping, RecoveryServicesProvider]
INFORMATION (FluentGen): Java template for client model
INFORMATION (FluentGen): Process for Fluent Lite, SDK integration disabled
...
FATAL: [object Object]
(node:22725) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:22725) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:22725) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2020-12-16T03:33:45Z
[INFO] ------------------------------------------------------------------------
