# Java Codegen Report
Generated at 2021-01-09T19:34:10.668261
## Success
<details>
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [WorkspaceSetting, IotAlert, AscLocation, SecureScoreItem, AutoProvisioningSetting, ScanResult, SecurityContact, AdaptiveApplicationControlGroup, PricingList, IoTSecurityAggregatedRecommendation, AdaptiveApplicationControlGroups, IotAlertTypeList, ConnectorSetting, IoTSecuritySolutionAnalyticsModelList, IoTSecurityAggregatedAlert, SecurityAssessment, RegulatoryComplianceControl, DeviceSecurityGroup, Scans, Pricing, SecuritySolutionsReferenceDataList, ServerVulnerabilityAssessmentsList, JitNetworkAccessPolicy, RegulatoryComplianceAssessment, AdvancedThreatProtectionSetting, AdaptiveNetworkHardening, DiscoveredSecuritySolution, RuleResults, Alert, RegulatoryComplianceStandard, PackageDownloads, SecurityAssessmentMetadata, InformationProtectionPolicy, OnPremiseIotSensor, SecuritySubAssessment, IotDefenderSettingsList, IotSensorsModel, OnPremiseIotSensorsList, AutomationValidationStatus, ComplianceResult, SecuritySolution, IotRecommendationType, AlertsSuppressionRule, Scan, RulesResults, IotSensorsList, IoTSecuritySolutionModel, SecurityTask, IotRecommendation, Device, AllowedConnectionsResource, TopologyResource, IotSitesList, IotRecommendationTypeList, JitNetworkAccessRequest, IoTSecuritySolutionAnalyticsModel, IotRecommendationModel, Operation, IotAlertModel, Setting, ServerVulnerabilityAssessment, IotSitesModel, Automation, SecureScoreControlDefinitionItem, IotAlertType, ScanResults, IotDefenderSettingsModel, SecureScoreControlDetails, ExternalSecuritySolution, Compliance]
...
FATAL: [object Object]
(node:23693) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:23693) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:23693) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-01-09T19:21:37Z
[INFO] ------------------------------------------------------------------------
