# Java Codegen Report
Generated at 2021-01-05T19:45:21.778769
## Success
<details>
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Scan, IotSensorsList, DiscoveredSecuritySolution, IoTSecuritySolutionAnalyticsModel, Device, AscLocation, IoTSecurityAggregatedAlert, IotRecommendationType, WorkspaceSetting, AdaptiveApplicationControlGroups, IotRecommendationTypeList, SecurityAssessment, SecuritySolution, Pricing, IotAlertTypeList, AutoProvisioningSetting, ServerVulnerabilityAssessment, OnPremiseIotSensorsList, AdaptiveApplicationControlGroup, SecureScoreControlDefinitionItem, IotDefenderSettingsList, ExternalSecuritySolution, IotSitesModel, AdaptiveNetworkHardening, Scans, IoTSecurityAggregatedRecommendation, PricingList, IotAlertType, IotAlertModel, IotAlert, SecuritySolutionsReferenceDataList, IotDefenderSettingsModel, SecuritySubAssessment, SecurityContact, Setting, IotRecommendationModel, SecureScoreItem, ServerVulnerabilityAssessmentsList, InformationProtectionPolicy, IotSensorsModel, RegulatoryComplianceStandard, RuleResults, TopologyResource, ComplianceResult, RegulatoryComplianceControl, ScanResults, PackageDownloads, Operation, IotRecommendation, IoTSecuritySolutionAnalyticsModelList, ScanResult, AllowedConnectionsResource, JitNetworkAccessRequest, DeviceSecurityGroup, IoTSecuritySolutionModel, SecureScoreControlDetails, Alert, Compliance, JitNetworkAccessPolicy, AlertsSuppressionRule, SecurityTask, AutomationValidationStatus, RulesResults, RegulatoryComplianceAssessment, IotSitesList, OnPremiseIotSensor, AdvancedThreatProtectionSetting, Automation, SecurityAssessmentMetadata, ConnectorSetting]
...
FATAL: [object Object]
(node:23576) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:23576) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-01-05T19:31:42Z
[INFO] ------------------------------------------------------------------------
