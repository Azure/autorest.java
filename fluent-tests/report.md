# Java Codegen Report
Generated at 2021-01-04T19:41:48.472841
## Success
<details>
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [IotAlertType, JitNetworkAccessPolicy, IotSensorsModel, JitNetworkAccessRequest, AdaptiveNetworkHardening, IotSitesList, RuleResults, RulesResults, Operation, AlertsSuppressionRule, SecureScoreControlDefinitionItem, Scans, ConnectorSetting, IotDefenderSettingsList, Pricing, IotRecommendationModel, IotSitesModel, OnPremiseIotSensor, SecuritySolutionsReferenceDataList, IotRecommendationType, IoTSecuritySolutionAnalyticsModel, RegulatoryComplianceAssessment, PackageDownloads, SecurityTask, AutoProvisioningSetting, ScanResult, IotDefenderSettingsModel, Setting, IotAlert, AdvancedThreatProtectionSetting, IoTSecurityAggregatedRecommendation, IotAlertTypeList, Compliance, Automation, SecurityAssessmentMetadata, IotRecommendationTypeList, Device, AscLocation, IoTSecurityAggregatedAlert, SecureScoreItem, IoTSecuritySolutionAnalyticsModelList, SecurityContact, AutomationValidationStatus, ComplianceResult, Alert, IoTSecuritySolutionModel, PricingList, OnPremiseIotSensorsList, InformationProtectionPolicy, TopologyResource, ExternalSecuritySolution, SecuritySolution, IotAlertModel, SecuritySubAssessment, ScanResults, IotRecommendation, WorkspaceSetting, Scan, DeviceSecurityGroup, RegulatoryComplianceControl, DiscoveredSecuritySolution, SecurityAssessment, AdaptiveApplicationControlGroups, SecureScoreControlDetails, RegulatoryComplianceStandard, ServerVulnerabilityAssessment, ServerVulnerabilityAssessmentsList, AllowedConnectionsResource, IotSensorsList, AdaptiveApplicationControlGroup]
...
FATAL: [object Object]
(node:23298) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:23298) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:23298) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-01-04T19:28:55Z
[INFO] ------------------------------------------------------------------------
