# Java Codegen Report
Generated at 2021-03-17T19:17:55.192452
## Success
<details>
...
[INFO] Finished at: 2021-03-17T18:12:10Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentMapper): Add Inner to response types: [StepResource, Rollout, OperationsList, ArtifactSource, ServiceTopologyResource, ServiceUnitResource, ServiceResource, RolloutRequest]
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@3719bd64 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@7ec319f0)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@3719bd64 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@7ec319f0)
...
FATAL (FluentGen): Unhandled error: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@3719bd64 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@7ec319f0)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@3719bd64 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@7ec319f0)
	at java.base/java.util.stream.Collectors.duplicateKeyException(Collectors.java:133)
	at java.base/java.util.stream.Collectors.lambda$uniqKeysMapAccumulator$1(Collectors.java:180)
	at java.base/java.util.stream.ReduceOps$3ReducingSink.accept(ReduceOps.java:169)
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [IoTSecurityAggregatedRecommendation, ConnectorSetting, Setting, ComplianceResult, DeviceSecurityGroup, AdaptiveApplicationControlGroup, AdaptiveNetworkHardening, ServerVulnerabilityAssessment, SecuritySolutionsReferenceDataList, AscLocation, ScanResult, IotSensorsModel, Device, IotDefenderSettingsModel, SecuritySubAssessment, Alert, IotAlertModel, IotRecommendationType, Scan, ScanResults, IotSitesList, SecurityTask, RegulatoryComplianceStandard, JitNetworkAccessRequest, IoTSecuritySolutionAnalyticsModelList, IoTSecuritySolutionAnalyticsModel, AutoProvisioningSetting, Scans, OnPremiseIotSensorsList, IotRecommendationModel, AdvancedThreatProtectionSetting, Automation, IotAlertType, AlertsSuppressionRule, PackageDownloads, DiscoveredSecuritySolution, IotSensorsList, AdaptiveApplicationControlGroups, AutomationValidationStatus, AllowedConnectionsResource, OnPremiseIotSensor, ServerVulnerabilityAssessmentsList, SecurityAssessment, IotRecommendationTypeList, IotAlert, TopologyResource, SecureScoreControlDefinitionItem, ExternalSecuritySolution, Operation, IoTSecuritySolutionModel, SecureScoreItem, RulesResults, Pricing, IotDefenderSettingsList, IotRecommendation, RegulatoryComplianceControl, IotAlertTypeList, RuleResults, SecurityContact, PricingList, RegulatoryComplianceAssessment, SecurityAssessmentMetadata, IotSitesModel, InformationProtectionPolicy, Compliance, SecuritySolution, SecureScoreControlDetails, IoTSecurityAggregatedAlert, WorkspaceSetting, JitNetworkAccessPolicy]
...
FATAL: [object Object]
(node:24474) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:24474) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:24474) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-03-17T19:03:05Z
[INFO] ------------------------------------------------------------------------
