# Java Codegen Report
Generated at 2020-12-23T19:29:49.374949
## Success
<details>
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [IotSensorsList, SecuritySolution, Alert, Scans, IoTSecuritySolutionAnalyticsModel, TopologyResource, ServerVulnerabilityAssessmentsList, SecurityContact, IotRecommendationType, ScanResults, IotSitesModel, DeviceSecurityGroup, DiscoveredSecuritySolution, IoTSecurityAggregatedAlert, IotAlertTypeList, RegulatoryComplianceControl, Operation, IoTSecuritySolutionModel, AdaptiveNetworkHardening, ConnectorSetting, ExternalSecuritySolution, PricingList, Pricing, AscLocation, IotSensorsModel, SecuritySubAssessment, IotRecommendationModel, AdvancedThreatProtectionSetting, IotAlert, Automation, IotRecommendationTypeList, Device, RegulatoryComplianceAssessment, OnPremiseIotSensorsList, AdaptiveApplicationControlGroup, JitNetworkAccessPolicy, RulesResults, IotAlertModel, SecurityTask, ServerVulnerabilityAssessment, AllowedConnectionsResource, RuleResults, IotDefenderSettingsList, AdaptiveApplicationControlGroups, PackageDownloads, IotAlertType, AlertsSuppressionRule, IoTSecurityAggregatedRecommendation, JitNetworkAccessRequest, Scan, SecurityAssessment, AutomationValidationStatus, SecuritySolutionsReferenceDataList, Compliance, WorkspaceSetting, AutoProvisioningSetting, IotDefenderSettingsModel, InformationProtectionPolicy, IoTSecuritySolutionAnalyticsModelList, SecureScoreItem, ScanResult, SecureScoreControlDefinitionItem, IotRecommendation, OnPremiseIotSensor, SecureScoreControlDetails, Setting, IotSitesList, RegulatoryComplianceStandard, ComplianceResult, SecurityAssessmentMetadata]
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Machine, MapResponse, ClientGroupMember, MachinesSummary, Port, Connection, MachineGroup, Liveness, ClientGroup, Process, ClientGroupMembersCount]
INFORMATION (FluentGen): Java template for client model
...
FATAL: [object Object]
(node:23795) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:23795) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:23795) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2020-12-23T19:15:01Z
[INFO] ------------------------------------------------------------------------
