# Java Codegen Report
Generated at 2020-12-15T07:12:32.547197
## Success
<details>
<summary>RP count: 149</summary>
...
WARNING (PreCheck/SchemaMissingType): The schema 'ClassicAdministratorProperties' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'ClassicAdministrator' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'ClassicAdministratorListResult' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'
...
WARNING (PreCheck/SchemaMissingType): The schema 'ResourceType' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'ProviderOperation' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'ProviderOperationsMetadata' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'ProviderOperationsMetadataListResult' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'Error' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleDefinitionFilter' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleDefinitionProperties' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleDefinition' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleDefinitionListResult' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'PermissionGetResult' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'Permission' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'Error' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'DenyAssignmentFilter' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'DenyAssignmentProperties' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'DenyAssignment' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'DenyAssignmentListResult' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'DenyAssignmentPermission' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'Principal' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleAssignmentFilter' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleAssignmentPropertiesWithScope' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleAssignment' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleAssignmentListResult' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleAssignmentProperties' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'RoleAssignmentCreateParameters' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'Error' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/CheckDuplicateSchemas): Checking for duplicate schemas, this could take a (long) while.  Run with --verbose for more detail.

WARNING (PreCheck/DuplicateSchema): Duplicate Schema named Error -- properties.error.description: undefined => "Object to be thrown in case of an unsuccessful response" 

WARNING (PreNamer/DeduplicateName): Deduplicating schema name: 'Error' -> 'ErrorAutoGenerated'

WARNING (PreNamer/DeduplicateName): Deduplicating schema name: 'Error' -> 'ErrorAutoGenerated2'

WARNING (PreNamer/DeduplicateName): Deduplicating schema name: 'Error' -> 'ErrorAutoGenerated3'
...
INFORMATION (FluentJavaSettings): Option, string, tag : package-2020-04-preview
INFORMATION (FluentJavaSettings): Option, string, base-folder : .
INFORMATION (FluentJavaSettings): Option, string, output-folder : $(azure-libraries-for-java-folder)/azure-mgmt-authorization
...
INFORMATION (OperationNameNormalization): Rename operation from 'listForResourceGroup' to 'listByResourceGroup', in operation group 'Permissions'
INFORMATION (OperationNameNormalization): Rename operation from 'listForResourceGroup' to 'listByResourceGroup', in operation group 'DenyAssignments'
INFORMATION (OperationNameNormalization): Rename operation from 'listForResourceGroup' to 'listByResourceGroup', in operation group 'RoleAssignments'

WARNING (ResponseStatusCodeNormalization): Operation 'get' expect '404' status code, in group 'RoleAssignments'
INFORMATION (ResponseStatusCodeNormalization): Remove '404' status code in operation 'get', in group 'RoleAssignments'
INFORMATION (SchemaCleanup): Remove unused schema 'ErrorAutoGenerated2'
INFORMATION (SchemaCleanup): Remove unused schema 'RoleDefinitionFilter'
INFORMATION (SchemaCleanup): Remove unused schema 'ErrorAutoGenerated3'
INFORMATION (SchemaCleanup): Remove unused schema 'DenyAssignmentFilter'
INFORMATION (SchemaCleanup): Remove unused schema 'RoleAssignmentFilter'
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalArgumentException: [JavaCheck/SchemaError] no common parent found for client models [RoleAssignmentListResult, Error]
java.lang.IllegalArgumentException: [JavaCheck/SchemaError] no common parent found for client models [RoleAssignmentListResult, Error]
	at com.azure.autorest.mapper.ClientMethodMapper.map(ClientMethodMapper.java:79)
...
FATAL (FluentGen): Unhandled error: [JavaCheck/SchemaError] no common parent found for client models [RoleAssignmentListResult, Error]
java.lang.IllegalArgumentException: [JavaCheck/SchemaError] no common parent found for client models [RoleAssignmentListResult, Error]
	at com.azure.autorest.mapper.ClientMethodMapper.map(ClientMethodMapper.java:79)
	at com.azure.autorest.mapper.MethodGroupMapper.map(MethodGroupMapper.java:115)
	at com.azure.autorest.mapper.ServiceClientMapper.map(ServiceClientMapper.java:88)
...
WARNING (PreCheck/SchemaMissingType): The schema 'ADCCatalogsListResult' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'
...
WARNING (PreCheck/SchemaMissingType): The schema 'ADCCatalog' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'ADCCatalogProperties' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'

WARNING (PreCheck/SchemaMissingType): The schema 'Principals' with an undefined type and decalared properties is a bit ambigious. This has been auto-corrected to 'type:object'
...
INFORMATION (FluentJavaSettings): Option, string, package-version : null
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentJavaSettings): Option, string, tag : package-2016-03-30
INFORMATION (FluentJavaSettings): Option, string, base-folder : .
INFORMATION (FluentJavaSettings): Option, string, output-folder : $(azure-libraries-for-java-folder)/azure-mgmt-datacatalog
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentNamer): Transform code model
INFORMATION (OperationNameNormalization): Rename operation from 'get' to 'getByResourceGroup', in operation group 'AdcCatalogs'
INFORMATION (FluentGen): Read YAML
INFORMATION (FluentJavaSettings): Option, string, add-inner : null
INFORMATION (FluentJavaSettings): Option, string, remove-inner : null
INFORMATION (FluentJavaSettings): Option, string, rename-model : null
...
INFORMATION (FluentJavaSettings): Option, string, tag : package-2016-03-30
INFORMATION (FluentJavaSettings): Option, string, base-folder : .
INFORMATION (FluentJavaSettings): Option, string, output-folder : /home/runner/work/autorest.java/autorest.java/fluent_generated/azure-resourcemanager-datacatalog
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [AdcCatalog, AdcCatalogsListResult, OperationEntityListResult]
...
INFORMATION (ResourceCreate): ResourceCreate: Fluent model 'AdcCatalog', method reference 'createOrUpdate', body parameter 'AdcCatalogInner'
INFORMATION (ResourceParser): Fluent model 'AdcCatalog' as category RESOURCE_GROUP_AS_PARENT
INFORMATION (ResourceUpdate): ResourceUpdate: Fluent model 'AdcCatalog', method reference 'update', body parameter 'AdcCatalogInner'
INFORMATION (ResourceRefresh): ResourceRefresh: Fluent model 'AdcCatalog', method reference 'getByResourceGroup'
INFORMATION (ResourceDelete): ResourceDelete: Fluent model 'AdcCatalog', method reference 'delete'

```
**stderr**
```

ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: resource name parameter not found in client method createOrUpdate, name segment catalogName
java.lang.IllegalStateException: resource name parameter not found in client method createOrUpdate, name segment catalogName
	at com.azure.autorest.fluent.model.clientmodel.fluentmodel.create.ResourceCreate.getResourceNamePathParameter(ResourceCreate.java:317)
	at com.azure.autorest.fluent.model.clientmodel.fluentmodel.create.ResourceCreate.getExistingParentMethod(ResourceCreate.java:353)
	...
	at com.azure.autorest.fluent.FluentGen.handleFluentLite(FluentGen.java:255)
...
FATAL (FluentGen): Unhandled error: resource name parameter not found in client method createOrUpdate, name segment catalogName
java.lang.IllegalStateException: resource name parameter not found in client method createOrUpdate, name segment catalogName
	at com.azure.autorest.fluent.model.clientmodel.fluentmodel.create.ResourceCreate.getResourceNamePathParameter(ResourceCreate.java:317)
	at com.azure.autorest.fluent.model.clientmodel.fluentmodel.create.ResourceCreate.getExistingParentMethod(ResourceCreate.java:353)
	at com.azure.autorest.fluent.model.clientmodel.fluentmodel.create.ResourceCreate.getDefinitionStages(ResourceCreate.java:156)
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@4d53d3cf and com.azure.autorest.model.clientmodel.ProxyMethodParameter@58696433)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@4d53d3cf and com.azure.autorest.model.clientmodel.ProxyMethodParameter@58696433)
...
FATAL (FluentGen): Unhandled error: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@4d53d3cf and com.azure.autorest.model.clientmodel.ProxyMethodParameter@58696433)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@4d53d3cf and com.azure.autorest.model.clientmodel.ProxyMethodParameter@58696433)
	at java.base/java.util.stream.Collectors.duplicateKeyException(Collectors.java:133)
	at java.base/java.util.stream.Collectors.lambda$uniqKeysMapAccumulator$1(Collectors.java:180)
	at java.base/java.util.stream.ReduceOps$3ReducingSink.accept(ReduceOps.java:169)
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [FlaggedUser, AndroidMamPolicy, FlaggedEnrolledApp, GroupItem, Application, WipeDeviceOperationResult, Device, OperationResult, IOsmamPolicy, Location]
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [RecoveryPoint, MigrationItem, Network, Event, RecoveryServicesProvider, StorageClassification, VCenter, ProtectionContainer, ProtectableItem, NetworkMapping, StorageClassificationMapping, ReplicationEligibilityResultsCollection, ProtectionContainerMapping, Fabric, VaultHealthDetails, VaultSetting, Policy, TargetComputeSize, Alert, SupportedOperatingSystems, ReplicationProtectionIntent, ReplicationEligibilityResults, RecoveryPlan, OperationsDiscovery, MigrationRecoveryPoint, Job, ReplicationProtectedItem, LogicalNetwork]
INFORMATION (FluentGen): Java template for client model
INFORMATION (FluentGen): Process for Fluent Lite, SDK integration disabled
...
INFORMATION (FluentJavaSettings): Option, string, azure-libraries-for-java-folder : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [IoTSecurityAggregatedAlert, PricingList, Device, RuleResults, IotSitesList, AutoProvisioningSetting, ScanResults, SecuritySolutionsReferenceDataList, AdaptiveApplicationControlGroups, SecuritySubAssessment, Operation, DeviceSecurityGroup, Pricing, IotRecommendationModel, IotDefenderSettingsModel, IoTSecuritySolutionModel, IotAlertType, Compliance, SecurityContact, AllowedConnectionsResource, AscLocation, Scans, OnPremiseIotSensorsList, IotSensorsList, IotAlertModel, IotRecommendationTypeList, AlertsSuppressionRule, IoTSecuritySolutionAnalyticsModelList, Alert, AutomationValidationStatus, IotRecommendation, RegulatoryComplianceStandard, AdvancedThreatProtectionSetting, JitNetworkAccessPolicy, RegulatoryComplianceAssessment, TopologyResource, IoTSecuritySolutionAnalyticsModel, Scan, RulesResults, SecureScoreControlDefinitionItem, RegulatoryComplianceControl, ServerVulnerabilityAssessmentsList, ExternalSecuritySolution, ScanResult, SecureScoreControlDetails, ConnectorSetting, ComplianceResult, IotAlertTypeList, WorkspaceSetting, DiscoveredSecuritySolution, InformationProtectionPolicy, IotDefenderSettingsList, OnPremiseIotSensor, SecuritySolution, JitNetworkAccessRequest, PackageDownloads, SecurityAssessmentMetadata, AdaptiveApplicationControlGroup, ServerVulnerabilityAssessment, SecurityAssessment, SecurityTask, IotSensorsModel, IotSitesModel, Automation, IoTSecurityAggregatedRecommendation, IotRecommendationType, AdaptiveNetworkHardening, Setting, IotAlert, SecureScoreItem]
...
FATAL: [object Object]
(node:23234) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:23234) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:23234) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2020-12-15T07:00:48Z
[INFO] ------------------------------------------------------------------------
