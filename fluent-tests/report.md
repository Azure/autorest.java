# Java Codegen Report
Generated at 2021-06-10T15:33:01.998517
## Success
<details>
...
[INFO] Finished at: 2021-06-10T14:19:08Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentMapper): Add Inner to response types: [ManagedPrivateEndpointResource, IntegrationRuntimeNodeIpAddress, DataFlowResource, ActivityRunsQueryResponse, TriggerResource, IntegrationRuntimeMonitoringData, PrivateEndpointConnectionResource, SelfHostedIntegrationRuntimeNode, IntegrationRuntimeAuthKeys, PipelineResource, AddDataFlowToDebugSessionResponse, SsisObjectMetadataListResponse, DataFlowDebugSessionInfo, IntegrationRuntimeConnectionInfo, IntegrationRuntimeResource, ExposureControlBatchResponse, DatasetResource, SsisObjectMetadataStatusResponse, GitHubAccessTokenResponse, PipelineRun, Factory, AccessPolicyResponse, ManagedVirtualNetworkResource, CreateRunResponse, LinkedServiceResource, DataFlowDebugCommandResponse, IntegrationRuntimeStatusResponse, ExposureControlResponse, TriggerRunsQueryResponse, Operation, PipelineRunsQueryResponse, TriggerQueryResponse, TriggerSubscriptionOperationStatus, CreateDataFlowDebugSessionResponse, PrivateLinkResourcesWrapper]
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Application, Device, FlaggedUser, Location, IOsmamPolicy, OperationResult, FlaggedEnrolledApp, WipeDeviceOperationResult, AndroidMamPolicy, GroupItem]
...
[INFO] Finished at: 2021-06-10T15:05:21Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [OperationResponse, ReservationOrderResponse, QuotaRequestOneResourceSubmitResponse, QuotaRequestSubmitResponse201, AppliedReservations, ReservationResponse, QuotaRequestDetails, Catalog, CalculatePriceResponse, AvailableScopeProperties, ExchangeOperationResultResponse, CalculateExchangeOperationResultResponse, CurrentQuotaLimitBase]
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [SecureScoreControlDetails, SecureScoreItem, IngestionSetting, SecurityContact, IotAlertTypeList, IoTSecuritySolutionAnalyticsModel, Device, IotSensorsModel, PackageDownloads, SecurityTask, RegulatoryComplianceAssessment, IotSensorsList, IotRecommendationType, SecurityAssessment, IoTSecuritySolutionModel, RegulatoryComplianceStandard, AscLocation, AdaptiveApplicationControlGroups, SecuritySolutionsReferenceDataList, Pricing, InformationProtectionPolicy, IotDefenderSettingsList, IngestionSettingToken, IotAlertModel, Software, SecuritySolution, IotRecommendationModel, AdaptiveApplicationControlGroup, AllowedConnectionsResource, AdvancedThreatProtectionSetting, IoTSecuritySolutionAnalyticsModelList, ScanResults, IotSitesModel, SecureScoreControlDefinitionItem, JitNetworkAccessPolicy, ServerVulnerabilityAssessment, IotDefenderSettingsModel, IotRecommendation, IotSitesList, Automation, DiscoveredSecuritySolution, SecurityAssessmentMetadata, AlertsSuppressionRule, ComplianceResult, IotRecommendationTypeList, TopologyResource, RegulatoryComplianceControl, AutomationValidationStatus, ExternalSecuritySolution, ConnectorSetting, Compliance, OnPremiseIotSensorsList, AdaptiveNetworkHardening, IotAlertType, WorkspaceSetting, JitNetworkAccessRequest, IoTSecurityAggregatedRecommendation, Scan, Operation, IotAlert, SecuritySubAssessment, ScanResult, Scans, OnPremiseIotSensor, ConnectionStrings, DeviceSecurityGroup, AutoProvisioningSetting, ServerVulnerabilityAssessmentsList, RulesResults, Alert, Setting, IoTSecurityAggregatedAlert, PricingList, RuleResults]
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [ClientGroup, Liveness, Port, ClientGroupMembersCount, MachinesSummary, Connection, Process, ClientGroupMember, Machine, MapResponse, MachineGroup]
...
FATAL: [object Object]
(node:24609) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:24609) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:24609) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-06-10T15:14:44Z
[INFO] ------------------------------------------------------------------------
...
[INFO] Finished at: 2021-06-10T15:16:05Z
[INFO] ------------------------------------------------------------------------
...
[INFO] Finished at: 2021-06-10T15:27:13Z
[INFO] ------------------------------------------------------------------------
