# Java Codegen Report
Generated at 2021-03-09T19:41:57.123440
## Success
<details>
...
[INFO] Finished at: 2021-03-09T18:35:10Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentMapper): Add Inner to response types: [OperationsList, Rollout, ArtifactSource, StepResource, ServiceResource, ServiceTopologyResource, RolloutRequest, ServiceUnitResource]
...
ERROR (FluentGen): Failed to successfully run fluentgen plugin java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@744ac922 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@125611cc)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@744ac922 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@125611cc)
...
FATAL (FluentGen): Unhandled error: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@744ac922 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@125611cc)
java.lang.IllegalStateException: Duplicate key subscriptionId (attempted merging values com.azure.autorest.model.clientmodel.ProxyMethodParameter@744ac922 and com.azure.autorest.model.clientmodel.ProxyMethodParameter@125611cc)
	at java.base/java.util.stream.Collectors.duplicateKeyException(Collectors.java:133)
	at java.base/java.util.stream.Collectors.lambda$uniqKeysMapAccumulator$1(Collectors.java:180)
	at java.base/java.util.stream.ReduceOps$3ReducingSink.accept(ReduceOps.java:169)
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [IotAlert, Setting, OnPremiseIotSensorsList, IoTSecuritySolutionModel, AscLocation, RegulatoryComplianceControl, InformationProtectionPolicy, DeviceSecurityGroup, ScanResults, Compliance, RulesResults, RegulatoryComplianceStandard, SecurityContact, AdaptiveNetworkHardening, IoTSecuritySolutionAnalyticsModelList, IotRecommendationModel, IotDefenderSettingsList, JitNetworkAccessPolicy, IoTSecuritySolutionAnalyticsModel, ExternalSecuritySolution, IotAlertModel, WorkspaceSetting, AlertsSuppressionRule, IotSitesList, Scans, DiscoveredSecuritySolution, AdaptiveApplicationControlGroup, ComplianceResult, IotRecommendationType, SecureScoreControlDetails, SecureScoreControlDefinitionItem, PackageDownloads, IotAlertTypeList, PricingList, IotRecommendation, AdaptiveApplicationControlGroups, Automation, SecuritySolutionsReferenceDataList, SecureScoreItem, IoTSecurityAggregatedRecommendation, IotDefenderSettingsModel, IotAlertType, SecuritySubAssessment, OnPremiseIotSensor, Pricing, AutomationValidationStatus, Device, TopologyResource, AllowedConnectionsResource, Operation, AdvancedThreatProtectionSetting, SecurityTask, ConnectorSetting, ServerVulnerabilityAssessment, ScanResult, IoTSecurityAggregatedAlert, RuleResults, JitNetworkAccessRequest, Alert, SecurityAssessmentMetadata, RegulatoryComplianceAssessment, IotRecommendationTypeList, SecurityAssessment, IotSitesModel, Scan, IotSensorsList, AutoProvisioningSetting, SecuritySolution, ServerVulnerabilityAssessmentsList, IotSensorsModel]
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [ClientGroupMember, ClientGroupMembersCount, Connection, Process, ClientGroup, MapResponse, MachinesSummary, Liveness, MachineGroup, Machine, Port]
INFORMATION (FluentGen): Java template for client model
INFORMATION (FluentGen): Process for Fluent Lite, SDK integration disabled
...
FATAL: [object Object]
(node:24827) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:24827) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:24827) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-03-09T19:26:07Z
[INFO] ------------------------------------------------------------------------
