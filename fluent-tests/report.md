...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Location, AndroidMamPolicy, WipeDeviceOperationResult, FlaggedUser, Device, IOsmamPolicy, GroupItem, FlaggedEnrolledApp, Application, OperationResult]
