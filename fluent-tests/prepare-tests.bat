...
SET COMMON_ARGUMENTS=--java --use:../ --output-folder=./ --sync-methods=all --azure-arm --fluent --generate-client-as-impl --required-parameter-client-methods --track1-naming --implementation-subpackage=models --client-side-validations --client-logger
