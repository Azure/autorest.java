...
if %errorlevel% neq 0 exit /b %errorlevel%
CALL autorest --version=%AUTOREST_CORE_VERSION% %FLUENTLITE_ARGUMENTS% --pom-file=pom_generated_resources.xml https://github.com/Azure/azure-rest-api-specs/tree/main/specification/automation/resource-manager --java.namespace=com.azure.mgmtlitetest.rp
if %errorlevel% neq 0 exit /b %errorlevel%
