...
public class FluentNamerTests {
    ...
    public void testLiveTestGen(){
        ...
        // exist operation without operation group and also operation group named "ResourceProvider", this case, null operation group is named "ResourceProviderOperation" to avoid conflict
        ...
        Assertions.assertTrue(fluentClient.getResourceCollections().stream().anyMatch(collection -> collection.getInterfaceType().getName().equals(CodeNamer.getPlural(FluentConsts.DEFAULT_NAME_FOR_UNGROUPED_OPERATIONS + FluentConsts.ANTI_CONFLICT_SUFFIX_FOR_UNGROUPED_OPERATIONS))));
    }
