...
/** Initializes a new instance of the ArraysItemTypesClient type. */
public final class ArraysItemTypesClientImpl {
    ...
    /** Initializes an instance of ArraysItemTypesClient client. */
    public ArraysItemTypesClientImpl() {
        this(
     ...
     */
    public ArraysItemTypesClientImpl(HttpPipeline httpPipeline) {
     ...
     */
    public ArraysItemTypesClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter) {
