...
public final class BasicPolymorphicModelsImpl {
    ...
    private final BasicPolymorphicModelsClientImpl client;
     ...
     */
    BasicPolymorphicModelsImpl(BasicPolymorphicModelsClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for BasicPolymorphicModelsBasicPolymorphicModels to be used by the proxy
     * service to perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "BasicPolymorphicMode")
    private interface BasicPolymorphicModelsService {
        @Put("/polymorphic/model")
