...
/** An instance of this class provides access to all the operations defined in OdataOps. */
public final class OdataOpsImpl {
    /** The proxy service used to perform REST calls. */
    private final OdataOpsService service;

    /** The service client containing this operation class. */
    private final OdataClientImpl client;

    /**
     * Initializes an instance of OdataOpsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    OdataOpsImpl(OdataClientImpl client) {
        this.service = RestProxy.create(OdataOpsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for OdataOdataOps to be used by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "OdataOdataOps")
    private interface OdataOpsService {
        @Get("/odata")
