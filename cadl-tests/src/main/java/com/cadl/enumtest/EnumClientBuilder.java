...
import com.cadl.enumtest.implementation.EnumClientImpl;
...
public final class EnumClientBuilder
        implements HttpTrait<EnumClientBuilder>,
                ConfigurationTrait<EnumClientBuilder>,
                EndpointTrait<EnumClientBuilder> {
    @Generated private static final String SDK_NAME = "name";

    @Generated private static final String SDK_VERSION = "version";

    @Generated private final Map<String, String> properties = CoreUtils.getProperties("cadl-enumtest.properties");
    ...
    @Generated
    @Override
    public EnumClientBuilder endpoint(String endpoint) {
     ...
     */
    @Generated
    public EnumClientBuilder retryPolicy(RetryPolicy retryPolicy) {
        this.retryPolicy = retryPolicy;
        return this;
    }

    /**
     * Builds an instance of EnumClientImpl with the provided parameters.
     *
     * @return an instance of EnumClientImpl.
     */
    @Generated
    private EnumClientImpl buildInnerClient() {
        HttpPipeline localPipeline = (pipeline != null) ? pipeline : createHttpPipeline();
        EnumClientImpl client =
                new EnumClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), endpoint);
        return client;
    }
     ...
     */
    @Generated
    public EnumAsyncClient buildAsyncClient() {
        return new EnumAsyncClient(buildInnerClient().getEnumOps());
    }
    ...
    public EnumClient buildClient() {
        return new EnumClient(new EnumAsyncClient(buildInnerClient().getEnumOps()));
    }
}
