...
public final class PolymorphismsImpl {
    ...
    private final PolymorphismClientImpl client;
     ...
     */
    PolymorphismsImpl(PolymorphismClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PolymorphismPolymorphisms to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "PolymorphismPolymorp")
    ...
    public Mono<Response<BinaryData>> writeWithResponseAsync(BinaryData body, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                context -> service.write(this.client.getEndpoint(), accept, body, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> writeWithResponseAsync(
            BinaryData body, RequestOptions requestOptions, Context context) {
        final String accept = "application/json";
        return service.write(this.client.getEndpoint(), accept, body, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> taskWithResponseAsync(BinaryData body, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                context -> service.task(this.client.getEndpoint(), accept, body, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> taskWithResponseAsync(
            BinaryData body, RequestOptions requestOptions, Context context) {
        final String accept = "application/json";
        return service.task(this.client.getEndpoint(), accept, body, requestOptions, context);
    }
