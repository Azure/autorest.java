...
/** The CreateWithHeadersHeaders model. */
@Immutable
public final class CreateWithHeadersHeaders {
    /*
    ...
    /**
     * Creates an instance of CreateWithHeadersHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public CreateWithHeadersHeaders(HttpHeaders rawHeaders) {
