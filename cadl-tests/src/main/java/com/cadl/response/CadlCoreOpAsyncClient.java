...
@ServiceClient(builder = CadlCoreOpClientBuilder.class, isAsync = true)
public final class CadlCoreOpAsyncClient {
    @Generated private final CadlCoreOpsImpl serviceClient;

    /**
     * Initializes an instance of CadlCoreOpAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    CadlCoreOpAsyncClient(CadlCoreOpsImpl serviceClient) {
