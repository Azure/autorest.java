...
package com.cadl.testserver.basicpolymorphicmodels;
...
import com.cadl.testserver.basicpolymorphicmodels.implementation.InheritanceClientImpl;
...
public final class InheritanceClientBuilder
    ...
    private final Map<String, String> properties =
            CoreUtils.getProperties("cadl-testserver-basicpolymorphicmodels.properties");
     ...
     */
    @Generated
    public InheritanceClientBuilder retryPolicy(RetryPolicy retryPolicy) {
     ...
     */
    @Generated
    private InheritanceClientImpl buildInnerClient() {
        HttpPipeline localPipeline = (pipeline != null) ? pipeline : createHttpPipeline();
        InheritanceClientImpl client =
                new InheritanceClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
     ...
     */
    @Generated
    public InheritanceAsyncClient buildAsyncClient() {
        return new InheritanceAsyncClient(buildInnerClient().getBasicPolymorphicModels());
    }
    ...
    public InheritanceClient buildClient() {
        return new InheritanceClient(new InheritanceAsyncClient(buildInnerClient().getBasicPolymorphicModels()));
    }
}
