...
public final class OutputBasicsImpl {
    ...
    /**
     * The interface defining all the services for OutputBasicClientOutputBasics to be used by the proxy service to
     * perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "OutputBasicClientOut")
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getModelWithResponseAsync(RequestOptions requestOptions, Context context) {
        final String accept = "application/json";
        return service.getModel(accept, requestOptions, context);
    }
