...
/** Initializes a new instance of the asynchronous MultiInterfaceClientClient type. */
@ServiceClient(builder = MultiInterfaceClientClientBuilder.class, isAsync = true)
public final class MultiInterfaceClientAsyncClient {
    @Generated private final MultiInterfaceClientClientImpl serviceClient;

    /**
     * Initializes an instance of MultiInterfaceClientAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    MultiInterfaceClientAsyncClient(MultiInterfaceClientClientImpl serviceClient) {
