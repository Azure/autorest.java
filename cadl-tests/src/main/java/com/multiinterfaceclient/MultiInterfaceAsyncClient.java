...
@ServiceClient(builder = MultiInterfaceClientBuilder.class, isAsync = true)
public final class MultiInterfaceAsyncClient {
    @Generated private final MultiInterfaceClientImpl serviceClient;

    /**
     * Initializes an instance of MultiInterfaceAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    MultiInterfaceAsyncClient(MultiInterfaceClientImpl serviceClient) {
