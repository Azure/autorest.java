...
@ServiceClient(builder = DogsClientBuilder.class)
public final class DogsClient {
    @Generated private final DogsAsyncClient client;

    /**
     * Initializes an instance of DogsClient class.
     *
     * @param client the async client.
     */
    @Generated
    DogsClient(DogsAsyncClient client) {
        this.client = client;
    }
