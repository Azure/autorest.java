...
@ServiceClient(builder = BooleanValueClientBuilder.class)
public final class BooleanValueClient {
    @Generated private final BooleanValueAsyncClient client;
     ...
     */
    @Generated
    BooleanValueClient(BooleanValueAsyncClient client) {
        this.client = client;
    }
