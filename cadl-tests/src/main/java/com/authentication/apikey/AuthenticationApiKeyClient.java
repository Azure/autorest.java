...
/** Initializes a new instance of the synchronous AuthenticationApiKeyClient type. */
@ServiceClient(builder = AuthenticationApiKeyClientBuilder.class)
public final class AuthenticationApiKeyClient {
    @Generated private final AuthenticationApiKeyAsyncClient client;

    /**
     * Initializes an instance of AuthenticationApiKeyClient class.
     *
     * @param client the async client.
     */
    @Generated
    AuthenticationApiKeyClient(AuthenticationApiKeyAsyncClient client) {
        this.client = client;
    }
