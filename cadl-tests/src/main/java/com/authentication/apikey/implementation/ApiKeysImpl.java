...
/** An instance of this class provides access to all the operations defined in ApiKeys. */
public final class ApiKeysImpl {
    /** The proxy service used to perform REST calls. */
    private final ApiKeysService service;

    /** The service client containing this operation class. */
    private final AuthenticationApiKeyClientImpl client;

    /**
     * Initializes an instance of ApiKeysImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ApiKeysImpl(AuthenticationApiKeyClientImpl client) {
        this.service = RestProxy.create(ApiKeysService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AuthenticationApiKeyApiKeys to be used by the proxy service to
     * perform REST calls.
     */
