...
public final class StringOperationsImpl {
    ...
    private final ExtensibleEnumsClientImpl client;
     ...
     */
    StringOperationsImpl(ExtensibleEnumsClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for ExtensibleEnumsStringOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "ExtensibleEnumsStrin")
