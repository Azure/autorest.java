...
/** Initializes a new instance of the asynchronous AutomaticClient type. */
@ServiceClient(builder = AutomaticClientBuilder.class, isAsync = true)
public final class AutomaticAsyncClient {
    @Generated private final AutomaticClientImpl serviceClient;

    /**
     * Initializes an instance of AutomaticAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    AutomaticAsyncClient(AutomaticClientImpl serviceClient) {
