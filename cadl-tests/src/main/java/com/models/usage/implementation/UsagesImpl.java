...
public final class UsagesImpl {
    ...
    private final ModelsUsageClientImpl client;
     ...
     */
    UsagesImpl(ModelsUsageClientImpl client) {
        this.service = RestProxy.create(UsagesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ModelsUsageUsages to be used by the proxy service to perform REST
     * calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "ModelsUsageUsages")
