...
import com.models.property.types.implementation.TypesClientImpl;
...
public final class TypesClientBuilder implements HttpTrait<TypesClientBuilder>, ConfigurationTrait<TypesClientBuilder> {
    ...
    /**
     * Builds an instance of TypesClientImpl with the provided parameters.
     *
     * @return an instance of TypesClientImpl.
     */
    @Generated
    private TypesClientImpl buildInnerClient() {
        HttpPipeline localPipeline = (pipeline != null) ? pipeline : createHttpPipeline();
        TypesClientImpl client = new TypesClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter());
        return client;
    }
