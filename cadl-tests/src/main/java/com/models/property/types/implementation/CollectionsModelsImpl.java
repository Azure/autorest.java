...
public final class CollectionsModelsImpl {
     ...
     */
    CollectionsModelsImpl(TypesClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for TypesClientCollectionsModels to be used by the proxy service to
     * perform REST calls.
     */
