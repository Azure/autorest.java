...
/** Initializes a new instance of the TypesClient type. */
public final class TypesClientImpl {
     ...
     */
    public TypesClientImpl(HttpPipeline httpPipeline) {
     ...
     */
    public TypesClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter) {
