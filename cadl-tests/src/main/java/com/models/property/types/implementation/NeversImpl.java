...
public final class NeversImpl {
     ...
     */
    NeversImpl(TypesClientImpl client) {
        this.service = RestProxy.create(NeversService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for TypesClientNevers to be used by the proxy service to perform REST
     * calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "TypesClientNevers")
    public interface NeversService {
        @Get("/models/properties/types/never")
        ...
        @Put("/models/properties/types/never")
     ...
     * @return model with a property never along with {@link Response} on successful completion of {@link Mono}.
     */
