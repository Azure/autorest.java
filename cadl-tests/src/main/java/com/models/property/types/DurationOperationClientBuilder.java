...
@ServiceClientBuilder(serviceClients = {DurationOperationClient.class, DurationOperationAsyncClient.class})
public final class DurationOperationClientBuilder
        implements HttpTrait<DurationOperationClientBuilder>, ConfigurationTrait<DurationOperationClientBuilder> {
    ...
    /** Create an instance of the DurationOperationClientBuilder. */
    @Generated
    public DurationOperationClientBuilder() {
    ...
    @Generated
    @Override
    public DurationOperationClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public DurationOperationClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public DurationOperationClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public DurationOperationClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public DurationOperationClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public DurationOperationClientBuilder configuration(Configuration configuration) {
     ...
     * @return the DurationOperationClientBuilder.
     */
    @Generated
    public DurationOperationClientBuilder retryPolicy(RetryPolicy retryPolicy) {
     ...
     */
    @Generated
    public DurationOperationAsyncClient buildAsyncClient() {
     ...
     */
    @Generated
    public DurationOperationClient buildClient() {
