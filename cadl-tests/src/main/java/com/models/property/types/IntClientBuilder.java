...
/** A builder for creating a new instance of the IntClient type. */
@ServiceClientBuilder(serviceClients = {IntClient.class, IntAsyncClient.class})
public final class IntClientBuilder implements HttpTrait<IntClientBuilder>, ConfigurationTrait<IntClientBuilder> {
    ...
    /** Create an instance of the IntClientBuilder. */
    @Generated
    public IntClientBuilder() {
    ...
    @Generated
    @Override
    public IntClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public IntClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public IntClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public IntClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public IntClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public IntClientBuilder configuration(Configuration configuration) {
     ...
     * @return the IntClientBuilder.
     */
    @Generated
    public IntClientBuilder retryPolicy(RetryPolicy retryPolicy) {
     ...
     */
    @Generated
    public IntAsyncClient buildAsyncClient() {
