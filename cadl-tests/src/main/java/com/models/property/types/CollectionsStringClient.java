...
@ServiceClient(builder = CollectionsStringClientBuilder.class)
public final class CollectionsStringClient {
    @Generated private final CollectionsStringAsyncClient client;
     ...
     */
    @Generated
    CollectionsStringClient(CollectionsStringAsyncClient client) {
        this.client = client;
    }
     ...
     * @return model with collection string properties.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CollectionsStringProperty get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(CollectionsStringProperty.class);
    }
