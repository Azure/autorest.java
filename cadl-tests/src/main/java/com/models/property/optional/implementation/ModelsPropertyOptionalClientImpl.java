...
/** Initializes a new instance of the ModelsPropertyOptionalClient type. */
public final class ModelsPropertyOptionalClientImpl {
    ...
    /** Initializes an instance of ModelsPropertyOptionalClient client. */
    public ModelsPropertyOptionalClientImpl() {
        this(
     ...
     */
    public ModelsPropertyOptionalClientImpl(HttpPipeline httpPipeline) {
     ...
     */
    public ModelsPropertyOptionalClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter) {
