...
public final class StringOperationsImpl {
     ...
     */
    StringOperationsImpl(ModelsPropertyOptionalClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for ModelsPropertyOptionalStringOperations to be used by the proxy
    ...
    private interface StringOperationsService {
        ...
        @Get("/models/properties/optional/string/default")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
        ...
        @Put("/models/properties/optional/string/all")
        ...
        @Put("/models/properties/optional/string/default")
        @ExpectedResponses({204})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
