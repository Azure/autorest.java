...
/** Initializes a new instance of the asynchronous ServiceDriven2Client type. */
@ServiceClient(builder = ServiceDriven2ClientBuilder.class, isAsync = true)
public final class ServiceDriven2AsyncClient {
    @Generated private final ServiceDriven2ClientImpl serviceClient;

    /**
     * Initializes an instance of ServiceDriven2AsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    ServiceDriven2AsyncClient(ServiceDriven2ClientImpl serviceClient) {
