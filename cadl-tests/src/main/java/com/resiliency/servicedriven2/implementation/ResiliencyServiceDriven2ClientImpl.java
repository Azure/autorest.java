...
public final class ResiliencyServiceDriven2ClientImpl {
    ...
    private final ResiliencyServiceDriven2ClientService service;
    ...
    public ResiliencyServiceDriven2ClientImpl(
        ...
        this.service =
                RestProxy.create(
                        ResiliencyServiceDriven2ClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for ResiliencyServiceDriven2Client to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
