...
/** Initializes a new instance of the asynchronous ServiceDriven1Client type. */
@ServiceClient(builder = ServiceDriven1ClientBuilder.class, isAsync = true)
public final class ServiceDriven1AsyncClient {
    @Generated private final ServiceDriven1ClientImpl serviceClient;

    /**
     * Initializes an instance of ServiceDriven1AsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    ServiceDriven1AsyncClient(ServiceDriven1ClientImpl serviceClient) {
