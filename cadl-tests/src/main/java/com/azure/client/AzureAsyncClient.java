...
import com.azure.client.implementation.HelloesImpl;
...
/** Initializes a new instance of the asynchronous AzureClient type. */
@ServiceClient(builder = AzureClientBuilder.class, isAsync = true)
public final class AzureAsyncClient {
    @Generated private final HelloesImpl serviceClient;

    /**
     * Initializes an instance of AzureAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    AzureAsyncClient(HelloesImpl serviceClient) {
