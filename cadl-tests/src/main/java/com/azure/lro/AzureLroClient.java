...
/** Initializes a new instance of the synchronous AzureLroClient type. */
@ServiceClient(builder = AzureLroClientBuilder.class)
public final class AzureLroClient {
    @Generated private final AzureLroAsyncClient client;

    /**
     * Initializes an instance of AzureLroClient class.
     *
     * @param client the async client.
     */
    @Generated
    AzureLroClient(AzureLroAsyncClient client) {
        this.client = client;
    }
