...
@Immutable
public final class ResourceOperationStatusUserExportedUserError {
    /*
    ...
    private ExportedUser result;

    /**
     * Creates an instance of ResourceOperationStatusUserExportedUserError class.
     *
     * @param status the status value to set.
     */
    @JsonCreator
    private ResourceOperationStatusUserExportedUserError(
