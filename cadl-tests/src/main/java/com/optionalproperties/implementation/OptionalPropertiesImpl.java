...
package com.optionalproperties.implementation;
...
public final class OptionalPropertiesImpl {
    ...
    /**
     * The interface defining all the services for OptionalPropertiesOptionalProperties to be used by the proxy service
     * to perform REST calls.
     */
    @Host("http://localhost:3000")
    @ServiceInterface(name = "OptionalPropertiesOp")
