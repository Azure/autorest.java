...
public final class OpenAiClientBuilder
    ...
    @Generated private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("azure-openai.properties");
    ...
    private HttpPipeline createHttpPipeline() {
        ...
        if (azureKeyCredential != null) {
            policies.add(new AzureKeyCredentialPolicy("apiKey", azureKeyCredential));
        }
