set VANILLA_ARGUMENTS=--version=3.0.6257 --java --use:.\ --output-folder=vanilla-tests --sync-methods=all --client-side-validations --add-context-parameter
set AZURE_ARGUMENTS=--version=3.0.6257 --java --use:.\ --output-folder=azure-tests --sync-methods=all --client-side-validations --add-context-parameter
