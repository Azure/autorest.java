...
public class AsyncPageRetrieverTemplate {
    ...
    public void write(JavaClass clientClass) {
        ...
        clientClass.privateStaticFinalClass(classSignature, javaClass -> {
            ...
            javaClass.publicMethod(String.format("getFirstPage(Callback<Page<%s>> callback)", elementType), getPageMethod -> {
            ...
            javaClass.publicMethod(String.format("getPage(String pageId, Callback<Page<%s>> callback)", elementType), getPageMethod -> {
