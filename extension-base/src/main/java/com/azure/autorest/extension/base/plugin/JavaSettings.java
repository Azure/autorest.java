...
public class JavaSettings
{
    ...
    public static JavaSettings getInstance()
    {
        if (_instance == null)
        {
            ...
            _instance = new JavaSettings(
                    ...
                    host.getBooleanValue("merge-orphan-optional-parameters", false));
        }
        return _instance;
    }
    ...
    private JavaSettings(boolean azure,
                         ...
                         boolean mergeOrphanOptionalParameters)
    {
        this.azure = azure;
        ...
        this.mergeOrphanOptionalParameters = mergeOrphanOptionalParameters;
    ...
    /**
     * @return whether to merge orphaned optional parameters into the parameter bag suffixed with "Options", if available.
     */
    public boolean isMergeOrphanOptionalParameters() {
        return mergeOrphanOptionalParameters;
    }
