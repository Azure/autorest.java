...
public class JavaSettings {
    ...
    public static JavaSettings getInstance() {
        if (instance == null) {
            ...
            instance = new JavaSettings(
                ...
                host.getValue(new TypeReference<Map<String, String>>() {}.getType(), "custom-package-info-descriptions")
            );
        }
        return instance;
    }
    ...
    private JavaSettings(AutorestSettings autorestSettings,
        ...
        boolean urlAsString,
        Map<String, String> customPackageInfoDescriptions) {
        ...
        this.customPackageInfoDescriptions = customPackageInfoDescriptions;
    }
    ...
    private final Map<String, String> customPackageInfoDescriptions;

    /**
     * Gets an unmodifiable view of the custom {@code package-info} descriptions.
     * <p>
     * The identifier, or key, for the description must be the fully qualified package name for the
     * {@code package-info}. So, for {@code com.azure.core} the identifier must be {@code com.azure.core}. If there is
     * no custom description the default description will be used.
     * <p>
     * If the identifier for a custom description doesn't match any packages generated it will be ignored.
     *
     * @return An unmodifiable view of the custom {@code package-info} descriptions.
     */
    public Map<String, String> getCustomPackageInfoDescriptions() {
        return customPackageInfoDescriptions == null
            ? Collections.emptyMap()
            : Collections.unmodifiableMap(customPackageInfoDescriptions);
    }
