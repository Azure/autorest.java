...
public final class DpgClientBuilder implements HttpTrait<DpgClientBuilder>, ConfigurationTrait<DpgClientBuilder> {
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("fixtures-llcinitial.properties");
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DpgClientBuilder.class);
}
