...
public final class PathItemsAsyncClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getAllWithValues(
            String pathItemStringPath, String localStringPath, RequestOptions requestOptions) {
        return this.serviceClient.getAllWithValuesAsync(pathItemStringPath, localStringPath, requestOptions);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getGlobalQueryNull(
            String pathItemStringPath, String localStringPath, RequestOptions requestOptions) {
        return this.serviceClient.getGlobalQueryNullAsync(pathItemStringPath, localStringPath, requestOptions);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getGlobalAndLocalQueryNull(
            String pathItemStringPath, String localStringPath, RequestOptions requestOptions) {
        return this.serviceClient.getGlobalAndLocalQueryNullAsync(pathItemStringPath, localStringPath, requestOptions);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getLocalPathItemQueryNull(
            String pathItemStringPath, String localStringPath, RequestOptions requestOptions) {
        return this.serviceClient.getLocalPathItemQueryNullAsync(pathItemStringPath, localStringPath, requestOptions);
    }
}
