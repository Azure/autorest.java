...
public final class DpgAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Product> getModel(String mode) {
        // Generated convenience method for getModelWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getModelWithResponse(mode, requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Product> postModel(String mode, Input input) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Product> getPages(String mode) {
        // Generated convenience method for getPages
        RequestOptions requestOptions = new RequestOptions();
        return getPages(mode, requestOptions).mapPage(protocolMethodData -> protocolMethodData.toObject(Product.class));
    }
}
