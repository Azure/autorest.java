...
@ServiceClientBuilder(
    serviceClients = { ConstantAndClientParameterServiceClient.class,
...
public final class ConstantAndClientParameterServiceClientBuilder
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ConstantAndClientParameterServiceClientBuilder.class);
}
