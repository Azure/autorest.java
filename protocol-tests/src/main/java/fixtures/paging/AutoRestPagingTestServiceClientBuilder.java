...
public final class AutoRestPagingTestServiceClientBuilder implements HttpTrait<AutoRestPagingTestServiceClientBuilder>,
     ...
     */
    @Generated
    private AutoRestPagingTestServiceVersion serviceVersion;
    ...
    private AutoRestPagingTestServiceClientImpl buildInnerClient() {
        ...
        AutoRestPagingTestServiceClientImpl client = new AutoRestPagingTestServiceClientImpl(localPipeline,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AutoRestPagingTestServiceClientBuilder.class);
}
