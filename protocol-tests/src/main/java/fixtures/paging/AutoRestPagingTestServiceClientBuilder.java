...
public final class AutoRestPagingTestServiceClientBuilder
        implements HttpTrait<AutoRestPagingTestServiceClientBuilder>,
                ConfigurationTrait<AutoRestPagingTestServiceClientBuilder> {
    ...
    @Generated
    @Override
    public AutoRestPagingTestServiceClientBuilder retryOptions(RetryOptions retryOptions) {
