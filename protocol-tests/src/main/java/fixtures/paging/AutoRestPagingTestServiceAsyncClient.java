...
public final class AutoRestPagingTestServiceAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<BinaryData> nextOperationWithQueryParams(RequestOptions requestOptions) {
        return this.serviceClient.nextOperationWithQueryParamsAsync(requestOptions);
    }
