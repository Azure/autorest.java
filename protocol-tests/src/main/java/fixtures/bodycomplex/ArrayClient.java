...
public final class ArrayClient {
    ...
    public ArrayWrapper getValid() {
        ...
        return getValidWithResponse(requestOptions).getValue().toObject(ArrayWrapper.class);
    }
    ...
    public ArrayWrapper getEmpty() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getEmptyWithResponse(requestOptions).getValue().toObject(ArrayWrapper.class);
    }
    ...
    public ArrayWrapper getNotProvided() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getNotProvidedWithResponse(requestOptions).getValue().toObject(ArrayWrapper.class);
    }
}
