...
public final class FlattencomplexClientBuilder
        implements HttpTrait<FlattencomplexClientBuilder>, ConfigurationTrait<FlattencomplexClientBuilder> {
    ...
    @Generated
    public FlattencomplexClientBuilder() {
    ...
    @Generated
    @Override
    public FlattencomplexClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public FlattencomplexClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public FlattencomplexClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public FlattencomplexClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public FlattencomplexClientBuilder configuration(Configuration configuration) {
     ...
     * @return the FlattencomplexClientBuilder.
     */
    @Generated
    public FlattencomplexClientBuilder host(String host) {
        this.host = host;
        return this;
    }
     ...
     */
    @Generated
    public FlattencomplexClientBuilder serviceVersion(AutoRestComplexTestServiceVersion serviceVersion) {
     ...
     */
    @Generated
    public FlattencomplexClientBuilder retryPolicy(RetryPolicy retryPolicy) {
     ...
     */
    @Generated
    public FlattencomplexAsyncClient buildAsyncClient() {
