...
public final class ArrayClientBuilder implements HttpTrait<ArrayClientBuilder>, ConfigurationTrait<ArrayClientBuilder> {
     ...
     */
    @Generated
    public ArrayClientBuilder host(String host) {
        this.host = host;
        return this;
    }
     ...
     */
    @Generated
    public ArrayClientBuilder serviceVersion(AutoRestComplexTestServiceVersion serviceVersion) {
     ...
     */
    @Generated
    public ArrayClientBuilder retryPolicy(RetryPolicy retryPolicy) {
     ...
     */
    @Generated
    public ArrayAsyncClient buildAsyncClient() {
