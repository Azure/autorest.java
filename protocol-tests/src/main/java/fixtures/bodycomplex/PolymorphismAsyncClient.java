...
public final class PolymorphismAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> putMissingDiscriminatorWithResponse(BinaryData complexBody,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> putValidMissingRequiredWithResponse(BinaryData complexBody,
        RequestOptions requestOptions) {
