...
public final class PolymorphismAsyncClient {
    ...
    public Mono<DotFish> getDotSyntax() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getDotSyntaxWithResponse(requestOptions)
                .map(Response::getValue)
                .map(protocolMethodData -> protocolMethodData.toObject(DotFish.class));
    }
    ...
    public Mono<DotFishMarket> getComposedWithDiscriminator() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getComposedWithDiscriminatorWithResponse(requestOptions)
                .map(Response::getValue)
                .map(protocolMethodData -> protocolMethodData.toObject(DotFishMarket.class));
    }
    ...
    public Mono<DotFishMarket> getComposedWithoutDiscriminator() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getComposedWithoutDiscriminatorWithResponse(requestOptions)
                .map(Response::getValue)
                .map(protocolMethodData -> protocolMethodData.toObject(DotFishMarket.class));
    }
    ...
    public Mono<Salmon> getComplicated() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getComplicatedWithResponse(requestOptions)
                .map(Response::getValue)
    ...
    public Mono<Void> putComplicated(Salmon complexBody) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return putComplicatedWithResponse(BinaryData.fromObject(complexBody), requestOptions).then();
    }
    ...
    public Mono<Void> putValidMissingRequired(Fish complexBody) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return putValidMissingRequiredWithResponse(BinaryData.fromObject(complexBody), requestOptions).then();
    }
}
