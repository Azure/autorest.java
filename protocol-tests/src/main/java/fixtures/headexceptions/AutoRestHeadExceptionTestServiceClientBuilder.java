...
import fixtures.headexceptions.implementation.AutoRestHeadExceptionTestServiceClientImpl;
...
public final class AutoRestHeadExceptionTestServiceClientBuilder
    ...
    @Generated
    private final Map<String, String> properties = CoreUtils.getProperties("fixtures-headexceptions.properties");
     ...
     */
    @Generated
    public AutoRestHeadExceptionTestServiceClientBuilder host(String host) {
        this.host = host;
        return this;
    }
     ...
     */
    @Generated
    public AutoRestHeadExceptionTestServiceClientBuilder retryPolicy(RetryPolicy retryPolicy) {
     ...
     */
    @Generated
    public AutoRestHeadExceptionTestServiceAsyncClient buildAsyncClient() {
        return new AutoRestHeadExceptionTestServiceAsyncClient(buildInnerClient().getHeadExceptions());
    }
