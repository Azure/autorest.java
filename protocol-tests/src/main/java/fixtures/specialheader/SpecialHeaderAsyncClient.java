...
public final class SpecialHeaderAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> paramRepeatabilityRequest() {
        // Generated convenience method for paramRepeatabilityRequestWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return paramRepeatabilityRequestWithResponse(requestOptions).map(Response::getValue);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> paramRepeatabilityRequestPut() {
        // Generated convenience method for paramRepeatabilityRequestPutWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return paramRepeatabilityRequestPutWithResponse(requestOptions).map(Response::getValue);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> paramRepeatabilityRequestGet() {
        // Generated convenience method for paramRepeatabilityRequestGetWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return paramRepeatabilityRequestGetWithResponse(requestOptions).map(Response::getValue);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Object> paramRepeatabilityRequestPageable() {
        // Generated convenience method for paramRepeatabilityRequestPageable
        RequestOptions requestOptions = new RequestOptions();
        return paramRepeatabilityRequestPageable(requestOptions);
    }
}
