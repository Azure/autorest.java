...
public final class HttpFailuresImpl {
    ...
    public Mono<Boolean> getEmptyErrorAsync(RequestOptions requestOptions) {
        return getEmptyErrorWithResponseAsync(requestOptions)
                .flatMap(
    ...
    public Mono<Boolean> getEmptyErrorAsync(RequestOptions requestOptions, Context context) {
        return getEmptyErrorWithResponseAsync(requestOptions, context)
                .flatMap(
                        (Response<Boolean> res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
    ...
    public boolean getEmptyError(RequestOptions requestOptions) {
        Boolean value = getEmptyErrorAsync(requestOptions).block();
        if (value != null) {
            return value;
        } else {
    ...
    public Mono<Boolean> getNoModelErrorAsync(RequestOptions requestOptions) {
        return getNoModelErrorWithResponseAsync(requestOptions)
                .flatMap(
                        (Response<Boolean> res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
    ...
    public Mono<Boolean> getNoModelErrorAsync(RequestOptions requestOptions, Context context) {
        return getNoModelErrorWithResponseAsync(requestOptions, context)
                .flatMap(
                        (Response<Boolean> res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
    ...
    public boolean getNoModelError(RequestOptions requestOptions) {
        Boolean value = getNoModelErrorAsync(requestOptions).block();
        if (value != null) {
            return value;
        } else {
            throw new NullPointerException();
    ...
    public Mono<Boolean> getNoModelEmptyAsync(RequestOptions requestOptions) {
        return getNoModelEmptyWithResponseAsync(requestOptions)
                .flatMap(
                        (Response<Boolean> res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
    ...
    public Mono<Boolean> getNoModelEmptyAsync(RequestOptions requestOptions, Context context) {
        return getNoModelEmptyWithResponseAsync(requestOptions, context)
                .flatMap(
                        (Response<Boolean> res) -> {
                            if (res.getValue() != null) {
                                return Mono.just(res.getValue());
    ...
    public boolean getNoModelEmpty(RequestOptions requestOptions) {
        Boolean value = getNoModelEmptyAsync(requestOptions).block();
        if (value != null) {
            return value;
        } else {
            throw new NullPointerException();
