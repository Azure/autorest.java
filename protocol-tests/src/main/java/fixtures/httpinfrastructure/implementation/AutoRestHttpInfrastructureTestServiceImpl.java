...
public final class AutoRestHttpInfrastructureTestServiceImpl {
    /** server parameter. */
     ...
     */
    public AutoRestHttpInfrastructureTestServiceImpl(String host) {
        this(
     ...
     * @param host server parameter.
     */
    public AutoRestHttpInfrastructureTestServiceImpl(HttpPipeline httpPipeline, String host) {
