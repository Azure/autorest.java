...
public final class HttpSuccessClientBuilder
     ...
     */
    @Generated
    public HttpSuccessClientBuilder serviceVersion(AutoRestHttpInfrastructureTestServiceVersion serviceVersion) {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(HttpSuccessClientBuilder.class);
}
