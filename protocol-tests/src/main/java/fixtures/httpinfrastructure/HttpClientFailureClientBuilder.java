...
public final class HttpClientFailureClientBuilder
     ...
     */
    @Generated
    public HttpClientFailureClientBuilder serviceVersion(AutoRestHttpInfrastructureTestServiceVersion serviceVersion) {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(HttpClientFailureClientBuilder.class);
}
