...
public final class MultipleResponsesClientBuilder
     ...
     */
    @Generated
    public MultipleResponsesClientBuilder serviceVersion(AutoRestHttpInfrastructureTestServiceVersion serviceVersion) {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MultipleResponsesClientBuilder.class);
}
