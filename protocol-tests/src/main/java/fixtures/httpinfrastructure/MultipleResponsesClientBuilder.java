...
public final class MultipleResponsesClientBuilder
    ...
    @Generated
    public MultipleResponsesClientBuilder() {
    ...
    @Generated
    @Override
    public MultipleResponsesClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public MultipleResponsesClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public MultipleResponsesClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public MultipleResponsesClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public MultipleResponsesClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public MultipleResponsesClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Generated
    @Override
    public MultipleResponsesClientBuilder configuration(Configuration configuration) {
     ...
     * @return the MultipleResponsesClientBuilder.
     */
    @Generated
    public MultipleResponsesClientBuilder host(String host) {
        this.host = host;
        return this;
    }
     ...
     */
    @Generated
    public MultipleResponsesClientBuilder retryPolicy(RetryPolicy retryPolicy) {
     ...
     */
    @Generated
    public MultipleResponsesAsyncClient buildAsyncClient() {
