...
public final class HttpFailureAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Boolean> getEmptyError() {
        // Generated convenience method for getEmptyErrorWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getEmptyErrorWithResponse(requestOptions).map(Response::getValue);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Boolean> getNoModelError() {
        // Generated convenience method for getNoModelErrorWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getNoModelErrorWithResponse(requestOptions).map(Response::getValue);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Boolean> getNoModelEmpty() {
        // Generated convenience method for getNoModelEmptyWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getNoModelEmptyWithResponse(requestOptions).map(Response::getValue);
    }
}
