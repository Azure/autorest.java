...
@ServiceClientBuilder(
        serviceClients = {AutoRestParameterizedHostTestClient.class, AutoRestParameterizedHostTestAsyncClient.class})
public final class AutoRestParameterizedHostTestClientBuilder {
     ...
     */
    private AutoRestParameterizedHostTestClientImpl buildInnerClient() {
        if (host == null) {
            this.host = "host";
        }
        if (pipeline == null) {
        ...
        AutoRestParameterizedHostTestClientImpl client =
                new AutoRestParameterizedHostTestClientImpl(pipeline, serializerAdapter, host);
        return client;
    }
    ...
    /**
     * Builds an instance of AutoRestParameterizedHostTestAsyncClient async client.
     *
     * @return an instance of AutoRestParameterizedHostTestAsyncClient.
     */
    public AutoRestParameterizedHostTestAsyncClient buildAsyncClient() {
        return new AutoRestParameterizedHostTestAsyncClient(buildInnerClient().getPaths());
    }

    /**
     * Builds an instance of AutoRestParameterizedHostTestClient sync client.
     *
     * @return an instance of AutoRestParameterizedHostTestClient.
     */
    public AutoRestParameterizedHostTestClient buildClient() {
        return new AutoRestParameterizedHostTestClient(buildInnerClient().getPaths());
    }
}
