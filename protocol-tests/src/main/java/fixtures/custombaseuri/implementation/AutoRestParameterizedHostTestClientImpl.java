...
public final class AutoRestParameterizedHostTestClientImpl {
     ...
     */
    public AutoRestParameterizedHostTestClientImpl(String host) {
        this(
     ...
     * @param host A string value that is used as a global part of the parameterized host.
     */
    public AutoRestParameterizedHostTestClientImpl(HttpPipeline httpPipeline, String host) {
