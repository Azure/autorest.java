...
public final class LroRetrysClientBuilder
    ...
    @Generated private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("fixtures-lro.properties");
    ...
    private static final ClientLogger LOGGER = new ClientLogger(LroRetrysClientBuilder.class);
}
