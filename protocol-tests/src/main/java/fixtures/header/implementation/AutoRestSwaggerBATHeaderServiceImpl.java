...
public final class AutoRestSwaggerBATHeaderServiceImpl {
    /** server parameter. */
     ...
     */
    public AutoRestSwaggerBATHeaderServiceImpl(String host) {
        this(
     ...
     * @param host server parameter.
     */
    public AutoRestSwaggerBATHeaderServiceImpl(HttpPipeline httpPipeline, String host) {
