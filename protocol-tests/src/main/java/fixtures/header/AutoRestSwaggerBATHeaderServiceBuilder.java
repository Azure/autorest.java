...
public final class AutoRestSwaggerBATHeaderServiceBuilder {
    ...
    /**
     * Builds an instance of AutoRestSwaggerBATHeaderServiceImpl with the provided parameters.
     *
     * @return an instance of AutoRestSwaggerBATHeaderServiceImpl.
     */
    private AutoRestSwaggerBATHeaderServiceImpl buildInnerClient() {
        if (host == null) {
