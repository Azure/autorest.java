...
public final class MediaTypesAsyncClient {
    ...
    public Mono<BinaryData> analyzeBody(RequestOptions requestOptions) {
        return this.serviceClient.analyzeBodyAsync(requestOptions);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> analyzeBodyNoAcceptHeader(RequestOptions requestOptions) {
        return this.serviceClient.analyzeBodyNoAcceptHeaderAsync(requestOptions);
    }
    ...
    public Mono<BinaryData> contentTypeWithEncoding(RequestOptions requestOptions) {
        return this.serviceClient.contentTypeWithEncodingAsync(requestOptions);
    }
}
