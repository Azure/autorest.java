...
public class PrimitivePutDateTime {
    public static void main(String[] args) {
        ...
        // BEGIN:fixtures.bodycomplex.generated.primitive-put-date-time.primitive-put-date-time
        BinaryData complexBody
            = BinaryData.fromString("{\"field\":\"0001-01-01T12:00:00-04:00\",\"now\":\"2015-05-18T11:38:00-08:00\"}");
        RequestOptions requestOptions = new RequestOptions();
        Response<Void> response = primitiveClient.putDateTimeWithResponse(complexBody, requestOptions);
        // END:fixtures.bodycomplex.generated.primitive-put-date-time.primitive-put-date-time
    }
}
