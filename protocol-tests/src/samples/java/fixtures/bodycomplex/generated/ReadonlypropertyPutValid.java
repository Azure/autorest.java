...
import fixtures.bodycomplex.ReadonlypropertyAsyncClient;
...
public class ReadonlypropertyPutValid {
    public static void main(String[] args) {
        ReadonlypropertyClient readonlypropertyClient = new ReadonlypropertyClientBuilder().host("http://localhost:3000").buildClient();
