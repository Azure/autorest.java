...
public class PrimitivePutDouble {
    public static void main(String[] args) {
        ...
        BinaryData complexBody = BinaryData.fromString("{\"field1\":3.0E-100,\"field_56_zeros_after_the_dot_and_negative_zero_before_dot_and_this_is_a_long_field_name_on_purpose\":-5.0E-57}");
