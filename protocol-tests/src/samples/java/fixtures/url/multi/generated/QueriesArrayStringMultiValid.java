...
public class QueriesArrayStringMultiValid {
    public static void main(String[] args) {
        ...
        RequestOptions requestOptions = new RequestOptions().addQueryParam("arrayQuery", "ArrayQuery1").addQueryParam("arrayQuery", "begin!*'();:@ &= $").addQueryParam("arrayQuery", "/?#[]end").addQueryParam("arrayQuery", "").addQueryParam("arrayQuery", "");
        Response<Void> response = autoRestUrlMutliCollectionFormatTestServiceClient.arrayStringMultiValidWithResponse(requestOptions);
