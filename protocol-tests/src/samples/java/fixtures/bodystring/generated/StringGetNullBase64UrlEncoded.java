...
public class StringGetNullBase64UrlEncoded {
    public static void main(String[] args) {
        ...
        // BEGIN:fixtures.bodystring.generated.string-get-null-base64url-encoded.string-get-null-base64url-encoded
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response = stringOperationClient.getNullBase64UrlEncodedWithResponse(requestOptions);
        // END:fixtures.bodystring.generated.string-get-null-base64url-encoded.string-get-null-base64url-encoded
    }
}
