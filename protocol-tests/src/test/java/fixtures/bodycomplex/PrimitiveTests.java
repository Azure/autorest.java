...
public class PrimitiveTests {
    ...
    public void getLong() throws Exception {
        BinaryData binaryData = client.getLong(null);
        Map map = binaryData.toObject(Map.class);
    ...
    public void getFloat() throws Exception {
        BinaryData binaryData = client.getFloat(null);
        Map map = binaryData.toObject(Map.class);
    ...
    public void getDouble() throws Exception {
        BinaryData binaryData = client.getDouble(null);
        Map map = binaryData.toObject(Map.class);
    ...
    public void getBool() throws Exception {
        BinaryData binaryData = client.getBool(null);
        Map map = binaryData.toObject(Map.class);
    ...
    public void getString() throws Exception {
        BinaryData binaryData = client.getString(null);
        Map map = binaryData.toObject(Map.class);
