...
public final class DictionariesImpl {
  ...
  DictionariesImpl(AutoRestComplexTestServiceImpl client) {
    this.service =
        RestProxy.create(
            DictionariesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
    this.client = client;
  }

  /**
   * The interface defining all the services for AutoRestComplexTestServiceDictionaries to be used
  ...
  public Mono<Response<Void>> putValidWithResponseAsync(
      DictionaryWrapper complexBody, Context context) {
