...
public final class Basic {
  ...
  /**
   * Get the name property: Name property with a very long description that does not fit on a single
   * line and a line break.
   *
  ...
  /**
   * Set the name property: Name property with a very long description that does not fit on a single
   * line and a line break.
   *
