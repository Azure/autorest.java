...
public final class BasicsImpl {
  ...
  BasicsImpl(AutoRestComplexTestServiceImpl client) {
    this.service =
        RestProxy.create(
            BasicsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
    this.client = client;
  }

  /**
   * The interface defining all the services for AutoRestComplexTestServiceBasics to be used by the
  ...
  public Mono<Response<Void>> putValidWithResponseAsync(Basic complexBody) {
    return FluxUtil.withContext(
        context ->
            service.putValid(
                this.client.getHost(), this.client.getApiVersion(), complexBody, context));
  }
