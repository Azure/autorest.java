...
public class EclipseUtils {
     ...
     */
    @SuppressWarnings("deprecation")
    public static <T extends EclipseCodeCustomization> T addAnnotation(String annotation,
        EclipseCodeCustomization customization, Supplier<T> refreshedCustomizationSupplier) {
     ...
     */
    public static <T extends EclipseCodeCustomization> T removeAnnotation(T codeCustomization,
     ...
     */
    @SuppressWarnings("deprecation")
    public static <T extends EclipseCodeCustomization> T replaceBody(String newBody,
        EclipseCodeCustomization customization, Supplier<T> refreshedCustomizationSupplier) {
        SymbolInformation symbol = customization.getSymbol();
        Editor editor = customization.getEditor();
        String fileName = customization.getFileName();
    ...
    @SuppressWarnings("deprecation")
    public static <T extends EclipseCodeCustomization> T replaceParameters(String newParameters,
        EclipseCodeCustomization customization, Supplier<T> refreshCustomizationSupplier) {
        SymbolInformation symbol = customization.getSymbol();
        Editor editor = customization.getEditor();
        String fileName = customization.getFileName();
        String fileUri = customization.getFileUri();
     ...
     */
    public static <T extends EclipseCodeCustomization> T addImports(List<String> importsToAdd,
        EclipseClassCustomization customization, Supplier<T> refreshCustomizationSupplier) {
        EclipseLanguageClient languageClient = customization.getLanguageClient();
        Editor editor = customization.getEditor();
        String fileUri = customization.getFileUri();
        String fileName = customization.getFileName();
