...
public class FluentType {
    ...
    public static final ClassType PROXY_RESOURCE = new ClassType.Builder().packageName("com.azure.core.management").name("ProxyResource").build();
    public static final ClassType SUB_RESOURCE = new ClassType.Builder().packageName("com.azure.core.management").name("SubResource").build();

    public static final ClassType MANAGEMENT_EXCEPTION = new ClassType.Builder().packageName("com.azure.core.management.exception").name("ManagementException")
        .build();
    public static final ClassType MANAGEMENT_ERROR = new ClassType.Builder().packageName("com.azure.core.management.exception").name("ManagementError").build();

    public static final ClassType AZURE_PROFILE = new ClassType.Builder().packageName("com.azure.core.management.profile").name("AzureProfile").build();

    public static final ClassType REGION = new ClassType.Builder().packageName("com.azure.core.management").name("Region").build();

    public static final ClassType SYSTEM_DATA = new ClassType.Builder().packageName("com.azure.core.management").name("SystemData").build();
