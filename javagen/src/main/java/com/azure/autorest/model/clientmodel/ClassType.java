...
//    }};
    ...
    public static final ClassType FLOAT = new Builder(false).knownClass(Float.class)
        .defaultValueExpressionConverter(defaultValueExpression -> String.valueOf(Float.parseFloat(defaultValueExpression)) + 'F')
    ...
    public static final ClassType LOCAL_DATE = new Builder(false).knownClass(LocalDate.class)
        .defaultValueExpressionConverter(defaultValueExpression -> String.format("LocalDate.parse(\"%1$s\")", defaultValueExpression))
        .wrapSerializationWithObjectsToString(true)
    ...
    public static final ClassType DATE_TIME = new Builder(false).knownClass(OffsetDateTime.class)
        .defaultValueExpressionConverter(defaultValueExpression -> String.format("OffsetDateTime.parse(\"%1$s\")", defaultValueExpression))
        .wrapSerializationWithObjectsToString(true)
    ...
    public static final ClassType DURATION = new Builder(false).knownClass(Duration.class)
        .defaultValueExpressionConverter(defaultValueExpression -> String.format("Duration.parse(\"%1$s\")", defaultValueExpression))
        .wrapSerializationWithObjectsToString(true)
    ...
    public static final ClassType DATE_TIME_RFC_1123 = getClassTypeBuilder(DateTimeRfc1123.class)
        .defaultValueExpressionConverter(defaultValueExpression -> String.format("new DateTimeRfc1123(\"%1$s\")", defaultValueExpression))
        .wrapSerializationWithObjectsToString(true)
    ...
    public static final ClassType BIG_DECIMAL = new ClassType.Builder(false).knownClass(BigDecimal.class)
        .defaultValueExpressionConverter(defaultValueExpression -> String.format("new BigDecimal(\"%1$s\")", defaultValueExpression))
        .build();

    public static final ClassType UUID = new Builder(false).knownClass(java.util.UUID.class)
        .defaultValueExpressionConverter(defaultValueExpression -> String.format("UUID.fromString(\"%1$s\")", defaultValueExpression))
        .wrapSerializationWithObjectsToString(true)
    ...
    public static final ClassType TOKEN_CREDENTIAL = new ClassType.Builder(false)
    ...
    public static final ClassType URL = new Builder(false)
        .defaultValueExpressionConverter(defaultValueExpression -> String.format("new URL(\"%1$s\")", defaultValueExpression))
    ...
    public static final ClassType NON_NULL = new ClassType.Builder(false)
        .knownClass(NonNull.class)
        .build();
    ...
    public static final ClassType BINARY_DATA = getClassTypeBuilder(BinaryData.class)
        .defaultValueExpressionConverter(defaultValueExpression -> String.format("BinaryData.fromObject(\"%s\")", defaultValueExpression))
        .build();
    ...
    public static final ClassType RESPONSE_ERROR = new Builder().knownClass(ResponseError.class).build();
    ...
    public String jsonSerializationMethodCall(String jsonWriterName, String fieldName, String valueGetter) {
        ...
        return fieldName == null
            ? String.format("%s.%s(%s)", jsonWriterName, methodBase, value)
            : String.format("%s.%sField(\"%s\", %s)", jsonWriterName, methodBase, fieldName, value);
    }
    ...
    public String xmlDeserializationMethod(String attributeName, String attributeNamespace) {
        if (attributeName == null) {
            ...
            return (attributeNamespace == null)
                ...
                : String.format(xmlAttributeDeserializationTemplate, "\"" + attributeNamespace + "\"", "\"" + attributeName + "\"");
        }
    }
    ...
    public static class Builder {
        ...
        public Builder prototypeAsDouble() {
            return this.knownClass(Double.class)
                .defaultValueExpressionConverter(defaultValueExpression -> String.valueOf(Double.parseDouble(defaultValueExpression)) + 'D')
                .serializationMethodBase("writeNumber")
                .wrapSerializationWithObjectsToString(false)
    ...
    static String xmlSerializationCallHelper(String xmlWriterName, String serializationMethodName,
        ...
        if (isAttribute) {
            if (namespaceUri == null) {
                return String.format("%s.%sAttribute(%s, %s)", xmlWriterName, serializationMethodName, name, valueGetter);
            } else {
                return String.format("%s.%sAttribute(\"%s\", %s, %s)", xmlWriterName, serializationMethodName,
                    namespaceUri, name, valueGetter);
            }
        } else {
            if (name == null) {
                return String.format("%s.%s(%s)", xmlWriterName, serializationMethodName, valueGetter);
            } else {
                if (namespaceUri == null) {
                    return String.format("%s.%sElement(%s, %s)", xmlWriterName, serializationMethodName, name, valueGetter);
                } else {
                    return String.format("%s.%sElement(\"%s\", %s, %s)", xmlWriterName, serializationMethodName,
                        namespaceUri, name, valueGetter);
                }
            }
        }
