...
public class ClientModelUtil {
     ...
     */
    public static boolean isWireTypeMismatch(ClientModelProperty clientModelProperty) {
        return clientModelProperty.getClientType() != clientModelProperty.getWireType();
    }
}
