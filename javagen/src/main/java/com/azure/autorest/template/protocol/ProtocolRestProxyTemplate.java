 ...
 */
public class ProtocolRestProxyTemplate implements IJavaTemplate<Proxy, JavaFile>  {

    private static ProtocolRestProxyTemplate _instance = new ProtocolRestProxyTemplate();
    private ProtocolRestProxyTemplate() {
    }

    public static ProtocolRestProxyTemplate getInstance() {
      return _instance;
    }
